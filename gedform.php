      ...
      if (!$currentuser) {
        ?>
          <tr>
              ...
              <td class="databack"><span class="normal"><INPUT TYPE="TEXT" NAME="email" SIZE="20"></span></td>
          </tr>
        <?php
      }
      ?>
        <tr>
            ...
            <td class="databack"><span class="normal"><SELECT NAME="type"><OPTION value="<?php echo $text['ancestors']; ?>" selected><?php echo $text['ancestors']; ?></option><OPTION
                                value="<?php echo $text['descendants']; ?>"><?php echo $text['descendants']; ?></option></SELECT></span></td>
        </tr>
        <tr>
