...
<form action="switchcolor2.php" name="form1" method="GET">
    Color (in hex RGB format): <input type="text" name="rgbcolor" id="rgbcolor" size="8"> <A HREF="#" onClick="cp.select(document.form1.rgbcolor,'pick5');return false;" NAME="pick5" ID="pick5"><img src="img/tng_colorpicker.gif" alt="" width="19"
