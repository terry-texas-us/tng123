                  ...
                  ?>
                    ...
                    <table cellpadding="3" cellspacing="1" border="0" class="normal">
                        <tr>
                          ...
                          ?>
                            <td class="fieldnameback fieldname">
                                <nobr>&nbsp;<b><?php echo $admtext['thumb']; ?></b>&nbsp;</nobr>
                            </td>
                            <td class="fieldnameback fieldname">
                                <nobr>&nbsp;<b><?php echo "{$admtext['title']}, {$admtext['description']}"; ?></b>&nbsp;</nobr>
                            </td>
                          <?php
                          if ($map['key']) {
                            ?>
                              <td class="fieldnameback fieldname">
                                  <nobr>&nbsp;<b><?php echo $admtext['googleplace']; ?></b>&nbsp;</nobr>
                              </td>
                            <?php
                          }
                          if (!$mediatypeID) {
                            ?>
                              <td class="fieldnameback fieldname">
                                  <nobr>&nbsp;<b><?php echo $admtext['mediatype']; ?></b>&nbsp;</nobr>
                              </td>
                            <?php
                          }
                          ?>
                            <td class="fieldnameback fieldname">
                                <nobr>&nbsp;<b><?php echo $admtext['linkedto']; ?></b>&nbsp;</nobr>
                            </td>
                        </tr>
                      <?php
                      if ($numrows) {
