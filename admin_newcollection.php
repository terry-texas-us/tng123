    ...
    <form action="admin_addcollection.php" method="post" name="collform" id="collform" onsubmit="return addCollection(this);">
        <table border="0" cellpadding="2" class="normal">
            ...
            <tr>
                ...
                <td><input type="text" name="display" size="30"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="icon" size="30" value="img/"/></td>
            </tr>
            <tr>
                <td><?php echo $admtext['collthumb']; ?>:</td>
                <td><input type="text" name="thumb" size="30" value="img/"/></td>
            </tr>
            <tr>
                <td><?php echo $admtext['displayorder']; ?>:</td>
                <td><input type="text" name="ordernum" size="5"/></td>
            </tr>
            <tr>
