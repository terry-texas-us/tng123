                ...
                <form action="admin_mergesources.php" method="post" name="form1" id="form1">
                    ...
                    <table class="normal">
                        <tr>
                            ...
                            <td width="80">&nbsp;</td>
                            <td>
                                <div style="float:left"><?php echo $admtext['sourceid']; ?> 2: <input type="text" name="sourceID2" id="sourceID2" size="10" value="<?php echo $sourceID2; ?>"> &nbsp;<?php echo $admtext['text_or']; ?>&nbsp;</div>
