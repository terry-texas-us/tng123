...
$sortstr = preg_replace("/xxx/", $text[$mediatypeID], $admtext['sortmedia']);
                ...
                <div id="orderdivs">
                  ...
                  while ($row = tng_fetch_assoc($result)) {
                    ...
                    if ($row['thumbpath'] && file_exists("$rootpath$usefolder/$treestr" . $row['thumbpath'])) {
                      ...
                      echo "<a href=\"admin_editmedia.php?mediaID={$row['mediaID']}\"><img src=\"$usefolder/$treestr" . str_replace("%2F", "/", rawurlencode($row['thumbpath'])) . "\" border=\"0\" $size[3] alt=\"{$row['description']}\"></a>";
                    } else {
                      echo "&nbsp;";
                    }
                    echo "</td>\n";
