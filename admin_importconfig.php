...
$setuptabs[3] = [1, "#", $admtext['importconfigsettings'], "import"];
                ...
                <table class="normal">
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" value="<?php echo $admtext['makefolder']; ?>" onclick="makeFolder('gedcom',document.form1.gedpath.value);">
...
<?php echo "<div style=\"text-align: center;\"><span class='normal'>$tng_title</div>"; ?>
</body>
</html>