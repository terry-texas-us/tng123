...
$setuptabs[3] = [1, "#", $admtext['configsettings'], "gen"];
          ...
          <table class="normal">
            ...
            <tr>
              ...
              <td><input type="text" value="<?php echo $photopath; ?>" name="photopath" class="verylongfield">
                <input type="button" value="<?php echo $admtext['makefolder']; ?>" onclick="makeFolder('photos',document.form1.photopath.value);"> <span id="msg_photos"></span></td>
            </tr>
            <tr>
              ...
              <td><input type="text" value="<?php echo $documentpath; ?>" name="documentpath" class="verylongfield">
                <input type="button" value="<?php echo $admtext['makefolder']; ?>" onClick="makeFolder('documents',document.form1.documentpath.value);"> <span id="msg_documents"></span></td>
            </tr>
            <tr>
              ...
              <td><input type="text" value="<?php echo $historypath; ?>" name="historypath" class="verylongfield">
                <input type="button" value="<?php echo $admtext['makefolder']; ?>" onClick="makeFolder('histories',document.form1.historypath.value);"> <span id="msg_histories"></span></td>
            </tr>
            <tr>
              ...
              <td><input type="text" value="<?php echo $headstonepath; ?>" name="headstonepath" class="verylongfield">
                <input type="button" value="<?php echo $admtext['makefolder']; ?>" onClick="makeFolder('headstones',document.form1.headstonepath.value);"> <span id="msg_headstones"></span></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input type="text" value="<?php echo $gendexfile; ?>" name="gendexfile" class="verylongfield">
                <input type="button" value="<?php echo $admtext['makefolder']; ?>" onClick="makeFolder('gendex',document.form1.gendexfile.value);"> <span id="msg_gendex"></span></td>
            </tr>
            <tr>
              ...
              <td><input type="text" value="<?php echo $backuppath; ?>" name="backuppath" class="verylongfield">
                <input type="button" value="<?php echo $admtext['makefolder']; ?>" onClick="makeFolder('backups',document.form1.backuppath.value);"> <span id="msg_backups"></span></td>
            </tr>
            <tr>
      ...
      <td class="tngshadow">
        ...
        <div id="site" style="display:none">
          <table class="normal">
              ...
              <td>
                <select name="tng_menu">
                  <option value="0"<?php if (!$tngconfig['menu']) {
                    echo " selected";
                  } ?>><?php echo $admtext['topright']; ?></option>
                  <option value="1"<?php if ($tngconfig['menu'] == 1) {
                    echo " selected";
                  } ?>><?php echo $admtext['topleft']; ?></option>
                  <option value="2"<?php if ($tngconfig['menu'] == 2) {
                    echo " selected";
                  } ?>><?php echo $admtext['nodisplay']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <select name="searchchoice">
                  <option value="0"<?php if (!$tngconfig['searchchoice']) {
                    echo " selected";
                  } ?>><?php echo $admtext['quicksearch']; ?></option>
                  <option value="1"<?php if ($tngconfig['searchchoice']) {
                    echo " selected";
                  } ?>><?php echo $admtext['advsearch']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td><?php echo $admtext['defaulttree']; ?>:</td>
              <td>
              ...
              <td>
                <select name="tng_imgviewer">
                  <option value="0"<?php if (!$tngconfig['imgviewer']) {
                    echo " selected";
                  } ?>><?php echo $admtext['ldson']; ?></option>
                  <option value="documents"<?php if ($tngconfig['imgviewer'] == "documents") {
                    echo " selected";
                  } ?>><?php echo $admtext['docsonly']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <select name="tng_imgvheight">
                  <option value="0"<?php if ($tngconfig['imgvheight'] == 1) {
                    echo " selected";
                  } ?>><?php echo $admtext['flex']; ?></option>
                  <option value="640"<?php if ($tngconfig['imgvheight'] == "640") {
                    echo " selected";
                  } ?>><?php echo $admtext['setheight']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <select name="tng_mediadel">
                  ...
                  <option value="2"<?php if ($tngconfig['mediadel'] == 2) {
                    echo " selected";
                  } ?>><?php echo $admtext['onrequest']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <select name="chooselang">
                  <option value="1"<?php if ($chooselang) {
                    echo " selected";
                  } ?>><?php echo $admtext['allow']; ?></option>
                  <option value="0"<?php if (!$chooselang) {
                    echo " selected";
                  } ?>><?php echo $admtext['disallow']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <select name="ldsdefault">
                  ...
                  <option value="1"<?php if ($ldsdefault == 1) {
                    echo " selected";
                  } ?>><?php echo $admtext['ldsoff']; ?></option>
                  <option value="2"<?php if ($ldsdefault == 2) {
                    echo " selected";
                  } ?>><?php echo $admtext['ldspermit']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <select name="nonames">
                  ...
                  <option value="2"<?php if ($nonames == 2) {
                    echo " selected";
                  } ?>><?php echo $admtext['initials']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <select name="lnprefixes">
                  <option value="0"<?php if (!$lnprefixes) {
                    echo " selected";
                  } ?>><?php echo $admtext['lntogether']; ?></option>
                  <option value="1"<?php if ($lnprefixes) {
                    echo " selected";
                  } ?>><?php echo $admtext['lnapart']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <select name="responsivetables">
                  <option value="1"<?php if ($responsivetables) {
                    echo " selected";
                  } ?>><?php echo $admtext['yes']; ?></option>
                  <option value="0"<?php if (!$responsivetables) {
                    echo " selected";
                  } ?>><?php echo $admtext['no']; ?></option>
                </select>
              </td>
            ...
            <tr>
              ...
              <td>
                <select name="tabletype">
                  <option value="toggle"<?php if ($tabletype == "toggle") {
                    echo " selected";
                  } ?>>toggle
                  </option>
                  <option value="stack"<?php if ($tabletype == "stack") {
                    echo " selected";
                  } ?>>stack
                  </option>
                  <option value="swipe"<?php if ($tabletype == "swipe") {
                    echo " selected";
                  } ?>>swipe
                  </option>
                  <option value="tng"<?php if ($tabletype == "tng") {
                    echo " selected";
                  } ?>>tng
                  </option>
                </select>
            ...
            <tr>
              ...
              <td>
                <select name="enablemodeswitch">
                  <option value="1"<?php if ($enablemodeswitch) {
                    echo " selected";
                  } ?>><?php echo $admtext['yes']; ?></option>
                  <option value="0"<?php if (!$enablemodeswitch) {
                    echo " selected";
                  } ?>><?php echo $admtext['no']; ?></option>
                </select>
              </td>
            ...
            <tr>
              ...
              <td>
                <select name="enableminimap">
                  <option value="1"<?php if ($enableminimap) {
                    echo " selected";
                  } ?>><?php echo $admtext['yes']; ?></option>
                  <option value="0"<?php if (!$enableminimap) {
                    echo " selected";
                  } ?>><?php echo $admtext['no']; ?></option>
                </select>
              </td>
      ...
      <td class="tngshadow">
        ...
        <div id="dna" style="display:none">
          <table class="normal">
            ...
            <tr>
              <td colspan="2"><?php echo $admtext['getcolorcodes']; ?> -> <a href="http://hnl.name/color-schemer-online/" class="snlink" target="_blank"><?php echo $admtext['colorschemer']; ?></a></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
        ...
        <div id="misc" style="display:none">
          <table class="normal">
              ...
              <td colspan="4">
                <select name="tng_istart">
                  <option value="0"<?php if (!$tngconfig['istart']) {
                    echo " selected";
                  } ?>><?php echo $admtext['allinfo']; ?></option>
                  <option value="1"<?php if ($tngconfig['istart']) {
                    echo " selected";
                  } ?>><?php echo $admtext['persinfo']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="4">
                <select name="notestogether">
                  <option value="0"<?php if (!$notestogether) {
                    echo " selected";
                  } ?>><?php echo $admtext['notesapart']; ?></option>
                  <option value="1"<?php if ($notestogether == 1) {
                    echo " selected";
                  } ?>><?php echo $admtext['notestogether']; ?></option>
                  <option value="2"<?php if ($notestogether == 2) {
                    echo " selected";
                  } ?>><?php echo $admtext['notestogether2']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="4"><input type="text" value="<?php echo $time_offset; ?>" name="time_offset" size="5"> <?php echo $admtext['servertime'] . " <strong>" . date("D h:i a") . "</strong> ";
              ...
              <td colspan="4">
                <select name="prefereuro">
                  <option value="false"<?php if ($tngconfig['preferEuro'] == "false") {
                    echo " selected";
                  } ?>><?php echo $admtext['monthfirst']; ?></option>
                  <option value="true"<?php if ($tngconfig['preferEuro'] == "true") {
                    echo " selected";
                  } ?>><?php echo $admtext['dayfirst']; ?></option>
                </select>
              </td>
            </tr>
            <tr>
