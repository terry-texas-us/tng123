...
if (isMobile()) {
    if ($tabletype == "toggle") {
        $header = "<table cellpadding='3' cellspacing='1' border='0' class=\"tablesaw whiteback w-100\" data-tablesaw-mode='columntoggle'" . $headerr;
    } elseif ($tabletype == "stack") {
        $header = "<table cellpadding='3' cellspacing='1' border='0' class=\"tablesaw whiteback w-100\" data-tablesaw-mode='stack'" . $headerr;
    } elseif ($tabletype == "swipe") {
        $header = "<table cellpadding='3' cellspacing='1' border='0' class=\"tablesaw whiteback w-100\" data-tablesaw-mode='swipe'" . $headerr;
    } else {
