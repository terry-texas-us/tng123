...
function openChangeTree(entity, tree, id) {
    tnglitbox = new LITBox('admin_changetreeform.php?entity=' + entity + '&oldtree=' + tree + '&entityID=' + id, {width: 480, height: 320});
    return false;
}
    ...
    if (form.note.value.length == 0)
        ...
        jQuery.ajax({
            ...
            success: function (vars) {
                ...
                newtr.id = "row_" + vars.id;
                insertCell(newtr, 0, "dragarea rounded-lg", '<img src="img/admArrowUp.gif" alt="" class="inline-block"><br><img src="img/admArrowDown.gif" alt="" class="inline-block">');
