...
function showPersonPreview(personID, tree, event) {
    ...
    if (!$personSelection.html()) {
        $personSelection.html('<div id="ld' + entitystr + '" class="person-inner"><img src="' + 'img/spinner.gif" style="border:0;" alt="" > ' + loadingMessage + '</div>');
...
function showFamilyPreview(familyID, tree) {
    ...
    if (!$familySelection.html()) {
        $familySelection.html('<div id="ld' + entitystr + '" class="person-inner"><img src="' + 'img/spinner.gif" alt=""> ' + loadingMessage + '</div>');
