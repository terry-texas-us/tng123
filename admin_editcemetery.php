            ...
            <td class="tngshadow">
                <table class="normal" width="100%">
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="<?php echo $row['maplink']; ?>" name="maplink" id="maplink" size="60"><input type="hidden" id="maplink_org"
                                                                                                                                   value="<?php echo $row['maplink']; ?>"><input type="hidden"
                                                                                                                                                                                 id="maplink_last">
                            <input
