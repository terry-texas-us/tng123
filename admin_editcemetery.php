            ...
            <td class="tngshadow">
                <table class="normal" width="100%">
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="<?php echo $row['maplink']; ?>" name="maplink" id="maplink" size="60"><input type="hidden" id="maplink_org" value="<?php echo $row['maplink']; ?>"><input type="hidden" id="maplink_last"> <input
                                    type="button" value="<?php echo $admtext['select'] . "..."; ?>" OnClick="javascript:FilePicker('maplink','headstones');"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="<?php echo $row['place']; ?>" name="place" id="place" class="longfield" onblur="fillCemetery(this.value);"> <a href="#" onclick="return openFindPlaceForm('place');"><img src="img/tng_find.gif"
                                                                                                                                                                                                                                title="<?php echo $admtext['find']; ?>"
                                                                                                                                                                                                                                alt="<?php echo $admtext['find']; ?>"
                                                                                                                                                                                                                                width="20" height="20"
                                                                                                                                                                                                                                class="alignmiddle"/></a>
                  ...
                  ?>
                    <tr>
                        ...
                        <td><textarea wrap cols="60" rows="8" name="notes"><?php echo $row['notes']; ?></textarea></td>
                    </tr>
                    <tr>
                        <td colspan="2">
		<span class="normal">
