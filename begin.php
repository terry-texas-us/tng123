...
/**
 * To allow new undfined text which needs to be added the language / locale system at some point.
 * Effect is all text is translated to English.
 *
 * @param string $text
 * @return string
 */
function _todo_(string $text): string {
    return $text;
}
