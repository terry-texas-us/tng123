  ...
  function validateForm() {
      ...
      if (tng_num_rows($langresult)) {
        ...
        while ($langrow = tng_fetch_assoc($langresult)) {
            ...
            $displayrows .= "<tr>";
            $displayrows .= "<td valign=\"top\">$display</td>";
          ...
          <tr>
            <td valign="top"><?php echo $admtext['assocwith']; ?>:</td>
                    ...
                    <tr id="tdesc">
                        ...
                        <td><input type="text" name="description" size="40" value="<?php echo $row['description']; ?>"></td>
                    </tr>
                    <tr id="displaytr"<?php echo $displaytrstyle; ?>>
                        <td valign="top"><?php echo $admtext['display']; ?>:</td>
                        <td><input type="text" name="defdisplay" size="40" value="<?php echo $defdisplay; ?>"></td>
                    </tr>
                  <?php
                  if ($displayrows) {
                    ?>
                  ...
                  ?>
                    <tr>
                        ...
                        <td><input type="text" name="ordernum" size="4" value="<?php echo $row['ordernum']; ?>"></td>
                    </tr>
                    <tr>
                        <td valign="top"><?php echo $admtext['evdata']; ?>:</td>
                        <td><input type="radio" name="keep" value="1" <?php if ($row['keep']) {
                            echo "checked";
                          } ?>> <?php echo $admtext['accept']; ?> &nbsp; <input type="radio" name="keep" value="0" <?php if ($row['keep'] != 1) {
                            echo "checked";
                    ...
                    <tr>
                        ...
                        <td><input type="radio" name="collapse" value="1" <?php if ($row['collapse']) {
                            echo "checked";
                          } ?>> <?php echo $admtext['yes']; ?> &nbsp; <input type="radio" name="collapse" value="0" <?php if ($row['collapse'] != 1) {
                            echo "checked";
                    ...
                    <tr>
                        ...
                        <td><input type="radio" name="ldsevent" value="1" <?php if ($row['ldsevent']) {
                            echo "checked";
