...
<?php if ($allow_edit || $allow_add || $allow_delete) { ?>
...
<?php } ?>
<?php if ($allow_edit || $allow_add || $allow_delete || $allow_media_add || $allow_media_edit || $allow_media_delete) { ?>
...
<?php } ?>
<?php if ($allow_edit && $allow_add && $allow_delete && !$assignedtree) { ?>
    <a href="admin_misc.php" class="lightlink2 leftlink" target="main"><?php echo $admtext['misc']; ?></a>
<?php } ?>
<hr>
<?php if ($allow_edit && $allow_add && $allow_delete && !$assignedbranch) { ?>
...
<?php } ?>
<a href="<?php echo $home_url; ?>" class="lightlink2 leftlink" target="main"><?php echo $admtext['publichome']; ?><br>
    <small><?php echo $admtext['inframe']; ?></small></a>
</body>
</html>