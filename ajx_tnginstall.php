...
switch ($_POST['subroutine']) {
    case 'perms':
        ...
        $files = array("adminlog.txt", $subroot . "config.php", "config/mmconfig.php", "genlog.txt", $subroot . "importconfig.php", $subroot . "logconfig.php", "config/mapconfig.php", "config/pedconfig.php", "subroot.php", "whatsnew.txt");
