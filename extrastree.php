...
$innermenu .= "<select name=\"generations\" class=\"verysmall\" onchange=\"window.location.href='$extrastree_url" . "personID=$personID&amp;tree=$tree&amp;showall=$showall&amp;generations=' + this.options[this.selectedIndex].value\">\n";
