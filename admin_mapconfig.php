          ...
          <tr>
            <td><?php echo $admtext['mapkey']; ?>:</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="<?php echo $map['stlat']; ?>" name="mapstlat" onblur="this.value = validateLatLong(this.value)"></td>
                    </tr>
                    <tr>
                        <td><?php echo $admtext['mapstlong']; ?>:</td>
                        <td><input type="text" value="<?php echo $map['stlong']; ?>" name="mapstlong" onblur="this.value = validateLatLong(this.value)"></td>
                    </tr>
                    <tr>
