...
$text['wasborn_male'] = "родился";
$text['wasborn_female'] = "родился";
$text['waschristen_male'] = "был крещен";
$text['waschristen_female'] = "был крещен";
$text['dead_male'] = "умер";
$text['dead_female'] = "умер";
$text['wasburied_male'] = "был похоронен";
$text['wasburied_female'] = "был похоронен";
$text['wascremated_male'] = "был кремирован";
$text['wascremated_female'] = "был кремирован";
$text['wasmarried_male'] = "замужем";
$text['wasmarried_female'] = "замужем";
$text['wasdivorced_male'] = "был разведен";
$text['wasdivorced_female'] = "был в разводе";
$text['inplace'] = " in ";
$text['onthisdate'] = " on ";
$text['inthisyear'] = " in ";
$text['and'] = "and ";
