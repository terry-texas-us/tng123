...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Database Host, Name, User Name, Password</h5>
            ...
            <h5 class="optionhead">Maintenance Mode</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Table Names</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Root Path</h5>
            ...
            <h5 class="optionhead">Config Path</h5>
            ...
            <h5 class="optionhead">Photo / Document / History / Headstone / Multimedia / GENDEX / Backup / Mods / Extensions Folders</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Home Page</h5>
            ...
            <h5 class="optionhead">Site Description</h5>
            <p>A short description of your site for use on the RSS feed page.</p>

            <h5 class="optionhead">Doctype Declaration</h5>
            ...
            <h5 class="optionhead">Custom Header / Footer / Meta</h5>
            <p>File names for the page fragments to be used as your TNG page header, footer and HEAD section ("meta"). Files with the default names
                are supplied.
            ...
            <h5 class="optionhead">Tab Style Sheet</h5>
            <p>The file that dictates the style of tabs displayed on many of the public pages. The default style (tngtabs1.css) features slanted tabs,
                but
                ...
                tabs) and "tngtabactive.png" (active tabs). To change the color of these images, you may use any image editor, or click on the link at
            ...
            <h5 class="optionhead">Menu Location</h5>
            <p>The TNG menu may be located on the top left of every page, just above the individual's name or other page heading, or on the top right
            ...
            <h5 class="optionhead">Show Home / Search / Login/Logout / Share / Print / Add Bookmark Links</h5>
            <p>Some of these options (Home/Search/Login) are located at the top left of every page, just under the page heading and above the row of
                tabs. The others
            ...
            <h5 class="optionhead">Search Link Destination</h5>
            <p>The default behavior of the Search link at the top of every page is to open a small window where you can search by entering a name or
            ...
            <h5 class="optionhead">Hide Christening Labels</h5>
            <p>This option allows you to hide all mention of the "Christening" event.</p>

            <h5 class="optionhead">Hide all DNA pages and data</h5>
            <p>If you're not going to use any of the DNA-related features and would like it removed from all public pages, set this option to Yes. DNA
                Tests will no longer be accessible from the public menus,
                nor will they be seen on any person's individual page.</p>

            <h5 class="optionhead">Default Tree</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Photos Extension</h5>
            ...
            <h5 class="optionhead">Show Extended Photo Info</h5>
            ...
            <h5 class="optionhead">Image Max Height and Width</h5>
            ...
            <h5 class="optionhead">Thumbnails Prefix</h5>
            <p>When generating thumbnails automatically, TNG will prepend this value to the original image file name to create the thumbnail file
                ...
                information, the prefix will be included directly before the file name. This prefix can include a folder name (ie, "thumbnails/"). If
                you
            ...
            <h5 class="optionhead">Thumbnails Suffix</h5>
            ...
            <h5 class="optionhead">Thumbnail Max Height</h5>
            <p>When TNG automatically creates a thumbnail image, the image will be no taller than this (pixels).</p>

            <h5 class="optionhead">Thumbnail Max Width</h5>
            <p>When TNG automatically creates a thumbnail image, the image will be no wider than this (pixels).</p>

            <h5 class="optionhead">Use default thumbnails</h5>
            <p>If a person does not have a default photo and this option is enabled, a generic, gender-specific thumbnail will be used instead on all
                pages that reference
                this person.</p>

            <h5 class="optionhead">Columns in Thumbnail View</h5>
            ...
            <h5 class="optionhead">Max characters in list notes</h5>
            ...
            <h5 class="optionhead">Enable Slide Show</h5>
            ...
            <h5 class="optionhead">Slide Show Auto Repeat</h5>
            <p>Setting this option to 'Yes' allows the slide show to run continuously.</p>

            <h5 class="optionhead">Enable Image Viewer</h5>
            ...
            <h5 class="optionhead">Image Viewer Height</h5>
            <p>Setting this option to 'Always show full image' will ensure that the entire image is viewable by default. Setting it to 'Fixed (640px)'
                causes images taller than
                640 pixels to be cropped at that height when the image is initially displayed. The viewer controls may still be used to pan around the
                image or to zoom in or out.</p>

            <h5 class="optionhead">Hide Personal Media</h5>
            <p>If this option is set to "Yes", then media listings on a person's individual page will start in a collapsed state. Instead of seeing
            ...
            <h5 class="optionhead">Remove physical file on delete</h5>
            <p>This option dictates what happens when an individual media record is deleted. If this option is set to "Yes", the associated physical
                file will also be deleted.
                If the option is set to "No", only the database record will be removed, leaving the physical file intact. If the option is set to "On
                request", you will be prompted to
                indicate whether the associated file should be deleted or not.</p>

            <h5 class="optionhead">Show photos on one row</h5>
            <p>This pertains to thumbnails shown on a person's individual page. When more than one thumbnail is present in any area, this option can
                be used to display all of the
                thumbnails horizontally in a single row (images will wrap if there are too many for them all to be shown on one row) or in a list, as
                they always were prior to TNG v12.
                When the thumbnails are displayed horizontally, no captions will be displayed. Media that do not have a thumbnail will still be listed
                vertically.</p>

            <h5 class="optionhead">Separate media in tree folders</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Language</h5>
            ...
            <h5 class="optionhead">Dynamic Language Change</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Require Login</h5>
            ...
            <h5 class="optionhead">Restrict access to assigned tree</h5>
            ...
            <h5 class="optionhead">Show LDS Data</h5>
            ...
            <h5 class="optionhead">Show Living Data</h5>
            ...
            <h5 class="optionhead">Show Names for Living</h5>
            <p>To hide the names of individuals marked as Living (no death or burial information, plus a birthdate less than 110 years ago), select
            ...
            <h5 class="optionhead">Show Names for Private</h5>
            ...
            <h5 class="optionhead">Show cookie approval message</h5>
            ...
            <h5 class="optionhead">Show link to data protection policy</h5>
            ...
            <h5 class="optionhead">Prompt for consent regarding personal info</h5>
            ...
            <h5 class="optionhead">Site Key and Secret</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Name Order</h5>
            ...
            <h5 class="optionhead">Uppercase All Surnames</h5>
            ...
            <h5 class="optionhead">Surname Prefixes</h5>
            <p>Governs how surname prefixes (i.e., "de" or "van") are treated. By default, anything imported in the GEDCOM surname field is part of
                ...
                surnames are sorted ("de Kalb" comes before "van Buren"). You can elect to keep surname prefixes as part of the surname, or you can
            ...
            <h5 class="optionhead">Prefix Detection on Import</h5>
            <p>If you have elected to treat surname prefixes as separate entities, this section will provide rules to help the import routine decide
                what is a prefix. Prefixes are defined as
                portions of the name separated by spaces, but you can choose how many prefixes from each name will be part of TNG's prefix. In other
                words, if you indicate that
                the "Num. prefixes each (max)" is 1, then only the "van" from "van der Merwe" would be moved to the prefix field. On the other hand,
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Email Address</h5>
            ...
            <h5 class="optionhead">Send all mail from address above</h5>
            ...
            <h5 class="optionhead">Allow new user registrations</h5>
            <p>Allows you to turn off the option for visitors to request a user account on your site.</p>

            <h5 class="optionhead">Notify on reviewable submissions</h5>
            ...
            <h5 class="optionhead">Create new tree for user</h5>
            ...
            <h5 class="optionhead">Auto approve new users</h5>
            ...
            <h5 class="optionhead">Send acknowledgement email</h5>
            ...
            <h5 class="optionhead">Include password in welcome email</h5>
            ...
            <h5 class="optionhead">Use SMTP Authentication</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Enable Responsive Tables</h5>
            ...
            <h5 class="optionhead">Responsive Table Type</h5>
            ...
            <ul>
                ...
                <li><strong>Stack</strong>, which stacks the table headers to a two column layout with headers on the left when the viewport width is
            ...
            <br>
            <h5 class="optionhead">Enable Responsive Tables Mode Switcher:</h5>
            <p>The Mode Switcher option allows the user to switch between toggle, stack, or swipe table column displays.</p>

            <h5 class="optionhead">Enable Responsive Tables Mini Map</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Max Search Results</h5>
            ...
            <h5 class="optionhead">Individuals Start With</h5>
            ...
            <h5 class="optionhead">Show Notes</h5>
            ...
            <ul>
                ...
                <li>Underneath corresponding events where possible: Event-specific notes are displayed directly underneath the events to which they
                    correspond. General notes are displayed
                    at the bottom of the "Personal" section and each "Family" section. If the general notes are long, scroll bars will be provided to
                    prevent the pages from getting too long
                    (the max height of the area can be found in genstyle.css, in the "notearea" block).
                </li>
                <li>Underneath events, except general notes: Same as above, but general notes are always displayed in a separate block at the bottom
                    of the page. No max height is imposed.
                </li>
            </ul>

            <h5 class="optionhead">Scroll citations</h5>
            ...
            <h5 class="optionhead">Server time offset (hours)</h5>
            <p>If your server is in a different time zone than you are, enter the difference in hours here. If your time is behind the server time,
                enter a negative number.</p>

            <h5 class="optionhead">Edit timeout (minutes)</h5>
            <p>The number of minutes a user is allowed to have exclusive edit rights to any individual or family record. During this time, any other
            ...
            <h5 class="optionhead">Max Generations, GEDCOM download</h5>
            <p>The number of maximum number generations that can be exported in a publicly requested GEDCOM file.</p>

            <h5 class="optionhead">What's New Days</h5>
            <p>The number of days to keep new items on the "What's New" page. To remove this limitation, set the value to zero. Doing that will cause
                older
                items to remain on the list until bumped off by newer items.</p>

            <h5 class="optionhead">What's New Limit</h5>
            <p>The maximum number of items in each category to display on the "What's New" page.</p>

            <h5 class="optionhead">Numeric Date Preference</h5>
            ...
            <h5 class="optionhead">Encryption type</h5>
            ...
            <h5 class="optionhead">Assign Place records to Trees</h5>
            <p>If this is set to "Yes", then each Place record will be associated with one of your Trees. That means that if you have multiple trees,
                you could have
                the same place appear multiple times in your Places table because it is associated with more than one tree. If you change this option
                to "No", you
                will be given the chance to automatically merge all Places into a single list. If you change this option to "Yes", you will see the
                option to assign
                a particular Tree to all the Places (since they previously wouldn't have had any assignment).</p>

            <h5 class="optionhead">Geocode all new places</h5>
            <p>If this option is set to "Yes", then all new places entered in Admin/People and Admin/Families will be automatically geocoded (assumes
                an
                Internet connection).</p>

            <h5 class="optionhead">Re-use deleted IDs</h5>
            ...
            <h5 class="optionhead">Show last import</h5>
            <p>If this option is set to "Yes", the date of the most recent GEDCOM import will be shown on the What's New and Statistics pages when a
                tree is selected.</p>

            <h5 class="optionhead">Show 'Important tasks' messages</h5>
            ...
            <h5 class="optionhead">Show record totals on Admin menu</h5>
            <p>Allows TNG to show totals for each category on the main Admin menu. For example, if there are 1,000 people in your TNG trees, you will
                see "1,000" on the right side of the "People" bar.</p>

            <h5 class="optionhead">Alert if no backup in this many days</h5>
            ...
            <h5 class="optionhead">I am using TNG offline</h5>
