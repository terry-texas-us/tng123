...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">Adding New Repositories</h4></a>
            ...
            <p><strong>NOTE</strong>: If you are using this software in conjunction with a PC/Mac-based genealogy program which also creates IDs for
                new sources,
                it is HIGHLY RECOMMENDED that keep all IDs in sync between the two programs at all times. Failure to do this may result in collisions
                and may also cause
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="edit"><h4 class="subheadbold">Editing Existing Repositories</h4></a>
            <p>To make changes to an existing repository, use the <a href="#search">Search</a> tab to locate the repository, then click on the Edit
            ...
            <p>To add or manage additional events, click on the "Add New" button next to <strong>Other Events</strong>. See the <a
                ...
                each event allow you to edit or delete the event, or add notes. The order in which the events are displayed is determined by date (if
                applicable),
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="delete"><h4 class="subheadbold">Deleting Repositories</h4></a>
            <p>To delete one repository, use the <a href="#search">Search</a> tab to locate the repository, then click on the Delete icon next to that
                repository. The row will
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="merge"><h4 class="subheadbold">Merge</h4></a>
            ...
            <p>First, select a tree. You cannot merge repositories from different trees, so only one tree can be selected. After that, you have the
                option of
                selecting a repository as the starting point for your search (Repository ID 1), or letting TNG find the first match for you. If you'd
                rather let TNG
                find all matches, leave the Repository ID 1 field blank</p>

            <p>If you selected a repository as Repository ID 1, you may also decide to manually select Repository ID 2. If you'd rather let TNG find
                duplicates
            ...
            <p><em>Combine Media</em> means that media from Repository 2 will be kept and added to the media already existing for
                Repository 1 if the two are merged. If this option is not selected, all media links for Repository 2 will be deleted after the merge.
            </p>

            <p><strong>Warning!</strong> Once a merge has taken place, it cannot be undone! Please consider backing up your database tables before
            ...
            <p>Repository 2 is merged into Repository 1. The ID for Repository 1 will be retained, as will all other data for Repository 1 unless the
                corresponding box(es) for
                are checked for Repository 2. For example, if the box next to Author is checked for Repository 2, this data in this field will be
                copied from Repository 2's record to Repository 1's record
                during the merge. Corresponding data for Repository 1 will then be deleted. Boxes for Repository 2 are checked automatically when no
                corresponding data exists for Repository 1. If
