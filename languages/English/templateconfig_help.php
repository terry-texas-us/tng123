...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p><h5 class="optionhead">Using a Template</h5>TNG templates allow you to quickly give your site a professional look and feel. To use
            ...
            <p><h5 class="optionhead">Customizing</h5>You may certainly customize your site beyond what the template files allow. Your default
            ...
            <p><h5 class="optionhead">Supporting Multiple Languages</h5>If you want any of the the messages in your Template Settings to be
            available in
            ...
            <p><h5 class="optionhead">Simple Changes</h5>Changes can be made by directly editing the files mentioned in the previous paragraph,
            ...
            <p><h5 class="optionhead">Images</h5>If you would like to change an image, the easiest way click the "Change" button next to the field
            containing
            ...
            <p><h5 class="optionhead">Feature and Resource Links</h5>If your selected template includes either of these options, you can create
            links in those
            ...
            <p><h5 class="optionhead">Changing Your Mind</h5>You may choose options for multiple templates, but only one will be in use at any
