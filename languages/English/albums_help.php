    ...
    <table class="tblback normal">
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <a id="add"><h4 class="subheadbold">Adding New Albums</h4></a>
                <p>An <strong>Album</strong> in TNG is a grouping of media. An Album can include any number of media, and any particular media item
                    can belong to multiple albums. Like individual media, Albums can be linked to people, families, sources, repositories or places.
                </p>
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p style="float:right;"><a href="#top">Top</a></p>
                <a id="edit"><h4 class="subheadbold">Editing Existing Albums</h4></a>
                <p>To make changes to an existing Album, use the <a href="#search">Search</a> tab to locate the Album, then click on the Edit icon
                    next to
                    that Album.
                ...
                <p>To add media to an album, click on the "Add Media" button, then use the form in the resulting popup to select media from the items
                    ...
                    the
                    "Search for" field
                    and click the "Search" button. When you locate an item that you'd like to add to the Album, click on the "Add" link to the left of
                    the
                    item row. That
                    item will be added and the popup will remain. Repeat this step to locate and add more media, or click on the "Close Window" link
                    to
                    return to the Edit Album page.</p>

                <p>To remove media from an album, move your mouse pointer over the item. A "Remove" link will be revealed. Click that link to remove
                    the
                    item. After the
                    confirmation, the item will fade away.</p>

                <p>To choose one thumbnail to be the <strong>Default Photo</strong> for the current Album, move your mouse pointer over the item. A
                    "Make Default" link will be revealed.
                    Click that link to designate the thumbnail for that item as the Album's Default Photo. To select a different Default Photo, repeat
                    the process with a different
                    item in the list. To remove the Default Photo designation altogether, click on the "Remove default photo" link at the top of the
                    page.
                </p>

                <p>To reorder the media within the Album, click on the "Drag" area for any item and hold the mouse button down while moving the mouse
                ...
                <p>NOTE: All changes relating to Album Media and Album Links are saved immediately and do not require you to click the "Save" button
                    at
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p style="float:right;"><a href="#top">Top</a></p>
                <a id="delete"><h4 class="subheadbold">Deleting Albums</h4></a>
                <p>To delete an Album, use the <a href="#search">Search</a> tab to locate the Album, then click on the Delete icon next to that Album.
                    The
                    row will
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p style="float:right;"><a href="#top">Top</a></p>
                <a id="sort"><h4 class="subheadbold">Sorting Albums</h4></a>
                <p>By default, Albums linked to a Person, Family, Source, Repository or Place are sorted by the order in which they were linked to
                    that
                ...
                <p>After selecting or entering an ID, click on the "Continue" button to display all Albums for the selected entity and Collection in
                    their
                    current order.
                    To reorder the Albums, click on the "Drag" area for any item and hold the mouse button down while moving the mouse pointer to the
                    desired location
                    within the list. When the item has reached the selected point, release the mouse button ("drag and drop"). Changes are
                    automatically
                    saved at that point.</p>
