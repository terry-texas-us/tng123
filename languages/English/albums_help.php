...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            not have rights to view living data.
            </p>

            <p><h5 class="optionhead">Required fields:</h5> Album Name is the only required field, but it is in your best interest to fill in the
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>To choose one thumbnail to be the <strong>Default Photo</strong> for the current Album, move your mouse pointer over the item. A "Make Default" link will be revealed.
                ...
                item in the list. To remove the Default Photo designation altogether, click on the "Remove default photo" link at the top of the page.
            </p>
            ...
            <p>You can link this Album to people, families, sources, repositories or places. For each link, first select the Tree associated with the
                link entity.
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>After selecting or entering an ID, click on the "Continue" button to display all Albums for the selected entity and Collection in their
                current order.
