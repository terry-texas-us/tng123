    ...
    <table class="tblback normal">
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>The Action buttons next to each search result allow you to edit, delete or preview that result. To delete more than one record at a
                    ...
                    buttons to toggle all select boxes at once. You can also convert multiple items from one Collection to another, or add multiple
                    items
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p><strong>NOTE</strong>: If you are uploading now, the directory you indicate here must already exist and must be writeable by all.
                    If
                    not, use your FTP
                    program or online file manager to create the directory and give it proper rights (775 should work, but 777 is required on some
                    sites).
                </p>
                ...
                <p>You can select an existing physical file (either from your local computer or from your web site) to act as a "thumbnail" (smaller
                    ...
                    <strong>Notes:</strong>
                    Ideally, thumbnails should be between 50 and 100 pixels on a side. Your thumbnail <strong>CANNOT</strong> be the same as the
                    original
                    image! TNG will complain if you attempt to use
                    the original image as the thumbnail. If you do not already have a thumbnail, TNG can create one for you, but only if your media
                    item
                    is a valid JPG, GIF or PNG image.
                    TNG can also create thumbnails from some PDF files, but you may still be required to upload your own thumbnail for others
                    (especially
                    older PDFs).</p>
                ...
                <p>If your server supports the GD image library, you will see an option here to supply your own
                    ...
                    and/or suffix attached. This prefix and suffix, along with the max width and height of the thumbnail, are designated in the
                    General
                    Settings. <strong>Notes:</strong> Your
                    thumbnail <strong>CANNOT</strong> be the same as the original image! TNG will complain if you attempt to use the original image as
                    the
                ...
                <p>When an individual's genealogy is requested, thumbnail images of each photo linked to the individual are displayed on the same
                    page. If
                    a thumbnail
                    image for your media item has not yet been uploaded to your web site, click the "Browse" button and locate the thumbnail on your
                    hard
                    drive.
                    You must then enter the destination path and file name for the thumbnail image in the next field. If the thumbnail is already on
                    your
                    web site, leave this
                    field blank.</p>
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>You can link this media item to individuals, families, sources, repositories or places. For each link, first select the tree
                    ...
                    Next, select the Link Type (Person, Family, Source, Repository or Place), and finally, enter the ID number or name (Places only)
                    of
                    the link entity. After
                    all the information has been entered, click on the "Add" button.</p>

                <p>If you don't know the ID number or exact Place Name, click the magnifying glass icon to search for it. A popup window will appear
                    to
                    let you do the searching.
                    When you find the desired entity description, click the "Add" link at the left. You may click "Add" for multiple entities. When
                    you
                ...
                <p>Click the "Sort" link next to the Name to quickly jump to a page where you can sort similar media items for this entity. You can do
                    the
                ...
                <p>Note: The Latitude/Longitude/Zoom information for media items is for informational purposes only. The location is not pinpointed on
                    any
                ...
                <p>For each region you want to link to an individual, first select the individual's tree, then define the region by drawing a
                    rectangle on
                    the image with your
                    ...
                    select your image coordinates. After the coordinates have been selected, a popup box will be displayed to allow you to find or
                    enter
                    ...
                    displayed. The
                    box will close and the code for this region will be added to the Image Map box below the image. You may edit that code if
                    necessary, or you
                    may enter the image map code directly if desired.</p>

                <p>Repeat this process for any additional regions needed. All new code will be added to the end of that already in the Image Map
                    box.</p>
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>To delete one media item, use the <a href="#search">Search</a> tab to locate the item, then click on the Delete icon next to that
                    item.
                    The row will
                    change color and then vanish as the item is deleted. To delete multiple media at a time, check the box in the Select column next
                    to
                    each item to be
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                To convert media items from one media type or "Collection" to another, check the Select box next to those items on the <a
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                at the top of the page next to the "Add to Album" button. Finally, click the "Add to Album" button. Media can also be added to Albums
                from
                Admin/Albums.</p>
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>If you wish to sort only the media items attached to a specific event associated with the link entity, check the box marked "Link
                    ...
                    all the other fields &mdash; including ID &mdash; are filled in. That will cause an additional dropdown box to appear, from which
                    you
                    will select the
                ...
                <p>After selecting or entering an ID, click on the "Continue" button to display all media for the selected entity and Collection in
                    ...
                    desired location
                    within the list. When the item has reached the selected point, release the mouse button ("drag and drop"). Changes are
                    automatically
                ...
                <p>While sorting, you may also select any of the displayed photos as the current entity's <strong>Default Photo</strong>. That means
                    ...
                    selected image will appear on pedigree charts and in page titles with the current entity's name or title. To set or remove a
                    Default
                    Photo designation, hold
                    your mouse pointer over any of the listed images, then click on either of the now visible options of "Make Default" or "Remove".
                    The
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>When you click on the "Generate" button under this option, TNG will automatically create thumbnails for all JPG, GIF or
                    ...
                    create thumbnails for all images, including those that already have them. Check "Regenerate thumbnail path names were file does
                    not
                    exist" if
                ...
                <p>This option allows you to make the first photo for each individual, family and source be that entity's Default
                    ...
                    assignment can be
                    made for all individuals, families, sources and repositories in a particular tree by selecting that tree from the dropdown box.
                    Check
                    the box
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>To perform the import, first select a Collection (or add a new collection first) and a Tree (if the incoming items should be
                    ...
                    button. If a record already exists for an item, no new record is created. The "key" (what determines whether a record already
                    exists
                    or not) consists of
                    both the file name and the tree. If you import the same item into multiple trees (or if the item was once imported with "All
                    Trees"
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>To use, first select a Collection and a Tree (if the incoming items should be associated with a tree), then click "Add Files" and
                    ...
                    from another window directly into the white area in the middle of the screen. To select a subfolder within the selected media
                    location
                    as the destination
                ...
                <p>To link multiple media items to the same entity all at once, check the box on the row for each item (or use the "Select All" button
                    to
                    select all the
                    uploaded items), then use the fields at the bottom of the page to complete the operation. Enter the ID, or use the Find icon to
                    locate
