...
<table class="tblback normal">
    <tr class="fieldnameback">
        <td class="tngshadow">
            ...
            <h2 class="largeheader">Help: <small>Collections</small></h2>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="what"><h4 class="subheadbold">What are Collections?</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">Adding Collections</h4></a>
            ...
            <p>This is the name that will be displayed wherever collections are listed, and whenever items of this collection are shown. The Display
                ...
                this field.
                By default, the name you pick will be used in all languages. If you support multiple languages and want your Display Title to be
                translated into the languages
                you support, you will need to create an entry in the "cust_text.php" file in each language folder. The key of the $text message should
                be the collection ID,
            ...
            <p>Duplicate that line in the cust_text.php file for each language you support, translating only the "Military Records" portion. The key
            ...
            <p>The name of the physical folder or directory on your web site where items in this collection will be stored. It should be relatively
                ...
                create it. You should
                see a message indicating whether the creation was successful or not. If your server did not allow the operation, you will have to use
                an FTP program or
                an online file manager to create the folder. It should be created in the same parent folder as the "photos", "documents", "histories"
            ...
            <p>This field helps you determine how much of your local media path names need to be stored on your site during a GEDCOM import by
                ...
                are located on your home computer.
                In other words, if the files on your computer are located in "C:\MyGenealogy\MyCollectionFiles", that is what you should enter here.
                [Note: If your path contains backslashes,
                like the ones in the example here, you will need two enter two backslashes for each instance (\\). Forward slashes need only be
                entered once.] TNG will then
                strip that part from each incoming path name, leaving you with just the file name and any additional subfolder names.
                If the files for this collection are in more than one place on your local computer, or if your GEDCOM file refers to them without the
                full path name
                (ie, just "MyCollectionFiles"), include those paths as a multiple entries.
                If some of your files reside in subfolders of this location and you want to preserve that structure on your web site, do not include
                the
                subfolders in this path. If you want all files to go into the same folder on your site, leave this field blank. If the field is blank,
            ...
            <a id="edit"><h4 class="subheadbold">Editing/Deleting Collections</h4></a>
