    ...
    <table class="tblback normal">
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>To add a new timeline event, click on the <strong>Add New</strong> tab, then fill out the form. To make changes to an existing
                    event,
                    use
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>To delete one timeline event, use the <a href="#search">Search</a> tab to locate the event, then click on the Delete icon next to
                    that
                    event record. The row will
                    change color and then vanish as the event is deleted. To delete more than one event at a time, check the box in the Select column
                    next
                    to each event to be
