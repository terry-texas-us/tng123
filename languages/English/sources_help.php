...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">Adding New Sources</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="edit"><h4 class="subheadbold">Editing Existing Sources</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="delete"><h4 class="subheadbold">Deleting Sources</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p><em>Combine Notes</em> means that notes from Source 2 will
                be added to the notes from Source 1 for all merged fields. If this option is not selected and a field from Source 2 is checked, the
                notes from Source 2
            ...
            <p><em>Combine Media</em> means that media from Source 2
                will be kept and added to the media already existing for Source 1 if the two are merged. If this option is not selected, all media
                links for Source 2
            ...
            <p>Source 2 is merged into Source 1. The ID for Source 1 will be retained, as will all other data for Source 1 unless the corresponding
                ...
                from Source 2's
                record to Source 1's record during the merge. Corresponding data for Source 1 will then be deleted. Boxes for Source 2 are checked
                automatically
                when no corresponding data exists for Source 1. If a data field is not displayed for either Source 1 or Source 2, then no data exists
                in that field
