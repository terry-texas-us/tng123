    ...
    <table class="tblback normal">
        <tr class="fieldnameback">
            <td class="tngshadow">
                ...
                <h2 class="largeheader">Help: <small>Cemeteries</small></h2>
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <a id="add"><h4 class="subheadbold">Add New / Edit Existing Cemeteries</h4></a>
                <p>TNG allows you to categorize and display your headstone photos by cemetery. To do that, you must set up a new cemetery record for
                    each
                    location. Cemetery
                    records in TNG are not related to place records and there is no GEDCOM convention for cemeteries, so even if your GEDCOM file
                    contains
                ...
                <p>To add a new cemetery, click on the <strong>Add New</strong> tab, then fill out the form. To make changes to an existing cemetery,
                    use
                ...
                <p>If you had previously uploaded your map or photo to the Headstones folder, enter the path and file name as it exists within the
                    ...
                    your map or photo now using the previous field, use this box to enter a path and file name for your file after it is uploaded. A
                ...
                <p>For <strong>State/Province/Shire</strong> and <strong>Country</strong>, select an existing entry using the dropdown box. If the
                    desired
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p style="float:right;"><a href="#top">Top</a></p>
                <a id="delete"><h4 class="subheadbold">Deleting Cemeteries</h4></a>
