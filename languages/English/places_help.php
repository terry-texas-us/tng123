...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Locate existing Places by searching for all or part of the <strong>Place Name</strong>. Select a Tree to limit the results to places
                assigned to that tree.
                Check "Missing Latitude or Longitude" to show only places that still need geocoding. Check "Find only LDS temple codes" to only show
                5-character place names that
                have been flagged as LDS temples. Check the "Exact match only" option
                to further narrow your search. Searching with no options selected and no value in the search box will find all Places in your
                database.</p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">Add New / Edit Existing Places</h4></a>

            <p>TNG automatically adds a new Place record every time you enter a new place in Admin/People, in Admin/Families, or as part of any Custom
                Event.
                If you change an existing place on any of those screens and the result is a new, unique place name, then a new Place record will also
                be created.</p>
            ...
            <p>If your General Settings are configured so that Places are assigned to Trees, you will see a Tree selection box here. If that's the
                ...
                is created (instead, delete the Place and re-add it under another tree). If you don't want Places to be assigned to Trees, go to
            ...
            <p>Click the "Show/Hide Clickable Map" button to show the Google Map. This feature is only active if you have received a "key" from Google
                and entered it in your
                TNG Map Settings (see the <a href="mapconfig_help.php">Map Settings Help</a> for more information). Click the button again to hide the
                map. To have Google Maps search for a location,
                enter that location in the <strong>Geocode Location</strong> field and click the "Search" button. Alternately, you can click and drag
                on the map to move
                the "pin" until it sits at the desired location. You can also use the Zoom controls to show more detail around the desired area. See
                the
                <a href="places_googlemap_help.php">Google Maps Help</a> page for more information. Also see the <a href="mapconfig_help.php">Map
                    Settings Help</a>
            ...
            <p>Select the Place Level that best describes the granularity level of the location represented by the place name. This can help your
                visitors know how
                exact you were intending to be with your pin placements. For example, if you want to put a pin in France but you don't care where, you
                would select
            ...
            <p><strong>NOTE:</strong> Subsequent GEDCOM imports using the "Replace all current data" option will NOT overwrite or remove
                existing Place data if the existing records have information in the Latitude, Longitude or Notes fields, or if any media are attached.
            </p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="delete"><h4 class="subheadbold">Deleting Places</h4></a>
            <p>To delete one Place, use the <a href="#search">Search</a> tab to locate the Place, then click on the Delete icon next to that Place
                record. The row will
                change color and then vanish as the Place is deleted. To delete more than one Place at a time, check the box in the Select column next
                to each Place to be
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="merge"><h4 class="subheadbold">Merging Places</h4></a>
            To review and merge place names that may be slightly different but refer to the same location, click on the "Merge" tab. You will decide
            whether two
            ...
            <p>You must enter something in the first field, but the second field is optional. You might decide to enter something there
                if you're trying to merge two places whose names are not very similar. For example, if you want to merge <em>PA</em> and <em>Pennsylvania</em>,
            ...
            <p>Under this heading you will see a list of matches for your search criteria. If any of them refer to the same location,
                check the box labeled "Merge these (delete)" to the left for each one. Each selected row will turn red. Next, click the circle in the
                column labeled "into this (keep)" for
                the Place name that will replace all of the checked Places. That row will turn green. It doesn't matter if the Place Name to keep is
                also
                ...
                button at the top or the bottom of the screen. All instances of the deleted Places (in individual and family records) will be replaced
            ...
            <p>Please also note that performance degrades as more items are selected to merge. In other words, merging two places goes much faster
                than merging 20 places.</p>

            <p>To search again without merging, just enter a new value in the "Search for" box at the top of the screen and click "Continue"
                again.</p>
        </td>
    </tr>
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="geo"><h4 class="subheadbold">Geocode</h4></a>
            ...
            <p>Depending on how many Places you have that need geocoding, this process may take a long time. Google also limits you to 2,500 places
                per day, so for
                those reasons, you may wish to limit the number of places you do
                at any one time. The default number is 100. If you find that the first 100 go quickly, you might try increasing that number for the
                next batch.</p>

            <h5 class="optionhead">If multiple results are found:</h5>
            <p>If a place name is ambiguous, Google may return more than one match. The recommended action in this case is to ignore all the returned
