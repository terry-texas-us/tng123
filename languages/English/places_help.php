...
<table width="100%" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><p class="subheadbold">Add New / Edit Existing Places</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="delete"><p class="subheadbold">Deleting Places</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="merge"><p class="subheadbold">Merging Places</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="geo"><p class="subheadbold">Geocode</p></a>
