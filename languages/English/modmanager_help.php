    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <ul>
                ...
                <li><strong>Bypass the Confirmations</strong> - allows you to specify whether you want to bypass the Confirmation screen display in the Mod List. The Confirmation is still written to the log if you select Yes. The default is
                    <strong>No</strong>.
                </li>
                <li><strong>Bypass the Action Messages</strong> - allows you to specify whether you want to bypass the Action message screen display in the Mod List. The Action messages are still written to the log if you select Yes. The default is
                    <strong>No</strong>.
                </li>
            </ul>
            </p>
