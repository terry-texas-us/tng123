    ...
    <table class="tblback normal">
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>The TNG Mod Manager, originally developed by Brian McFadyen and updated by Sean Schwoere to work with the Joomla TNG Component, is
                    ...
                    package that have been coded to work with this manager. Updates were made in TNG V9 by Bart Degryse and Ken Roy to prevent clean
                    up
                ...
                <p>The <strong>Batch Updates</strong> was added by Rick Bisbee in TNG 10.0.3 to provide the capability to execute the same action
                    against
                    multiple mods. The Description popup was added by Jeff Robison.</p>
                <p>The <strong>Options</strong> was added by Ken Roy in TNG 10.0.3 to allow changing some of the execution behavior of the Mod
                    Manager.</p>
                <p>The <strong>View Log</strong> was added by Ken Roy in TNG 10.0.3 to display the Mod Manager Log which is now split from the Admin
                    Log.
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <ul>
                    ...
                    <li><strong>Installed</strong> if the mod is completely installed, the option to <strong>Remove</strong> the Mod is presented and
                        the
                        option to <strong>Edit</strong> parameters if any exist
                    </li>
                    <li><strong>Clean Up</strong> if the mod is partially installed, the <strong>Cleanup</strong> button is provided. A Clean up
                        operation
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <ul>
                    <li>Location - that specifies the code location to be changed</li>
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <ul>
                    ...
                    <li><strong>Unable to Install</strong> - displays a list of all the mods that cannot be installed, either due to Bad Targets or
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <ul>
                    <li><strong>Show Affected Files List</strong> - allows you to select whether to dislay the Affected Files List in the Mod List
                        tab.
                    ...
                    <li><strong>Show Files Copied in List</strong> - displays the files that are copied or copied to by the mod. The default is
                        <strong>Yes</strong>.
                    </li>
                    ...
                    <li><strong>Show List as</strong> - allows you to select whether you want the list as a Table or Comma Separated Values. It
                        defaults
                        to <strong>Table</strong>.
                    </li>
                    <li><strong>Show List in Batch Updates</strong> - allows you to select whether you want the list displayed in the More popup in
                        Batch
                ...
                <ul>
                    <li><strong>Log Mod Manager Actions</strong> - allows you to select whether you want to log the Mod Manager confirmation and
                        actions. The default is <strong>Yes</strong>.
                    </li>
                    ...
                    <li><strong>Log Max lines</strong> - allows you to specify how many lines to keep in the log. The default is <strong>2000</strong>.
                    </li>
                </ul>
                </p>
                <p><strong>Other Options</strong>
                <ul>
                    <li><strong>Sort Lists by</strong> - allows you to specify what column to sort the Mod List and Batch Updates. The default is
                        <strong>Config File Name</strong>.
                    </li>
                    <li><strong>Bypass the Confirmations</strong> - allows you to specify whether you want to bypass the Confirmation screen display
                        in the Mod List. The Confirmation is still written to the log if you select Yes. The default is
                        <strong>No</strong>.
                    </li>
                    <li><strong>Bypass the Action Messages</strong> - allows you to specify whether you want to bypass the Action message screen
                        display in the Mod List. The Action messages are still written to the log if you select Yes. The default is
                        <strong>No</strong>.
                    </li>
                </ul>
                </p>
