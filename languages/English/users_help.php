...
<table width="100%" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Setting up user records for your visitors allows you to give them special rights that they can enjoy only after logging in with their
                ...
                adequate rights, you may not be able to get back into the Admin area. If you forget your username, go to the TNG login page and enter
                the e-mail
            ...
            <p>To add a new user, click on the <strong>Add New</strong> tab, then fill out the form. To edit an existing user, click on the Edit icon
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>New user records listed on the Review page can be deleted or edited in the same way regular user records are deleted or edited. When
                editing a new user
