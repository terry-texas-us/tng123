...
<table width="100%" border="0" cellpadding="10" cellspacing="2" class="tblback normal">
  <tr class="fieldnameback">
    ...
    <tr class="databack">
        <td class="tngshadow">
          ...
          <p>Enter the ID number or name associated with this test. If you can't find a number or the vendor didn't give you one, feel free to make up a new number or name. <br><strong>Note </strong> that if you do not enter a value for the Test
          ...
          <p>The <strong>mtDNA Haplogroup</strong> field is provided for the matrilineal haplogroup normally provided with the mtDNA test.</p>
            ...
            <p>The confirmed checkbox is used to indicate that the test provided a confirmed haplogroup as opposed to a predicted one. Because a haplogroup consists of similar haplotypes, it is possible to predict a haplogroup from the haplotype. A SNP
                test is required to confirm the haplogroup prediction. Not all the testing companies offer SNP testing, and consequently their customer's haplogroup predictions are sometimes inaccurate.</p>
        </td>
    </tr>
  <tr class="databack">
    <td class="tngshadow">
      ...
      <p>A genetic marker is a gene or DNA sequence with a known location on a chromosome that can be used to identify an individual. DNA tests can be distinguished by the number of markers they test for.<br>Typical Y-DNA tests can be done for 12,
        25, 37, 44, 67, 91, 101 or 111 markers.<br>Because Family Tree DNA is currently the only vendor offering Y-DNA tests these days, 12, 25, 37, 67, and 111 markers are used in the Y-DNA comparison report.</p>

      <p><strong>Marker Values</strong></p>
      <p>Enter your Y-DNA marker values separated by commas.<br>For example, "13,24,14,10,11-14,12,12,12,13,14,30,17,9-10,11,11,24,15,19,30,15-15-16-17" (without quotes).<br>or with blanks after the comma for readability, "13, 24, 14, 10, 11-14,
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <ul>
                ...
                <li>The <strong>coding region (CR)</strong> is the part of your mtDNA genome that contains genes which runs from nucleotide 00575 to nucleotide 16000.</li>
            </ul>
            </p>
          ...
          <p>Enter your mtDNA test results in the provided input fields separated by commas.<br>For example, "A16129G,T16187C,C16189T,T16223C,G16230A,T16278C,C16311T,C16519T".<br>You can also enter the results with a blank after the comma for increased
  ...
  <tr class="databack">
    <td class="tngshadow">
      ...
      <p><strong>Shared DNA</strong><br>
        Shared DNA segments, also referred to as ‘matching segments’, are the sections of DNA that are identical between two individuals. These segments were most likely inherited from a common ancestor. When deciding which DNA matches to pursue,
        follow up on the ones with more than one large segment; those are your closer relatives, the ones whose trees may be easier to connect to yours.</p>

      <p><strong>Total shared cMs</strong><br>
        This is the sum of the autosomal DNA, given in centimorgans (cM), that you and your genetic match share.<br>See <a href="https://dnapainter.com/tools/sharedcmv4" traget="_blank">The Shared cM Project Tool</a> for the relationship
  ...
  <tr class="databack">
    <td class="tngshadow">
      ...
      <p>Enter the most distant paternal (Y-DNA) or maternal (mtDNA) ancestor's of the person taking the test. Different Y-DNA and mtDNA testers might have different most distant ancestors depending on how far back they have taken their paper
        trail.</p>
