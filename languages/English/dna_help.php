...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">Adding New Tests</h4></a>
            ...
            <p>You can assign a test to a previously created DNA test group.<br>To create a DNA test group go to Admin >> DNA Tests >> and click on
                the DNA Groups tab. Then click on the Add New tab.</p>

            <h5 class="optionhead">DNA Groups</h5>
            <p>DNA Groups are used to select or filter DNA tests or test_types in a list. You should consider creating your DNA Groups in a meaningul
                way to restrict the list of tests displayed. For example, you might create a group for your paternal line
                and another group for your maternal line. DNA Groups are just a way to filter a list of tests. Linking tests to a group is optional.
            ...
            <p>A haplogroup is a genetic population of people who share a common ancestor on the patrilineal or matrilineal line. Haplogroups are
                ...
                tests or if the test taker also took the mtDNA or Y-DNA test.</p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="ydna"><h4 class="subheadbold">Y-DNA Test Result Fields</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <ul>
                <li><strong>RSRS</strong> - Reconstructed Sapiens Reference Sequence is a mitochondrial DNA (mtDNA) reference sequence that uses both
                    a global sampling of modern human samples and samples from ancient hominids. It was introduced in early
                    2012 as a replacement for the rCRS (revised Cambridge Reference Sequence). The RSRS keeps the same numbering system as the CRS,
                    but represents the ancestral genome of Mitochondrial Eve, from which all currently known human mitochondria
                    descend.
                </li>

                <li><strong>rCRS</strong> - Revised Cambridge Reference Sequence for human mitochondrial DNA was first announced in 1981 leading to
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="common"><h4 class="subheadbold">Common Test Result Fields</h4></a>
            ...
            <p>This field applies to all test types and will be auto-filled with comma separated ancestral surnames of the person who took the Y-DNA
                and mtDNA tests only<br>The surnames returned depends on the test type and you may edit any way you
                like.<br>In Admin >> Setup >> Configuration >> General Settings>>Names there is an option for surname exclusion such as unknown or
            ...
            <p>If there are web sites or pages associated with this test, enter them here. Put each link on a new line. Enter the site or page title
            ...
            <p>Check the box next to any information you want displayed on a person's page (getperson.php).<br>All supplied info will be displayed on
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="edit"><h4 class="subheadbold">Editing Existing Tests</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="delete"><h4 class="subheadbold">Deleting Existing Tests</h4></a>
