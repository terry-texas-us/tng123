    ...
    <table class="tblback normal">
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>To add a new test, click on the <strong>Add New</strong> tab, then fill out the form. The test can be linked to people in the
                    database
                ...
                <p>DNA Groups are used to select or filter DNA tests or test_types in a list. You should consider creating your DNA Groups in a
                    ...
                    and another group for your maternal line. DNA Groups are just a way to filter a list of tests. Linking tests to a group is
                    optional.
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>Your Y-chromosome DNA (Y-DNA) can trace your father, his father, his father’s father, and so forth using STR markers, which are
                    places
                    where your genetic code has a variable number of repeated parts.</p>
                <p><strong>Number of Markers</strong></p>
                <p>A genetic marker is a gene or DNA sequence with a known location on a chromosome that can be used to identify an individual. DNA
                    tests
                    can be distinguished by the number of markers they test for.<br>Typical Y-DNA tests can be done for 12,
                    25, 37, 44, 67, 91, 101 or 111 markers.<br>Because Family Tree DNA is currently the only vendor offering Y-DNA tests these days,
                    12,
                ...
                <p>Enter your Y-DNA marker values separated by commas.<br>For example,
                    "13,24,14,10,11-14,12,12,12,13,14,30,17,9-10,11,11,24,15,19,30,15-15-16-17" (without quotes).<br>or with blanks after the comma
                    for
                    readability, "13, 24, 14, 10, 11-14,
                    12, 12, 12, 13, 14, 30, 17, 9-10, 11, 11, 24, 15, 19, 30,1 5-15-16-17" (without quotes).</p>
                <p>Note that Y-DNA STRs that have multiple values must be entered using a dash between the values since the number of multiple values
                    can
                    be variable</p>

                <strong>SNPs</strong></p>
                <p>An SNP (Single-nucleotide polymorphism) happens when a single place in the genome sequence is altered during the cell formation
                    process and this mutation persists in the progeny. A person has many inherited SNPs that together create a unique
                    (UEP) DNA pattern for that individual.</p>
                <p>In genetic genealogy a unique-event polymorphism (UEP) is a genetic marker that corresponds to a mutation which is likely to occur
                    so infrequently that it is believed overwhelmingly probable that all the individuals who share the marker,
                ...
                <p>A terminal SNP is the defining SNP of the latest branch of a haplogroup known by current research. It should be unique and constant
                    in
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <ul>
                    ...
                    <li>The <strong>coding region (CR)</strong> is the part of your mtDNA genome that contains genes which runs from nucleotide 00575
                        to
                        nucleotide 16000.
                    </li>
                </ul>
                ...
                <p>The sbove information on mtDNA was extracted from the <a
                        href="https://www.familytreedna.com/learn/mtdna-testing/parts-mitochondrial-dna-mtdna-hvr1-hvr2-coding-region/"
                        target="_blank">The
                        Family Tree DNA Learning Center</a></p>

                <p><strong>Reference Sequence</strong></p>
                <p> You can select one of two reference sequence for the mtDNA test result fields. Family Tree DNA provides both sequence, so you need
                    to chose which version of the results you are entering in the input fields.
                <ul>
                    <li><strong>RSRS</strong> - Reconstructed Sapiens Reference Sequence is a mitochondrial DNA (mtDNA) reference sequence that uses
                        both
                        a global sampling of modern human samples and samples from ancient hominids. It was introduced in early
                        2012 as a replacement for the rCRS (revised Cambridge Reference Sequence). The RSRS keeps the same numbering system as the
                        CRS,
                        but represents the ancestral genome of Mitochondrial Eve, from which all currently known human mitochondria
                        descend.
                    </li>

                    <li><strong>rCRS</strong> - Revised Cambridge Reference Sequence for human mitochondrial DNA was first announced in 1981 leading
                        to
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p><strong>Shared DNA</strong><br>
                    ...
                    follow up on the ones with more than one large segment; those are your closer relatives, the ones whose trees may be easier to
                    connect
                    to yours.</p>
                ...
                <p><strong>shared segments</strong><br>
                    Number of shared segments in this shared DNA match. The more segments you share and the greater the length of those segments, the
                    more closely related you are.</p>

                <p><strong>Largest Segment</strong><br>
                    Segments which share a large number of centiMorgans in common are more likely to be of significance and to indicate a common
                    ancestor within a genealogical timeframe. This is the largest shared seqment in this DNA match.</p>
                ...
                <p><strong>centiMorgans</strong><br>
                    In genetic genealogy, a centiMorgan (cM) or map unit (m.u.) is a unit of recombinant frequency which is used to measure genetic
                    distance. This is the number of cMs in the largest matching seqment.</p>
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>To make changes to an existing test, use the <a href="#search">Search</a> tab to locate the test, then click on the Edit icon next
                    to
                    that test.</p>
                ...
                <p>If you don't know the ID number, click the magnifying glass icon to search for it. A popup window will appear to let you do the
                    searching.
                    When you find the desired individual, click the person's name to add their ID to the add box, then click the "Add" button as
                    described
                    above.</p>
        ...
        <tr class="databack">
            <td class="tngshadow">
                ...
                <p>To delete a test, use the <a href="#search">Search</a> tab to locate the test, then click on the Delete icon next to that test. The
                    row
                    will
                    change color and then vanish as the test is deleted. To delete more than one test at a time, check the box in the Select column
                    next
                    to each test to be
