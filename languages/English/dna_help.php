...
<table width="100%" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Locate existing tests by searching for all or part of the <strong>Person ID</strong> or <strong>Name</strong>. Select a Tree or check
                one of the other options to further narrow your search.
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><p class="subheadbold">Adding New Tests</p></a>
            <p>To add a new test, click on the <strong>Add New</strong> tab, then fill out the form. The test can be linked to people in the database
            ...
            <p>Enter the ID number or name associated with this test. If you can't find a number or the vendor didn't give you one, feel free to make
          ...
          <p>This is the date on which your test was matched to the person who took the DNA test.</p>
            ...
            <p>If you enter Yes to keep this test private, the test display will be restricted to logged in users who have the <strong>Allow Private</strong> privilege. This allows you to restrict access to DNA Tests that you marked as Keep Test Private.
              The test will be viewable by the TNG Administrator</p>

          <span class="optionhead">Person who took this test</span>
          <p>This is the person who took the test. Select the tree and enter the person's ID, or click the magnifying glass to look up the individual by name. OR you can enter the name of a person not in your database. You must select a tree, even if the
          ...
          <p>DNA Groups are used to select or filter DNA tests or test_types in a list. You should consider creating your DNA Groups in a meaningul way to restrict the list of tests displayed. For example, you might create a group for your paternal line
            and another group for your maternal line. DNA Groups are just a way to filter a list of tests. Linking tests to a group is optional. Note that you DNA Groups are now associated to the test type and you cannot use the same DNA Group name for
            two different test types.</p>

          <span class="optionhead">Haplogroup</span>
          <p>A haplogroup is a genetic population of people who share a common ancestor on the patrilineal or matrilineal line. Haplogroups are assigned letters of the alphabet (A-T), and refinements (SNPs) consist of additional number and letter
            combinations. Two separate input fields are provided because some testing companies provide both as estimated haplogroups on atDNA tests or if the test taker also took the mtDNA or Y-DNA test.</p>
          <p>The <strong>mtDNA Haplogroup</strong> field is provided for the matrilineal haplogroup normally provided with the mtDNA test.</p>
            ...
            <p>Some testing companies provide a mtDNA and Y-DNA Haplogroup on their atDNA tests. Family Tree DNA provides it if the corresponding
                mtDNA and Y-DNA tests were taken. Other testing companies predict what the haplogroups might be.</p>

            <p>The confirmed checkbox is used to indicate that the test provided a confirmed haplogroup as opposed to a predicted one. Because a
                haplogroup consists of similar haplotypes, it is possible to predict a haplogroup from the haplotype. A SNP
                test is required to confirm the haplogroup prediction. Not all the testing companies offer SNP testing, and consequently their
                customer's haplogroup predictions are sometimes inaccurate.</p>
        </td>
    </tr>
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="ydna"><p class="subheadbold">Y-DNA Test Result Fields</p></a>

            <p>Your Y-chromosome DNA (Y-DNA) can trace your father, his father, his father’s father, and so forth using STR markers, which are places
                where your genetic code has a variable number of repeated parts.</p>
            <p><strong>Number of Markers</strong></p>
            <p>A genetic marker is a gene or DNA sequence with a known location on a chromosome that can be used to identify an individual. DNA tests
                can be distinguished by the number of markers they test for.<br>Typical Y-DNA tests can be done for 12,
                25, 37, 44, 67, 91, 101 or 111 markers.<br>Because Family Tree DNA is currently the only vendor offering Y-DNA tests these days, 12,
                25, 37, 67, and 111 markers are used in the Y-DNA comparison report.</p>

            <p><strong>Marker Values</strong></p>
            <p>Enter your Y-DNA marker values separated by commas.<br>For example,
                "13,24,14,10,11-14,12,12,12,13,14,30,17,9-10,11,11,24,15,19,30,15-15-16-17" (without quotes).<br>or with blanks after the comma for
                readability, "13, 24, 14, 10, 11-14,
                12, 12, 12, 13, 14, 30, 17, 9-10, 11, 11, 24, 15, 19, 30,1 5-15-16-17" (without quotes).</p>
            <p>Note that Y-DNA STRs that have multiple values must be entered using a dash between the values since the number of multiple values can
                be variable</p>

      <strong>SNPs</strong></p>
      <p>An SNP (Single-nucleotide polymorphism) happens when a single place in the genome sequence is altered during the cell formation process and this mutation persists in the progeny. A person has many inherited SNPs that together create a unique
        (UEP) DNA pattern for that individual.</p>
      <p>In genetic genealogy a unique-event polymorphism (UEP) is a genetic marker that corresponds to a mutation which is likely to occur so infrequently that it is believed overwhelmingly probable that all the individuals who share the marker,
        worldwide, will have inherited it from the same common ancestor, and the same single mutation event.</p>
      ...
      <p><strong>Significant SNPs</strong></p>
            ...
            <p>A terminal SNP is the defining SNP of the latest branch of a haplogroup known by current research. It should be unique and constant in
                time. Sometimes “terminal SNP” is used to mean the SNP for which a man has most recently tested.</p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="mtdna"><p class="subheadbold">mtDNA Test Result Fields</p></a>

            <p><span class="optionhead">Mitochondrial DNA (mtDNA) </span> traces your ancestry from your mother to her mother, her mother's mother,
            ...
            <ul>
                ...
                <li>The <strong>coding region (CR)</strong> is the part of your mtDNA genome that contains genes which runs from nucleotide 00575 to
                    nucleotide 16000.
                </li>
            </ul>
            </p>
            <p>The sbove information on mtDNA was extracted from the <a
            ...
            <ul>
              <li><strong>RSRS</strong> - Reconstructed Sapiens Reference Sequence is a mitochondrial DNA (mtDNA) reference sequence that uses both a global sampling of modern human samples and samples from ancient hominids. It was introduced in early
                2012 as a replacement for the rCRS (revised Cambridge Reference Sequence). The RSRS keeps the same numbering system as the CRS, but represents the ancestral genome of Mitochondrial Eve, from which all currently known human mitochondria
                descend.
              </li>

              <li><strong>rCRS</strong> - Revised Cambridge Reference Sequence for human mitochondrial DNA was first announced in 1981 leading to the initiation of the human genome project.</li>
            </ul>
          </p>
            ...
            <p>Enter your mtDNA test results in the provided input fields separated by commas.<br>For example,
                "A16129G,T16187C,C16189T,T16223C,G16230A,T16278C,C16311T,C16519T".<br>You can also enter the results with a blank after the comma for
                increased
                reasability, for example "A16129G, T16187C, C16189T, T16223C, G16230A, T16278C, C16311T, C16519T" (without the quotes)</p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="atdna"><p class="subheadbold">atDNA Test Result Fields</p></a>

            <p><span class="optionhead">Autosomal DNA (atDNA) </span> checks your autosomal chromosomes, that is the other 22 pairs beyond the
            ...
            <p><strong>Shared DNA</strong><br>
                Shared DNA segments, also referred to as ‘matching segments’, are the sections of DNA that are identical between two individuals.
                These segments were most likely inherited from a common ancestor. When deciding which DNA matches to pursue,
                follow up on the ones with more than one large segment; those are your closer relatives, the ones whose trees may be easier to connect
                to yours.</p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="common"><p class="subheadbold">Common Test Result Fields</p></a>

            <p>The following fields are common to all test types>/p>

                <span class="optionhead">Most distant ancestor</span>
            <p>Enter the most distant paternal (Y-DNA) or maternal (mtDNA) ancestor's of the person taking the test. Different Y-DNA and mtDNA testers
            ...
            <p>Enter the personID of the most recent common ancestor(MRCA). The MRCA is the shared common ancestor between two or more test takers.
      ...
      <p>This field applies to all test types and will be auto-filled with comma separated ancestral surnames of the person who took the Y-DNA and mtDNA tests only<br>The surnames returned depends on the test type and you may edit any way you
        like.<br>In Admin >> Setup >> Configuration >> General Settings>>Names there is an option for surname exclusion such as unknown or UNKNOWN and an option to display the surnames in uppercase.<br>There is now also an option for how many
      ...
      <p>If there are web sites or pages associated with this test, enter them here. Put each link on a new line. Enter the site or page title and the URL, separated by a comma. For example, "Ancestry.com,https://www.ancestry.com". If you don't
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="edit"><p class="subheadbold">Editing Existing Tests</p></a>
            <p>To make changes to an existing test, use the <a href="#search">Search</a> tab to locate the test, then click on the Edit icon next to
                that test.</p>
            ...
            <p>If you don't know the ID number, click the magnifying glass icon to search for it. A popup window will appear to let you do the
                searching.
                When you find the desired individual, click the person's name to add their ID to the add box, then click the "Add" button as described
                above.</p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="delete"><p class="subheadbold">Deleting Existing Tests</p></a>
            <p>To delete a test, use the <a href="#search">Search</a> tab to locate the test, then click on the Delete icon next to that test. The row
                will
                change color and then vanish as the test is deleted. To delete more than one test at a time, check the box in the Select column next
                to each test to be
