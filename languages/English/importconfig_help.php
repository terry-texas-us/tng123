    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>If your data import or export fails to complete for any reason, select this option and rerun the import/export. If it fails again,
                ...
                off. For imports, this option only works if your GEDCOM file is already in your GEDCOM folder (it does not work with files uploaded
            ...
            <p>TNG will set the Private flag for an individual during a GEDCOM import if the person has not been deceased more than this many years.
                Leave
            ...
            <p>The same as the last option, TNG will set the Living flag for an individual during a GEDCOM import if the person has not been deceased
            ...
            <p>If you check the box for "Allow TNG to assign names to embedded media", TNG will ignore the path and file names associated with your
                embedded media and will
                assign a new file name based on the convention tree ID + media ID + media extension. The file will then be placed in the Photos folder
                (as defined in the General Settings).
                You might want to select this option if you have imported embedded media in the past, since TNG used this convention by default prior
                to version 3.4.0. If you have TNG-assigned
            ...
            <p>Enter the base path or paths (separate multiple entries with commas) where photos are located on your home computer. It should
                ...
                enter here. If some of your photo links
                ...
                reside in subfolders of this location and you want to preserve that structure on your web site, do not include the subfolders in this
                path. If you want all photos to go
                into the same location (the TNG Photos folder), leave this field blank and check "Import file name only" for the last option on this
                page.</p>
            ...
            <p>Enter the base path or paths (separate multiple entries with commas) where histories are located on your home computer. It should
                ...
                refer to that location in relative terms (ie, just "MyHistories"), include the relative path as a multiple entry. If some of your
                histories
                reside in subfolders of this location and you want to preserve that structure on your web site, do not include the subfolders in this
                path. If you want all histories to go
            ...
            <p>Enter the base path or paths (separate multiple entries with commas) where documents are located on your home computer. It should
                ...
                should enter here. If some of your document links
                refer to that location in relative terms (ie, just "MyDocuments"), include the relative path as a multiple entry. If some of your
                documents
                reside in subfolders of this location and you want to preserve that structure on your web site, do not include the subfolders in this
                path. If you want all documents to go
            ...
            <p>Enter the base path or paths (separate multiple entries with commas) where headstone images are located on your home computer. It
                ...
                on your web site. In other words, if the headstones on your computer are located in "C:\MyGenealogy\MyHeadstones", that is what you
                should enter here. If some of your headstone links
                refer to that location in relative terms (ie, just "MyHeadstones"), include the relative path as a multiple entry. If some of your
                headstones
                reside in subfolders of this location and you want to preserve that structure on your web site, do not include the subfolders in this
                path. If you want all headstones to go
                into the same location (the TNG Headstones folder), leave this field blank and check "Import file name only" for the last option on
                this page.</p>

            <h5 class="optionhead">Local Path(s) for Other Media</h5>
            <p>Enter the base path or paths (separate multiple entries with commas) where other media (ie, videos or recordings) are located on your
                home computer. It should correspond to the TNG Multimedia folder
                on your web site. In other words, if the videos or recordings on your computer are located in "C:\MyGenealogy\MyMultimedia", that is
                what you should enter here. If some of your multimedia links
                refer to that location in relative terms (ie, just "MyMultimedia"), include the relative path as a multiple entry. If some of your
                videos or recordings
                reside in subfolders of this location and you want to preserve that structure on your web site, do not include the subfolders in this
                path. If you want all videos/recordings to go
                into the same location (the TNG Multimedia folder), leave this field blank and check "Import file name only" for the last option on
                this page.</p>
            ...
            <p>If you would like some of your notes to be labeled as "private" on import and not be displayed in the public areas, TNG can do that if
                all
                notes fitting that description start with the same character. Characters commonly used for this purpose are the tilde (~) or the
                exclamation
