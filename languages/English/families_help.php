...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Locate existing families by searching for all or part of the <strong>Family ID</strong>, <strong>Father's Name</strong> or <strong>Mother's
                    Name</strong>.
                Select a Tree or check "Exact match only" to further narrow your search. Select "Father's Name" to have your search criteria compared
                against all fathers' names.
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">Adding New Families</h4></a>
            <p>A <strong>Family</strong> is needed for every relationship between a "Father" and a "Mother" (children may or may not be included). If
                a person is married multiple times
            ...
            <p>Select existing individuals to be the <strong>Father</strong> or <strong>Mother</strong> in this family by clicking "Find...", or
                ...
                Father or Mother field (it cannot be edited directly). To remove a spouse from the relationship (does not delete the spouse from the
                database),
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="edit"><h4 class="subheadbold">Editing Existing Families</h4></a>
            ...
            <p><strong>Note</strong>: Notes, source citations, "Other" events and "More" information for standard events are all saved automatically.
                Other changes (e.g., to
            ...
            <p>Select existing individuals to be children in this family by clicking "Find", or create new children by clicking
                ...
                edited directly, but you can use the "Remove" link (visible when your mouse pointer is over each child) to remove a child from the
                list. You can
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Top</a></p>
            <a id="delete"><h4 class="subheadbold">Deleting Families</h4></a>
            <p>To delete one family, use the <a href="#search">Search</a> tab to locate the individual, then click on the Delete icon next to that
                family. The row will
                change color and then vanish as the family is deleted (the spouses and children will not be deleted, but the relationship will be
                disssolved).
