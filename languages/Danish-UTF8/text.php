...
$text['contactus_long'] = "Hvis du har spørgsmål eller kommentarer til oplysningerne på denne hjemmeside, så kontakt os venligst <span class=\"emphasis\"><a href=\"suggest.php\"></a></span>. Vi glæder os til at høre fra dig.";
...
$text['text_for'] = "for";
//added in 11.0.0
$text['searchsite'] = "Søg på denne hjemmeside";
$text['searchsitemenu'] = "Søg hjemmeside";
...
//added in 12.0.1
$text['cookieuse'] = "Bemærk: Denne hjemmeside bruger cookies.";
$text['dataprotect'] = "EU-persondataforordningen";
$text['viewpolicy'] = "Vis databeskyttelsespolitik";
$text['understand'] = "OK";
$text['consent'] = "Jeg giver mit samtykke til, at denne hjemmeside kan gemme de personlige oplysninger, der er indsamlet her. Jeg forstår, at jeg kan bede hjemmesidens ejer om at fjerne disse oplysninger til enhver tid.";
...
$text['wasborn_male'] = "blev født";
$text['wasborn_female'] = "blev født";
$text['waschristened_male'] = "blev døbt";
$text['waschristened_female'] = "blev døbt";
$text['died_male'] = "døde";
$text['died_female'] = "døde";
