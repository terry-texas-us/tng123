...
switch ($textpart) {
    ...
    case "gedcom":
        ...
        $text['nomaxgen'] = "Morate da odredite maksimalan broj generacija. Vratite se na prethodnu stranu, koristeci dugme za nazad i ispravite gre�ku.";
        $text['gedcreatedfrom'] = "GEDCOM napravljen od";
        $text['gedcreatedfor'] = "napravljen za";
        $text['creategedfor'] = "Kreiranje GEDCOM fajlova";
        $text['email'] = "Va�a E-mail adresa";
        $text['suggestchange'] = "Predlog za izmenu ili dopunu podataka";
        $text['yourname'] = "Va�e ime i prezime";
        $text['comments'] = "Komentar";
        $text['comments2'] = "Va� komentar";
        $text['submitsugg'] = "Po�alji primedbu";
        $text['proposed'] = "Predlo�ena izmena";
        $text['mailsent'] = "Hvala vam. Va�a poruka je poslata.";
        $text['mailnotsent'] = "�ao nam je, ali va�a poruka nemo�e biti isporucena.";
        $text['mailme'] = "Po�alji kopiju i na ovu adresu";
        $text['entername'] = "Zaboravili ste da upi�ete va�e ime.";
        $text['entercomments'] = "Zaboravili ste da upi�ite va� komentar";
    ...
    case "getperson":
        ...
        $text['thanks'] = "Hvala";
        $text['received'] = "Va�a primedba je prosledena administratoru.";
    ...
    case "relate":
        ...
        $text['enternamepart'] = "Upi�ite deo imena i / ili prezimena";
        $text['pleasenamepart'] = "Upi�ite deo imena ili prezimena.";
        $text['clicktoselect'] = "Kliknite mi�em i odaberite";
        ...
        $text['findrelinstr'] = "Da bi ste videli stepen srodstva izmedu dve osobe, koristite dugme 'TRA�I' za pronala�enje osoba (ili zadr�ite vec upisanu osobu), zatim pritisnite dugme 'IZRACUNAJ'.";
    ...
    case "search":
    case "reports":
        $text['noreports'] = "Ne postoji nijedan izve�taj.";
        $text['reportname'] = "Ime izve�taja";
        $text['allreports'] = "Svi izve�taji";
        $text['report'] = "Izve�taj";
        $text['error'] = "Gre�ka";
        $text['reportsyntax'] = "Sintaksa upita koji radi uz izve�taj";
        $text['wasincorrect'] = "je pogre�na, i kao rezultat izve�taj nemo�e biti pokazan. Kontaktirajte system administratora : vladeta@batocanin.com";
        $text['errormessage'] = "Gre�ka";
        $text['equals'] = "nalik na";
        $text['endswith'] = "zavr�ava se sa";
        $text['soundexof'] = "zvuci kao";
        $text['metaphoneof'] = "metafora od";
        $text['plusminus10'] = "+/- 10 godina od";
        $text['lessthan'] = "manje od";
        $text['greaterthan'] = "vi�e od";
        $text['lessthanequal'] = "manje ili jedanko";
        $text['greaterthanequal'] = "vece ili jednako";
        $text['equalto'] = "jednako";
        $text['tryagain'] = "Poku�ajte ponovo";
        $text['joinwith'] = "Odnos parametara";
        $text['cap_and'] = "I";
        $text['cap_or'] = "ILI";
        $text['showspouse'] = "Poka�i bracne partnere (ime se po";
        $text['submitquery'] = "Va� upit";
        ...
        $text['showdeath'] = "Poka�i informacije o smrti/sahrani";
        $text['altbirthplace'] = "Mesto kr�tenja";
        ...
        $text['enterdate'] = "Upi�ite ili odaberite minimum jednu od ovih informacijs: dan, mesec, godina, kljucna rec";
    ...
    case "showlog":
        ...
        $text['mostrecentactions'] = "poslednjih izvr�enih upita.";
    ...
    case "showphoto":
        ...
        $text['showallhsr'] = "Poka�i sve zapise o spomenicima";
        $text['in'] = "-";
        $text['showmap'] = "Poka�i plan";
    ...
    case "places":
        ...
        $text['placesstarting'] = "Poka�i mesta cije ime pocinje sa";
        $text['showmatchingplaces'] = "Kliknite na ime mesta da vidite manje lokalitete. Kliknite na lupu ako �elite da vidite koje sve povezan sa tom lokacijom.";
        $text['totalnames'] = "ukupno osoba";
        $text['showallplaces'] = "Poka�i sva veca mesta";
        $text['totalplaces'] = "ukupno mesta";
        $text['mainplacepage'] = "Poka�i pocetnu listu mesta";
        $text['allplaces'] = "Sva veca mesta";
        $text['placescont'] = "Poka�i sva mesta koja u imenu sadr�e";
        //changed in 8.0.0
    ...
    case "timeline":
        ...
        $text['nobirth'] = "Odabrana osoba nema korektan datum rodenja i nemo�e biti dodata.";
        $text['event'] = "Dogadaj(i)";
        $text['chartwidth'] = "�IRINA DIJAGRAMA";
        $text['timelineinstr'] = "Dodaj nove osobe unoseci njihov ID u donja polja:";
        $text['togglelines'] = "Toggle Lines";
        //changed in 9.0.0
        $text['noliving'] = "Odabrana osoba je markirana kao �iva i ne mo�e biti dodata jer vi nemate dovoljno prava";
        break;
    ...
    case "trees":
    case "login":
        $text['browsealltrees'] = "Pretra�ivanje svih porodicnih stabala";
        ...
        $text['realname'] = "Va�e pravo ime";
        $text['phone'] = "Telefon";
        $text['email'] = "Va�a E-mail adresa";
        $text['address'] = "Adresa";
        $text['acctcomments'] = "Komentar";
        $text['submit'] = "Po�alji";
        $text['leaveblank'] = "(ostavite prazno ako �elite novo porodicno stablo)";
        $text['required'] = "Polja koja morate obavezno popuniti";
        $text['enterpassword'] = "Molimo vas upi�ite lozinku";
        $text['enterusername'] = "Molimo vas upi�ite korisnicko ime";
        $text['failure'] = "�ao nam je, ali korisnicko ime koje ste odabrali je vec u upotrebi. Vratite se na prethodnu stranu koristeci dugme za nazad i odaberite neko drugo korisnicko ime.";
        $text['success'] = "Hvala. Dobili smo va� zahtev za registraciju. Dobicete mail cim va�a registracija bude aktivirana ili u skucaju da su potrebne dodatne informacije.";
        ...
        $text['loginnotsent'] = "Tra�ene informacije nisu poslate.";
        $text['enterrealname'] = "Milomo vas upi�ite va�e pravo ime i prezime";
    ...
    case "stats":
        ...
        $text['totmales'] = "Ukupno osoba mu�kog pola";
        $text['totfemales'] = "Ukupno osoba �enskog pola";
        $text['totunknown'] = "Ukupno osoba nepoznatog pola";
        $text['totliving'] = "Ukupno �ivih";
        ...
        $text['avglifespan'] = "Prosecan �ivotni vek";
        $text['earliestbirth'] = "Najranije rodenje";
        $text['longestlived'] = "NAJDU�E �IVELI";
        $text['days'] = "dana";
        $text['age'] = "GODINA I DANA";
        $text['agedisclaimer'] = "Izracunavanje godina je bazirano na podacima rodenja i smrti. Buduci da postoje nepotpuni podaci kao �to su pre 1869 ili oko 1863 ili iza 1780 ova izracunavanje ne mogu biti 100% tacna.";
    ...
    case "notes":
        $text['browseallnotes'] = "Lista svih bele�ki";
        break;
...
$text['bornchr'] = "RO�ENJE ILI KR�TENJE";  //from search
...
$text['refresh'] = "PONOVI";
$text['whatsnew'] = "�ta ima novo";
$text['reports'] = "Izve�taji";
$text['placelist'] = "Lista svih mesta koja u svome imenu sadr�e";
$text['baptizedlds'] = "Baptized (LDS)";
$text['endowedlds'] = "Endowed (LDS)";
$text['sealedplds'] = "Sealed P (LDS)";
$text['sealedslds'] = "Sealed S (LDS)";
...
$text['mnusearchfornames'] = "Potra�i ososbu";
...
$text['text_for'] = "za tra�eni pojam";
//added in 11.0.0
