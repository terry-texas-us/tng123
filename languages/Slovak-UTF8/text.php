...
switch ($textpart) {
  ...
  case "pedigree":
    ...
    $text['scrollnote'] = "Poznámka: Na zobrazenie diagramu môžete použiť posuvník dole alebo doprava.";
  ...
  case "showphoto":
    ...
    $text['photoowner'] = "Majiteľ/Pôvodca";
  ...
  case "install":
    ...
    $text['loginfirst'] = "Najskôr sa musíte prihlásiť.";
...
$text['mostwanted'] = "Najhľadanejšie";
...
$text['mnufeatures'] = "Ďalšie vlastnosti";
...
$text['searchsitemenu'] = "Sídlo hľadania";
...
$text['wasborn_male'] = "born born";
$text['wasborn_female'] = "born born";
$text['waschristened_male'] = "bol pokrstený";
$text['waschristened_female'] = "bol pokrstený";
$text['zomrel_male'] = "zomrel";
$text['zomrel_female'] = "zomrel";
$text['wasburied_male'] = "bol pochovaný";
$text['wasburied_female'] = "bol pochovaný";
$text['wascremated_male'] = "bol spopolnený";
$text['wascremated_female'] = "bol spopolnený";
$text['wasmarried_male'] = "ženatý";
$text['wasmarried_female'] = "ženatý";
$text['wasdivorced_male'] = "bol rozvedený";
$text['wasdivorced_female'] = "bol rozvedený";
$text['inplace'] = " in ";
$text['onthisdate'] = " on ";
$text['inthisyear'] = " in ";
$text['and'] = "and ";
