...
switch ($textpart) {
    ...
    case "getperson":
        ...
        $text['general'] = "عام";
        $text['bkmkvis'] = "<strong> ملاحظة: </strong> هذه الإشارات المرجعية مرئية فقط على هذا الكمبيوتر وهذا المتصفح.";
        //added in 9.0.0
    ...
    case "pedigree":
        ...
        $text['scrollnote'] = "ملاحظات: قد تحتاج إلى السرد إلى الأسفل أو اليمين لرؤية الرسم البياني";
    ...
    case "install":
        ...
        $text['loginfirst'] = "عليك تسجيل الدخول أولا.";
...
$text['findplaces'] = "البحث عن كافة الأفراد ذوي أحداث في هذه المنطقة";
