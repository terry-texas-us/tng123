...
$text['wasborn_male'] = "γεννήθηκε";
$text['wasborn_female'] = "γεννήθηκε";
$text['waschristened_male'] = "βαπτίστηκε";
$text['waschristened_female'] = "βαπτίστηκε";
$text['death_male'] = "πέθανε";
$text['died_female'] = "πέθανε";
$text['wasburied_male'] = "θάφτηκε";
$text['wasburied_female'] = "θάφτηκε";
$text['wascremated_male'] = "έχει αποτεφρωθεί";
$text['wascremated_female'] = "έχει αποτεφρωθεί";
$text['wasmarried_male'] = "Έγγαμος";
$text['wasmarried_female'] = "Έγγαμος";
$text['wasdivorced_male'] = "διαζευγμένος";
$text['wasdivorced_female'] = "διαζευγμένος";
$text['inplace'] = "σε";
$text['onthisdate'] = "σε";
$text['inthisyear'] = "σε";
$text['and'] = "και";
