...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">V�choz� zobrazen�</h5>
            ...
            <h5 class="optionhead">D�ti ve vyskakovac�ch oknech</h5>
            ...
            <h5 class="optionhead">Odkazy na sch�mata ve vyskakovac�ch oknech</h5>
            ...
            <h5 class="optionhead">Skr�t pr�zdn� r�me�ky</h5>
            <p>V�b�rem 'Ano' odstran�te ze sch�matu pr�zdn� r�me�ky.</p>

            <h5 class="optionhead">���ka r�me�ku (bez vyskakovac�ch oken)</h5>
            ...
            <h5 class="optionhead">V��ka r�me�ku (bez vyskakovac�ch oken)</h5>
            ...
            <h5 class="optionhead">Zarovn�n� r�me�ku (bez vyskakovac�ch oken)</h5>
            ...
            <h5 class="optionhead">Posunut� v��ky r�me�ku (bez vyskakovac�ch oken)</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Spu�t�n� sch�matu potomk�</h5>
            ...
            <h5 class="optionhead">Zobrazit pozn�mky v Registru</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">V�choz� po�et vztah�</h5>
            ...
            <h5 class="optionhead">Maxim�ln� po�et vztah�</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">V��ka sch�matu</h5>
            ...
            <h5 class="optionhead">Kter� ud�losti zahrnout</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Odsazen� zleva</h5>
            ...
            <h5 class="optionhead">Velikost data v r�me�ku</h5>
            ...
            <h5 class="optionhead">Barva r�me�ku</h5>
            ...
            <h5 class="optionhead">Barva pr�zdn�ch r�me�k�</h5>
            ...
            <h5 class="optionhead">Barva st�nu</h5>
            <p>Barva, kter� bude pou�ita pro st�ny. V�choz� hodnota je #999999 (�ed�).</p>

            <h5 class="optionhead">Posun st�nu</h5>
            ...
            <h5 class="optionhead">Vodorovn� odd�len� r�me�k�</h5>
            ...
            <h5 class="optionhead">Svisl� odd�len� r�me�k�</h5>
            ...
            <h5 class="optionhead">V�choz� velikost str�nky PDF</h5>
            ...
            <h5 class="optionhead">Zobrazen� vyskakovac�ho okna</h5>
            ...
            <h5 class="optionhead">Zarovn�n� r�me�ku (s vyskakovac�m oknem)</h5>
            <p>Zarovn�n� �daj�, kter� se objev� v r�me�ku, kdy� se nepou��vaj� vyskakovac� okna.
                Pozn.: Data a m�sta budou v�dy zarovn�na doleva, ale blok, kter� je obsahuje, bude zarovn�n podle tohoto nastaven�.</p>

            <h5 class="optionhead">Posunut� v��ky r�me�ku (s vyskakovac�m oknem)</h5>
            <p>Hodnota, podle kter� by se m�la v��ka r�me�k� sch�matu m�nit u dal��ch generac� (v pixelech).
                M�lo by to b�t z�porn� ��slo. V�choz� hodnota je -2. Je-li vlo�ena hodnota 0, neobjev� se v rozm�rech r�me�ku ��dn� zm�na.
                Pou�it� ��slo by m�lo b�t v�dy lich�, tak�e bude-li vlo�eno sud� ��slo, bude zv�t�eno o 1.</p>

            <h5 class="optionhead">Vlo�it fotografie</h5>
