...
<table width="100%" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><p class="subheadbold">P�id�n� nov�ch test�</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="ydna"><p class="subheadbold">Pole v�sledk� test� Y-DNA</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="mtdna"><p class="subheadbold">Pole v�sledk� test� mtDNA</p></a>

            <p>Mate�skou linii p�edk� lze stopovat pomoc� <span class="optionhead">mitochondri�ln� DNA (mtDNA)</span>. Dle sou�asn�ch konvenc� je
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="atdna"><p class="subheadbold">Pole v�sledk� test� atDNA</p></a>

            <p><span class="optionhead">Autozom�ln� DNA (atDNA) </span> testuje va�e autozom�ln� chromoz�my, co� je dal��ch 22 p�r� za pohlavn�mi
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="common"><p class="subheadbold">Spole�n� pole v�sledk� test�</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="edit"><p class="subheadbold">�prava existuj�c�ch test�</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="delete"><p class="subheadbold">Vymaz�n� existuj�c�ch test�</p></a>
