...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Hostitel datab�ze, n�zev, u�ivatelsk� jm�no, heslo</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Slo�ky Fotografie / Dokumenty / Vypr�v�n� / N�hrobky / Multim�dia / GENDEX / Z�lohy / M�dy / Extensions</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>URL genealogick�ch str�nek</h5>
            ...
            <h5>Vlastn� z�hlav� / z�pat� / meta</h5>
            ...
            <h5>Zobrazit odkazy na domovskou str�nku / Hledat / P�ihl�en�/Odhl�en� / Sd�let / Tisk / P�idat z�lo�ku</h5>
            ...
            <h5>Skr�t popisky k�tu</h5>
            <p>Tato volba umo��uje skr�t v�echny zm�nky o ud�losti "k�tu".</p>

            <h5>Skr�t v�echny str�nky a �daje k DNA</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Zobrazit roz���enou informaci o obr�zku</h5>
            ...
            <h5>Maxim�ln� v��ka a ���ka obr�zku</h5>
            ...
            <h5>P�edpona/prefix pro n�hledy</h5>
            ...
            <h5>P��pona/sufix pro n�hledy</h5>
            ...
            <h5>Sloupc� v zobrazen� n�hled�</h5>
            ...
            <h5>Maxim�ln� po�et znak� v seznamu pozn�mek</h5>
            ...
            <h5>P�i smaz�n� sou�asn� odstranit fyzick� soubor</h5>
            ...
            <h5>Zobrazit fotografie na jednom ��dku</h5>
            ...
            <h5>Rozd�lit m�dia do slo�ek strom�</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Omezit p��stup pouze na p�ipojen� strom</h5>
            ...
            <h5>Zobrazit �daje o �iv�ch osob�ch</h5>
            ...
            <h5>Zobrazit jm�na �ij�c�ch osob</h5>
            ...
            <h5>Zobrazit jm�na osob ozna�en�ch jako neve�ejn�</h5>
            ...
            <h5>Zobrazit zpr�vu o povolen� cookies</h5>
            ...
            <h5>Zobrazit odkaz na z�sady ochrany dat</h5>
            ...
            <h5>��dost o souhlas ohledn� osobn�ch �daj�</h5>
            ...
            <h5>Kl��e Site Key a Secret Key</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Zji�t�n� p�edpon p�i importu</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Maxim�ln� po�et ��dk� ve sloupci (pr�m.)</h5>
            ...
            <h5>Potla�it kategorii "Nezn�m�"</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Pos�lat v�echny maily z v��e uveden� adresy</h5>
            ...
            <h5>Vytvo�it nov� strom pro u�ivatele</h5>
            ...
            <h5>Automaticky schv�lit nov� u�ivatele</h5>
            ...
            <h5>Zahrnout heslo do uv�tac�ho mailu</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Povolit responzivn� tabulky</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Maxim�ln� po�et v�sledk� hled�n�</h5>
            ...
            <h5>P�ipojit z�znamy m�st ke strom�m</h5>
            ...
            <h5>Geok�dovat v�echna nov� m�sta</h5>
            ...
            <h5>Znovu pou��t smazan� ID ��sla</h5>
            ...
            <h5>Zobrazit ozn�men� 'D�le�it� �koly'</h5>
            ...
            <h5>Zobrazit celkov� sou�ty z�znam� v menu Administrace</h5>
            ...
            <h5>Upozornit, pokud z�loha nebyla vytvo�ena b�hem tohoto po�tu dn�</h5>
