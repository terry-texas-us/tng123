...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Vylou�it n�zvy hostitele</h5>
            ...
            <h5>Vylou�it u�ivatelsk� jm�na</h5>
            ...
            <h5>N�zev souboru protokolu (Admin)</h5>
            ...
            <h5>Maxim�ln� po�et ��dk� v protokolu (Admin)</h5>
            ...
            <h5>Zablokovat n�vrhy nebo nov� u�ivatelsk� registrace</h5></p>
