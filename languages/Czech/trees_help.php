...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Adresa/m�sto/kraj/PS�/zem�/telefon:</h5>
            <p>Kontaktn� �daje majitele.</p>

            <h5>Informace o majiteli zachovat neve�ejn�</h5>
            ...
            <h5>Nepovolit u�ivatel�m st�hnut� soubor� GEDCOM</h5>
            <p>Za�krtnut�m tohoto pol��ka zabr�n�te u�ivatel�m st�hnout z tohoto stromu soubory GEDCOM.</p>

            <h5>Nepovolit u�ivatel�m tvorbu soubor� PDF</h5>
