...
<table width="100%" border="0" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            <a name="gettingstarted"><p class="subheadbold">Za��n�me:</p></a>
            <p>��m za��t nejd��ve? Zde je z�klad:</p>
            <ol>
                <li><p><strong>Pe�liv� dodr�ujte instrukce k instalaci, kter� jsou obsa�en� v souboru <a href="../../readme.html" target="_blank">readme.html</a> .</strong> P��mo z t�to str�nky
                        lze nastavit z�kladn� konfiguraci, ale v�echny pot�ebn� hodnoty m��ete nastavit z volby <strong>Nastaven�</strong> zde z hlavn�ho administr�torsk�ho menu.</p></li>
                <li><p><strong>Vytvo�te alespo� jeden strom.</strong> Nebudete-li m�t v�ce nez�visl�ch soubor� GEDCOM, budete pravd�podobn� pot�ebovat pouze jeden strom.</p></li>
                <li><p><strong>Vytvo�te alespo� jednoho u�ivatele.</strong> Prvn� u�ivatel, kter�ho vytvo��te, mus� b�t Administr�tor (mus� m�t v�echna p��stupov� pr�va a NESM� m�t omezen� t�kaj�c� se ��dn�ho stromu).</p></li>
                <li><p><strong>Naimportujte sv�j soubor GEDCOM nebo za�n�te ru�n� vkl�dat sv� data</strong>. Pokud je budete vkl�dat ru�n�, nez�le�� na to, co vlo��te nejd��ve.
                        N�kdo rad�ji vkl�d� nejprve osoby a potom je spoj� do rodin, zat�mco jin� za��naj� rodinami a pak do nich p�id�vaj� osoby. Nemus�te
                        se ��dit ��dnou strategi�.</p></li>
                <li><p><strong>Pod�vejte se na n�sledn� procesy</strong> (po Importu/Exportu) a prove�te ty, o kter�ch si mysl�te, �e jsou nutn� (v�ce informac�
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a name="notes"><p class="subheadbold">Pozn�mky:</p></a>
            <ol>
                <li><p>Pokud v�m v menu Administrace chyb� n�kter� volby, z�ejm� jste se nep�ihl�sili s �pln�mi p��stupov�mi pr�vy nebo jsou va�e p��stupov� pr�va omezena pouze na ur�it� strom.
                        Chcete-li u�ivatelsk� pr�va zm�nit, odhlaste se a p�ihlaste se jako Administr�tor, nebo svoji datab�zi upravte p��mo pomoc� phpMyAdmin nebo podobn�mi n�stroji.</p></li>
                <li><p>Pomoc� odkazu na domovskou str�nku na horn�m okraji r�mce se dostanete na domovskou str�nku a zobraz�te ji v okn� va�eho prohl�e�e. Pomoc� odkazu na domovskou str�nku v lev�m r�mci otev�ete svoji
                        str�nku vpravo v hlavn�m r�mci, co� v�m umo�n� pohyb po va�ich str�nk�ch a kdykoli n�vrat do sekce Administr�tora jedn�m kliknut�m v lev�m r�mci.</p></li>
            </ol>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a name="otherresources"><p class="subheadbold">Jin� zdroje:</p></a>
            <ol>
                <li><p>Mailov� seznam pro aktualizace: <a href="mailto:tngusers@lythgoes.net">tngusers@lythgoes.net</a>. P�ij�mat a pos�lat maily na
                        <a href="mailto:tngusers-subscribe@lythgoes.net">tngusers-subscribe@lythgoes.net</a>. Tento seznam se pou��v� v�hradn� na informov�n� u�ivatel�
