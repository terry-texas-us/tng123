...
<table width="100%" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="what"><p class="subheadbold">Co je to v�tev?</p></a>>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="add"><p class="subheadbold">P�idat novou / Upravit existuj�c� v�tve</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="delete"><p class="subheadbold">Vymaz�n� v�tve</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="label"><p class="subheadbold">Ozna�en� v�tv�</p></a>
