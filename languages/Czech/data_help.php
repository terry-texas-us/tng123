...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p><h5 class="optionhead">P�ed importem:</h5> Z va�eho genealogick�ho programu vytvo�te standardn� soubor GEDCOM 5.5 (4.0 je tak�
            ...
            <p><h5 class="optionhead">[Import souboru GEDCOM] Z va�eho po��ta�e</h5>
            ...
            <h5 class="optionhead">OR [Import souboru GEDCOM] Z webov�ch str�nek (ve slo�ce GEDCOM)</h5>
            ...
            <h5 class="optionhead">P�ijmout data pro v�echny vlastn� typy ud�lost�</h5>
            ...
            <h5 class="optionhead">Importovat pouze vlastn� typy ud�lost� (nebudou vlo�eny, nahrazeny nebo p�id�ny ��dn� �daje)</h5>
            ...
            <h5 class="optionhead">Nahradit v�echna aktu�ln� data</h5>
            ...
            <h5 class="optionhead">Nahradit pouze odpov�daj�c� z�znamy</h5>
            ...
            <h5 class="optionhead">Nenahradit ��dn� data</h5>
            <p>Nov� z�znamy budou p�id�ny, ale shodn� z�znamy budou ignorov�ny (nenahrazeny).</p>

            <h5 class="optionhead">P�idat v�echny z�znamy</h5>
            ...
            <h5 class="optionhead">Nep�epo��tat ozna�en� �ij�c�</h5>
            ...
            <h5 class="optionhead">Nahradit pouze, pokud jsou �daje nov�j��</h5>
            ...
            <h5 class="optionhead">Importovat m�dia, pokud existuj�</h5>
            ...
            <h5 class="optionhead">Za��t ��slovat ID ��sla od prvn�ho voln�ho ��sla/Za��t ��slovat ID ��sla od</h5>
            ...
            <h5 class="optionhead">Star� styl importu</h5>
            ...
            <h5 class="optionhead">Funkce "za��t znovu"</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Vylou�it �ij�c�/Vylou�it neve�ejn�</h5>
            <p>Za�krtnut�m t�chto tla��tek vylou��te �ij�c� nebo neve�ejn� osoby z exportovan�ho souboru GEDCOM.</p>

            <h5 class="optionhead">Exportovat odkazy na m�dia</h5>
            ...
            <h5 class="optionhead">Lok�ln� um�st�n� fotografi�/dokument�/n�hrobk�/vypr�v�n�/zvukov�ch z�znam�/vide�</h5>
