...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            <p><h5 class="optionhead">Pou�it� �ablony</h5><br>�ablony TNG umo�n� d�t va�im str�nk�m rychle profesion�ln� vzhled a atmosf�ru.
            ...
            <p>Chcete-li zachovat existuj�c� nastaven� str�nky (z verze p�ed 8.1.0), nechte volbu <strong>Umo�nit v�b�r �ablony</strong> nastavenu na
                <b>Ne</b>.</p>
            <p><h5 class="optionhead">P�izp�soben�</h5><br>Va�i str�nku m��ete upravit podle toho, co v�m soubory �ablon dovol�. Va�e v�choz�
            ...
            form�tov�n�) je definov�no v souboru templatestyle.css (v podslo�ce "css" u ka�d� �ablony), ale pokud chcete n�co m�nit, je lep�� zm�ny
            prov�st
            ...
            <p><h5 class="optionhead">Podpora v�ce jazyk�</h5><br>Pokud chcete, aby byla n�jak� zpr�va v nastaven� �ablony dostupn� v jin�m jazyku,
            vyberte tento jazyk z rozbalovac�ho seznamu vedle odpov�daj�c� zpr�vy, pot� klikn�te na tla��tko "Prov�st". Objev� se
            nov� pole, kam m��ete zapsat p�eklad t�to zpr�vy. Po kliknut� na tla��tko "Ulo�it" v horn� ��sti str�nky se tato zpr�va stane trvalou
            sou��st�
            nastaven� �ablony va�� str�nky.</p>
            <p><h5 class="optionhead">Jednoduch� zm�ny</h5><br>Zm�ny m��ete ud�lat p��mo �pravou soubor� zm�n�n�ch v p�ede�l�m odstavc�ch, ale n�kter�
            jednoduch� zm�ny m��ete prov�st
            ...
            <p><h5 class="optionhead">Obr�zky</h5><br>Chcete-li zm�nit n�jak� obr�zek, nejjednodu��� je kliknout na tla��tko "Zm�nit" vedle pole
            obsahuj�c�ho
            ...
            kliknut�m prav�m tla��tkem my�i na obr�zek, kter� vid�te ve sv�m prohl�e�i (pou�ijte tla��tko "N�hled"), a v�b�rem "Vlastnosti" nebo
            "Zobrazit vlastnosti obr�zku". Pokud mus�te
            rozm�ry obr�zku zm�nit, mus�te je zm�nit ru�n�.</p>
            <p>Po nahr�n� obr�zku a dokon�en� v�ech zm�n klikn�te na "Ulo�it" v doln� ��sti str�nky. Pokud tento proces neprob�hne, m��ete m�t chybn�
                nastavena p��stupov�
                pr�va na va�i slo�ku �ablon. Ujist�te se, zda jsou pr�va nastavena na 755 nebo 777. Pokud st�le nem��ete pracovat, m��ete k nahr�n�
                nov�ho obr�zku p��mo do podslo�ky "img" ve slo�ce �ablony,
                kterou pou��v�te, pou��t FTP program nebo jin� online spr�vce soubor�.</p>
            <p><h5 class="optionhead">Odkazy na funkce a zdroje</h5><br>Pokud va�e vybran� �ablona obsahuje n�kterou z t�chto mo�nost�, m��ete
            vytvo�it odkazy v t�chto
            sekc�ch pomoc� seznamu n�zv� odkaz� a jejich URL na jednom ��dku odd�len�ch ��rkou. Nap�. <em>TNG,
                http://www.tngsitebuilding.com</em>.</p>
            <p><h5 class="optionhead">Zm�na n�zoru</h5><br>Volby nastaven� m��ete upravit pro v�ce �ablon, ale pou�ita m��e b�t pouze jedna. Pokud se
            pozd�ji rozhodnete, �e chcete pou��vat jinou
