...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            <p><h5>Pou�it� �ablony</h5>�ablony TNG umo�n� d�t va�im str�nk�m rychle profesion�ln� vzhled a atmosf�ru.
            ...
            <p>Chcete-li zachovat existuj�c� nastaven� str�nky (z verze p�ed 8.1.0), nechte volbu <strong>Umo�nit v�b�r �ablony</strong> nastavenu na
                <b>Ne</b>.</p>
            <p><h5>P�izp�soben�</h5>Va�i str�nku m��ete upravit podle toho, co v�m soubory �ablon dovol�. Va�e v�choz�
            ...
            <p><h5>Podpora v�ce jazyk�</h5>Pokud chcete, aby byla n�jak� zpr�va v nastaven� �ablony dostupn� v jin�m jazyku,
            ...
            <p><h5>Jednoduch� zm�ny</h5>Zm�ny m��ete ud�lat p��mo �pravou soubor� zm�n�n�ch v p�ede�l�m odstavc�ch, ale n�kter�
            ...
            <p><h5>Obr�zky</h5>Chcete-li zm�nit n�jak� obr�zek, nejjednodu��� je kliknout na tla��tko "Zm�nit" vedle pole
            obsahuj�c�ho
            ...
            <p><h5>Odkazy na funkce a zdroje</h5>Pokud va�e vybran� �ablona obsahuje n�kterou z t�chto mo�nost�, m��ete
            ...
            <p><h5>Zm�na n�zoru</h5>Volby nastaven� m��ete upravit pro v�ce �ablon, ale pou�ita m��e b�t pouze jedna. Pokud se
