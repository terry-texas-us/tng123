...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Po�ad� p�i zobrazen�</h5>
            ...
            <h5 class="optionhead">�daje ud�losti</h5>
            ...
            <h5 class="optionhead">Sbalit ud�lost</h5>
            ...
            <h5 class="optionhead">Ud�lost CJKSpd</h5>
            ...
            <p><h5 class="optionhead">Povinn� pole:</h5>Pro va�i ud�lost mus�te vybrat nebo zadat GEDCOM tag. Pokud zvol�te tag "EVEN" (obecn�
            vlastn� ud�lost),
