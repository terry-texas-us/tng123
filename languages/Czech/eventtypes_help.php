...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Nalezen� existuj�c�ch vlastn�ch typ� ud�lost� vyhled�n�m cel�ho nebo ��sti <strong>Tagu, Typu/popisu (pro ud�losti EVEN)</strong> nebo
            ...
            <p><h5>P�ijmout/Odm�tnout/V�e</h5>
            ...
            <p><h5>Smazat/P�ijmout/Odm�tnout/Sbalit vybran�</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">P�idat nebo upravit vlastn� typy ud�lost�</h4></a>

            <p>Nejobvyklej�� neboli "Standardn�" typy ud�lost�, jako jsou Narozen�, �mrt�, S�atek n�kolik dal��ch, jsou spravov�ny p��mo na str�nk�ch
                osoby, rodiny, pramenu nebo �lo�i�ti pramen�.
                V�echny ostatn� typy ud�lost� jsou spojeny s "vlastn�mi" typy ud�lost�
                a jsou spravov�ny v sekc�ch <strong>Dal�� ud�losti</strong> na str�nk�ch osoby, rodiny, pramenu nebo �lo�i�t� pramen�. P�ed z�pisem
                n�kter� z t�chto "dal��ch"
                ud�lost� mus�te m�t z�znam s n� spojen�ho vlastn�ho typu ud�losti. TNG automaticky nastav� vlastn� typy ud�lost� pro v�echny
                nestandardn� ud�losti, kter� obsahuje
                v� soubor GEDCOM, ale nastavit vlastn� typy ud�lost� m��ete tak� ru�n�.</p>

            <p>Chcete-li p�idat nov� vlastn� typ ud�losti, klikn�te na z�lo�ku <strong>P�idat nov�</strong> a pak vypl�te formul��. Chcete-li upravit
                existuj�c� vlastn� typ ud�losti, pou�ijte
            ...
            <h5>Vybrat tag nebo zadat</h5>
            <p>Toto je 3 nebo 4 znakov� zkratka (v�echna velk� p�smena) nebo mnemotechnick� k�d.
                V�t�inu obvykl�ch nestandardn�ch ud�lost� obsahuje v�b�rov� pole Tag. Pokud zde po�adovan� tag nevid�te, zm��ete jej p��mo zadat do
                pole pod t�mto polem. Vyberete-li tag z tohoto seznamu
                A sou�asn� jej zap�ete do pole, tag, kter� zap�ete do pole, bude m�t p�ednost a tag vybran� ze seznamu bude odm�tnut.</p>

            <h5>Type/popis</h5>
            <p>Toto pole by m�lo odpov�dat hodnot� "TYPE" pro tento typ ud�losti z va�eho genealogick�ho programu. POZN.: Toto pole se zobraz� pouze,
                kdy� vyberete
            ...
            <h5>�daje ud�losti</h5>
            <p>Chcete-li p�ijmout importovan� �daje, kter� odpov�daj� tomuto vlastn�mu typu ud�losti, vyberte <em>P�ijmout</em>. Chcete-li data, kter�
                odpov�daj� tomuto vlastn�mu typu ud�losti, nep�ijmout
                a zp�sobit, �e nebudou naimportov�na, vyberte <em>Odm�tnout</em>. Kdy� je ud�lost tohoto typu naimportov�na, nastaven�m t�to volby
                zp�t na Odm�tnout
                nebude tento vlastn� typ ud�losti zobrazov�n.</p>

            <h5>Sbalit ud�lost</h5>
            ...
            <h5>Ud�lost CJKSpd</h5>
            <p>Pokud by tento typ ud�losti m�l podl�hat stejn�m pravidl�m ochrany osobn�ch �daj�, kter� upravuj� dal�� ud�losti CJKSpd, zvolte zde
                mo�nost "Ano".</p>

            <p><h5>Povinn� pole:</h5>Pro va�i ud�lost mus�te vybrat nebo zadat GEDCOM tag. Pokud zvol�te tag "EVEN" (obecn�
            vlastn� ud�lost),
            mus�te zadat tak� Type/popis. Pokud jako tag nezvol�te EVEN, mus�te nechat pole Type/popis pr�zdn�. Mus�te tak� zadat �et�zec
            Zobrazit.</p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="accept"><h4 class="subheadbold">P�ijmout vybran� / Odm�tnout vybran�</h4></a>
            <p>Chcete-li najednou ozna�it vlastn� typy ud�lost� jako <strong>P�ijmout</strong> nebo <strong>Odm�tnout</strong>, za�krtn�te pol��ko
                Vybrat vedle ka�d�ho vlastn�ho typu ud�losti,
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="delete"><h4 class="subheadbold">Vymazat vlastn� typy ud�lost�</h4></a>
            <p>Chcete-li odstranit vlastn� typ ud�losti, pou�ijte z�lo�ku <a href="#search">Hledat</a> k nalezen� polo�ky, a pot� klikn�te na ikonku
                Vymazat vedle tohoto z�znamu. Tento ��dek zm�n�
                barvu a pot� po odstran�n� vlastn�ho typu ud�losti zmiz�. Chcete-li najednou odstranit v�ce z�znam�, za�krtn�te tla��tko ve sloupci
                Vybrat vedle ka�d�ho z�znamu, kter� m� b�t
