...
<table width="100%" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="tables"><p class="subheadbold">Z�lohov�n�, obnovov�n� &amp; optimalizace dat v tabulk�ch</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="structure"><p class="subheadbold">Z�lohov�n� struktury tabulek</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="ids"><p class="subheadbold">P�e��slov�n� ID ��sel</p></a>
