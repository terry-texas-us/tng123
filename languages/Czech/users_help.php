...
<table width="100%" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><p class="subheadbold">P�id�n� nov�ho u�ivatele</p></a>
            ...
            <p><span class="optionhead">Povinn� pole:</span> Mus�te zadat u�ivatelsk� jm�no, heslo a popis u�ivatele. V�echna ostatn� pole jsou
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="delete"><p class="subheadbold">Vymaz�n� u�ivatel�</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="review"><p class="subheadbold">P�ezkoumat</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="rights"><p class="subheadbold">Role a p��stupov� pr�va</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="rights"><p class="subheadbold">Omezen� p��stupu</p></a>
