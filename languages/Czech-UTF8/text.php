...
switch ($textpart) {
  ...
  case "pedigree":
    ...
    $text['scrollnote'] = "Pozn.: pro zobrazení diagramu můžete použít posuvník dolů nebo doprava.";
  ...
  case "install":
    ...
    $text['exists'] = "existuje";
    $text['loginfirst'] = "Nejdříve se musíte přihlásit.";
...
$text['wasmarried_male'] = "byl sezdán s";  // same as $text['wasdmarried'] if no gender verb
$text['wasmarried_female'] = "byla sezdána s";  // same as $text['wasdmarried'] if no gender verb
