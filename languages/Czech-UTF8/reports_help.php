...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Chcete-li upravit existující report, použijte
            ...
            <h5>Zvolte pole pro zobrazení</h5>
            ...
            <p>Při práci se skutečnými datovými poli (jako Datum poslední aktualizace) můžete porovnat pole přímo s jiným skutečným datem
                nebo skutečnými datovými poli. Předdefinované skutečné datum, které můžete použít jako operátor, je 'Dnes'. Při porovnávání dvou
                skutečných dat můžete také použít
            ...
            <p>Po výběru názvu pole zvolte dále ze seznamu <em>Operátory &amp; Speciální hodnoty</em> porovnávací operátor. Jsou to "=, !=, < > <=,
                >=, obsahuje, začíná na, končí na". Operátor
                zkopírujte do pravé části jeho výběrem a kliknutím na sousední tlačítko <em>Přidat >></em> nebo jednoduše dvojklikem na název
                operátora (pouze IE).</p>

            <p>Příkaz zakončete výběrem pole nebo hodnoty pro porovnání s vaším původním polem. Můžete také zvolit některou ze speciálních hodnot:
                <em>Aktuální měsíc, aktuální rok</em> nebo
                <em>aktuální den</em>. Chcete-li vybrat hodnotu konstantního řetězce, zadejte do pole <em>Konstantní řetězec</em> hodnotu řetězce bez
                uvozovek a klikněte na sousední tlačítko <em>Přidat >></em>.
                Chcete-li přidat prázdný řetězec, nechte před kliknutím na toto tlačítko pole prázdné. Pokud chcete zvolit hodnotu číselné konstanty,
                zadejte do pole <em>Číselná konstanta</em> číslo a klikněte na sousední
            ...
            <h5>Uložit report vs. Uložit a ukončit</h5>
