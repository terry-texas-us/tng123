...
<table width="100%" border="0" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <span class="optionhead">Akce</span>
            <p>Zvolte, zda chcete přidat nové značky nebo vymazat existující. Pokud chcete vymazat existující značky, musíte také zvolit, zda má tato akce vymazat značky větve u všech členů
