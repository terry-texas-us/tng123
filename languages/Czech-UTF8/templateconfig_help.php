...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            <p><h5>Použití šablony</h5>Šablony TNG umožní dát vašim stránkám rychle profesionální vzhled a atmosféru.
            ...
            <p>Chcete-li zachovat existující nastavení stránky (z verze před 8.1.0), nechte volbu <strong>Umožnit výběr šablony</strong> nastavenu na
                <b>Ne</b>.</p>
            <p><h5>Přizpůsobení</h5>Vaši stránku můžete upravit podle toho, co vám soubory šablon dovolí. Vaše výchozí
            ...
            <p><h5>Podpora více jazyků</h5>Pokud chcete, aby byla nějaká zpráva v nastavení šablony dostupná v jiném jazyku,
            ...
            <p><h5>Jednoduché změny</h5>Změny můžete udělat přímo úpravou souborů zmíněných v předešlém odstavcích, ale některé
            ...
            <p><h5>Obrázky</h5>Chcete-li změnit nějaký obrázek, nejjednodušší je kliknout na tlačítko "Změnit" vedle pole
            obsahujícího
            ...
            kliknutím pravým tlačítkem myši na obrázek, který vidíte ve svém prohlížeči (použijte tlačítko "Náhled"), a výběrem "Vlastnosti" nebo
            "Zobrazit vlastnosti obrázku". Pokud musíte
            rozměry obrázku změnit, musíte je změnit ručně.</p>
            <p>Po nahrání obrázku a dokončení všech změn klikněte na "Uložit" v dolní části stránky. Pokud tento proces neproběhne, můžete mít chybně
                nastavena přístupová
            ...
            <p><h5>Odkazy na funkce a zdroje</h5>Pokud vaše vybraná šablona obsahuje některou z těchto možností, můžete
            ...
            <p><h5>Změna názoru</h5>Volby nastavení můžete upravit pro více šablon, ale použita může být pouze jedna. Pokud se
