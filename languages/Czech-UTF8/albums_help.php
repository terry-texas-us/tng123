...
<table width="100%" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><p class="subheadbold">Přidání nových alb</p></a>
        ...
        <p><span class="optionhead">Vždy viditelné</span><br>
          ...
          připojeno k žijící osobě nebo rodině. Jinak jsou aktivní alba nebo média, která jsou připojená k žijícím osobám, skryta pro návštěvníky, kteří nemají oprávnění prohlížet data žijících osob.
            ...
            <p><span class="optionhead">Pole, která musí být vyplněna:</span> Název alba je jediné pole, které je nutné vyplnit, ale je ve vašem zájmu
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="edit"><p class="subheadbold">Úprava existujícího alba</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="sort"><p class="subheadbold">Třídění alb</p></a>
