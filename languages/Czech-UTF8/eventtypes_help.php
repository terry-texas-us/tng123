...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p><h5>Přijmout/Odmítnout/Vše</h5>
            ...
            <p><h5>Smazat/Přijmout/Odmítnout/Sbalit vybrané</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p><h5>Povinná pole:</h5>Pro vaši událost musíte vybrat nebo zadat GEDCOM tag. Pokud zvolíte tag "EVEN" (obecná
            vlastní událost),
