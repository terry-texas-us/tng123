...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p><h5 class="optionhead">Před importem:</h5> Z vašeho genealogického programu vytvořte standardní soubor GEDCOM 5.5 (4.0 je také
            ...
            <p><h5 class="optionhead">[Import souboru GEDCOM] Z vašeho počítače</h5>
            ...
            <h5 class="optionhead">OR [Import souboru GEDCOM] Z webových stránek (ve složce GEDCOM)</h5>
            ...
            <h5 class="optionhead">Přijmout data pro všechny vlastní typy událostí</h5>
            ...
            <h5 class="optionhead">Importovat pouze vlastní typy událostí (nebudou vloženy, nahrazeny nebo přidány žádné údaje)</h5>
            ...
            <h5 class="optionhead">Nahradit všechna aktuální data</h5>
            ...
            <h5 class="optionhead">Nahradit pouze odpovídající záznamy</h5>
            ...
            <h5 class="optionhead">Nenahradit žádná data</h5>
            <p>Nové záznamy budou přidány, ale shodné záznamy budou ignorovány (nenahrazeny).</p>

            <h5 class="optionhead">Přidat všechny záznamy</h5>
            ...
            <h5 class="optionhead">Nepřepočítat označení Žijící</h5>
            ...
            <h5 class="optionhead">Nahradit pouze, pokud jsou údaje novější</h5>
            ...
            <h5 class="optionhead">Importovat média, pokud existují</h5>
            ...
            <h5 class="optionhead">Začít číslovat ID čísla od prvního volného čísla/Začít číslovat ID čísla od</h5>
            ...
            <h5 class="optionhead">Starý styl importu</h5>
            ...
            <h5 class="optionhead">Funkce "začít znovu"</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Vyloučit žijící/Vyloučit neveřejné</h5>
            <p>Zaškrtnutím těchto tlačítek vyloučíte žijící nebo neveřejné osoby z exportovaného souboru GEDCOM.</p>

            <h5 class="optionhead">Exportovat odkazy na média</h5>
            ...
            <h5 class="optionhead">Lokální umístění fotografií/dokumentů/náhrobků/vyprávění/zvukových záznamů/videí</h5>
