...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Hostitel databáze, název, uživatelské jméno, heslo</h5>
            ...
            <h5 class="optionhead">Režim údržby</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Názvy tabulek</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Kořenová složka</h5>
            ...
            <h5 class="optionhead">Konfigurační složka</h5>
            ...
            <h5 class="optionhead">Složky Fotografie / Dokumenty / Vyprávění / Náhrobky / Multimédia / GENDEX / Zálohy / Módy / Extensions</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Domovská stránka</h5>
            ...
            <h5 class="optionhead">URL genealogických stránek</h5>
            <p>Webová adresa vaší genealogické složky (např. "http://mysite.com/genealogy").</p>

            <h5 class="optionhead">Název stránek</h5>
            ...
            <h5 class="optionhead">Popis stránek</h5>
            ...
            <h5 class="optionhead">Vlastní záhlaví / zápatí / meta</h5>
            ...
            <h5 class="optionhead">Styl záložek</h5>
            ...
            <h5 class="optionhead">Umístění menu</h5>
            ...
            <h5 class="optionhead">Zobrazit odkazy na domovskou stránku / Hledat / Přihlášení/Odhlášení / Sdílet / Tisk / Přidat záložku</h5>
            ...
            <h5 class="optionhead">Cíl odkazu Hledat</h5>
            ...
            <h5 class="optionhead">Skrýt popisky křtu</h5>
            <p>Tato volba umožňuje skrýt všechny zmínky o události "křtu".</p>

            <h5 class="optionhead">Skrýt všechny stránky a údaje k DNA</h5>
            ...
            <h5 class="optionhead">Výchozí strom</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Typ souborů fotografií</h5>
            ...
            <h5 class="optionhead">Zobrazit rozšířenou informaci o obrázku</h5>
            ...
            <h5 class="optionhead">Maximální výška a šířka obrázku</h5>
            ...
            <h5 class="optionhead">Předpona/prefix pro náhledy</h5>
            ...
            <h5 class="optionhead">Přípona/sufix pro náhledy</h5>
            ...
            <h5 class="optionhead">Sloupců v zobrazení náhledů</h5>
            ...
            <h5 class="optionhead">Maximální počet znaků v seznamu poznámek</h5>
            ...
            <h5 class="optionhead">Automatické opakování prezentace</h5>
            <p>Nastavení této hodnoty na 'Ano' povolí automatický pokračující běh prezentace.</p>

            <h5 class="optionhead">Umožnit prohlížeč obrázků</h5>
            ...
            <h5 class="optionhead">Výška prohlížeče obrázků</h5>
            ...
            <h5 class="optionhead">Skrýt média osob</h5>
            ...
            <h5 class="optionhead">Při smazání současně odstranit fyzický soubor</h5>
            ...
            <h5 class="optionhead">Zobrazit fotografie na jednom řádku</h5>
            ...
            <h5 class="optionhead">Rozdělit média do složek stromů</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Dynamická změna jazyka</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Vyžadovat přihlášení</h5>
            ...
            <h5 class="optionhead">Omezit přístup pouze na připojený strom</h5>
            ...
            <h5 class="optionhead">Zobrazit údaje CJKSpd</h5>
            ...
            <h5 class="optionhead">Zobrazit údaje o živých osobách</h5>
            ...
            <h5 class="optionhead">Zobrazit jména žijících osob</h5>
            ...
            <h5 class="optionhead">Zobrazit jména osob označených jako neveřejné</h5>
            ...
            <h5 class="optionhead">Zobrazit zprávu o povolení cookies</h5>
            ...
            <h5 class="optionhead">Zobrazit odkaz na zásady ochrany dat</h5>
            ...
            <h5 class="optionhead">Žádost o souhlas ohledně osobních údajů</h5>
            ...
            <h5 class="optionhead">Klíče Site Key a Secret Key</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Pořadí jména a příjmení</h5>
            ...
            <h5 class="optionhead">Všechna příjmení velkými písmeny</h5>
            ...
            <h5 class="optionhead">Předpony příjmení</h5>
            ...
            <h5 class="optionhead">Zjištění předpon při importu</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Maximální počet řádků ve sloupci (prům.)</h5>
            ...
            <h5 class="optionhead">Potlačit kategorii "Neznámé"</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Emailová adresa</h5>
            ...
            <h5 class="optionhead">Posílat všechny maily z výše uvedené adresy</h5>
            ...
            <h5 class="optionhead">Povolit nové registrace uživatelů</h5>
            <p>Umožní vypnout možnost návštěvníků požádat o uživatelský účet na vašich stránkách.</p>

            <h5 class="optionhead">Upozornit na návrhy k přezkoumání</h5>
            ...
            <h5 class="optionhead">Vytvořit nový strom pro uživatele</h5>
            ...
            <h5 class="optionhead">Automaticky schválit nové uživatele</h5>
            ...
            <h5 class="optionhead">Posílat schvalovací mail</h5>
            ...
            <h5 class="optionhead">Zahrnout heslo do uvítacího mailu</h5>
            ...
            <h5 class="optionhead">Použít ověření SMTP</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Povolit responzivní tabulky</h5>
            ...
            <h5 class="optionhead">Typ responzivní tabulky</h5>
            ...
            <br>
            <h5 class="optionhead">Povolit přepínač módů responzivních tabulek:</h5>
            ...
            <h5 class="optionhead">Povolit minimapu responzivních tabulek</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5 class="optionhead">Maximální počet výsledků hledání</h5>
            ...
            <h5 class="optionhead">Osoby začínají na</h5>
            ...
            <h5 class="optionhead">Zobrazit poznámky</h5>
            ...
            <h5 class="optionhead">Posouvání citací</h5>
            ...
            <h5 class="optionhead">Časový odstup serveru (v hodinách)</h5>
            ...
            <h5 class="optionhead">Upravit prodlevu (v minutách)</h5>
            ...
            <h5 class="optionhead">Maximální počet generací při uložení GEDCOMU</h5>
            <p>Maximální počet generací, které mohou být exportovány ve veřejném požadavku na vytvoření souboru GEDCOM.</p>

            <h5 class="optionhead">Co je nového dny</h5>
            ...
            <h5 class="optionhead">Typ šifrování</h5>
            ...
            <h5 class="optionhead">Připojit záznamy míst ke stromům</h5>
            ...
            <h5 class="optionhead">Geokódovat všechna nová místa</h5>
            ...
            <h5 class="optionhead">Znovu použít smazaná ID čísla</h5>
            ...
            <h5 class="optionhead">Zobrazit poslední import</h5>
            ...
            <h5 class="optionhead">Zobrazit oznámení 'Důležité úkoly'</h5>
            ...
            <h5 class="optionhead">Zobrazit celkové součty záznamů v menu Administrace</h5>
            ...
            <h5 class="optionhead">Upozornit, pokud záloha nebyla vytvořena během tohoto počtu dní</h5>
            ...
            <h5 class="optionhead">Používám TNG offline</h5>
