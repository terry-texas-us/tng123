...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Toto médium je z externího zdroje</h5>
            ...
            <h5>Název souboru na stránkách / Media URL</h5>
            ...
            <h5>Soubor s náhledem obrázku</h5>
            ...
            <h5>Zadat obrázek/Vytvořit z originálu</h5>
            ...
            <h5>Název souboru na stránkách</h5>
            ...
            <h5>Soubory uložit ve: Složce multimédií / Složce kolekce</h5>
            ...
            <h5>Majitel/Pramen, Datum pořízení</h5>
            ...
            <h5>Ukázat mapu hřbitova a médium, kdykoliv bude tato položka zobrazena</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Místo pořízení/vytvoření</h5>
            <p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Spojeno s určitou událostí</h5>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <h5>Přiřadit výchozí fotografie</h5>
