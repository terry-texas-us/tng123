  ...
  <tr class="fieldnameback">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>
            <p>Tato sekce je ve výchozím stavu sbalena. Pro její rozbalení klikněte na výraz "Místo pořízení/vytvoření" nebo na šipku vedle něj. Znáte-li název místa,
            ...
            <span class="optionhead">Mapa obrázku</span>
            <p>Tato sekce je ve výchozím stavu sbalena. Pro její rozbalení kliněte na výraz "Mapa obrázku" nebo na šipku vedle něj. V této sekci můžete spojit
            ...
            <p>U každé oblasti, kterou chcete spojit s osobou, nejdříve zvolte strom dané osoby, poté určete na obrázku oblast nakreslením obdélníku ukazatelem vaší myší.
                ...
                Takto vyberete souřadnice vašeho obrázku. Po výběru souřadnic se objeví okno, ve kterém můžete najít nebo zapsat ID číslo osoby. Pro nalezení záznamu zapište
