...
<table width="100%" border="0" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Zapište ID číslo spojené s tímto testem. Pokud nemůžete číslo najít nebo vám jej dodavatel nedal, nebojte se vytvořit číslo nové. <br/><strong>Všimněte si, </strong>že pokud nezadáte hodnotu do pole Číslo testu/název, nebudete mít k
            ...
            <p>Zaškrtávací políčko Potvrzeno slouží k označení, že test poskytl potvrzenou haploskupinu na rozdíl od předpokládané. Protože haploskupina se skládá z podobných haplotypů, je možné předpovědět haploskupinu z haplotypu. Pro potvrzení
                předpovědi haploskupiny je vyžadován test SNP. Ne všechny testovací společnosti nabízejí test SNP, proto jejich předpovědi haploskupiny zákazníka jsou někdy nepřesné.</p>
        </td>
    </tr>
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Otcovskou linii daného muže lze stopovat prostřednictvím DNA obsažené v jeho chromozómu Y (Y-DNA). Test Y-DNA spočívá v analýze segmentů DNA chromozómu Y (přítomném pouze u mužů), zvaných krátká tandemová repetice (STR z anglického Short
                Tandem Repeat). Testované segmenty jsou označovány jako markery a nacházejí se v nekódující části DNA. STR vyjadřují změnu počtu opakování daného segmentu DNA.</p>

            <p><strong>Počet markerů</strong></p>
            <p>Genetický marker je gen nebo sekvence DNA se známým umístěním na chromozomu, který může být použit k identifikaci jednotlivce. Testy DNA se mohou lišit podle počtu markerů, které se testují.<br/>Typické testy Y-DNA mohou být provedeny na 12,
                25, 37, 44, 67, 91, 101 nebo 111 markerů.<br/>Vzhledem k tomu, že Family Tree DNA je v současné době jediným dodavatelem nabízejícím testy Y-DNA, je ve porovnávacím reportu Y-DNA použito 12, 25, 37, 67 a 111 markerů.</p>

            <span class="optionhead">Hodnoty markerů</span>
            <p>Zadejte hodnoty vašeho Y-DNA markeru oddělené čárkou. Například: "13,24,14,10,11-14,12,12,12,13,14,30,17,9-10,11,11,24,15,19,30,15-15-16-17" (bez uvozovek).<br/>nebo s mezerami za čárkou pro lepší čitelnost, "13, 24, 14, 10, 11-14, 12, 12,
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Zadejte výsledky svého testu mtDNA oddělené čárkou.<br/>Například: "A16129G,T16187C,C16189T,T16223C,G16230A,T16278C,C16311T,C16519T".<br/>Výsledek můžete také zadat s mezerami za čárkou pro lepší čitelnost, například "A16129G, T16187C,
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p><strong>Sdílená DNA</strong><br/>
                Sdílené segmenty DNA, označované také jako "odpovídající segmenty", jsou části DNA, které jsou shodné mezi dvěma jednotlivci. Tyto segmenty byly pravděpodobně zděděny od společného předka. Při rozhodování o tom, která shody DNA budete
                sledovat, postupujte podle těch s více než jedním velkým segmentem; to jsou vaše blízcí příbuzní, ti, jejichž stromy se snadněji spojí s vašimi.</p>

            <p><strong>Celkově sdílené cM</strong><br/>
                Toto je součet autosomální DNA, dané v centimorgans (cM), který vy a vaše genetická shoda sdílíte.<br/>Viz <a href="https://dnapainter.com/tools/sharedcmv4" traget="_blank">The Shared cM Project Tool</a>, kde je více informací o
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Zadejte nejvzdálenějšího otcovského (Y-DNA) nebo mateřského (mtDNA) předka testované osoby. Různé osoby s testy Y-DNA a mtDNA mohou mít různé nejvzdálenější předky v závislosti na tom, jak daleko do minulosti existuje jejich papírová
                stopa.</p>
