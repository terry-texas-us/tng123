...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            <a id="show"><h4 class="subheadbold">Zobrazit/skrýt klikací mapu</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Google Map Geocoder vám umožní nalézt souřadnice zeměpisné šířky a délky pro název místa při použití pole Geokódovat umístění jako
                vstupního pole.
            ...
            <p>U existujících názvů míst v TNG je někdy třeba ve vstupním poli Geokódovat umístění upravit název místa. Např. Google nemá rád názvy
                okresů
            ...
            <p>Při přijetí souřadnic zeměpisné šířky a délky, které vám nabízí vyhledávání v mapě, musíte být velmi pečliví. Přinejmenším byste měli
                ...
                nenachází na místě, kde byste jej čekali, zeměpisná šířka a délka, která je vrácena, nemusí být správná. V takovém případě byste měli
                zpozornět a kliknout na
            ...
            <p>Rozbalovací seznam Úroveň sídla můžete použít k výběru úrovně členění sídla zastoupeného názvem místa. K dispozici je šest úrovní v
                ...
                Tagy pro úrovně 2 až 5 můžete změnit, aby reflektovali např. kostel/nemocnice/hřbitov, město/obec, okres/department,
                ...
                v tabulce hřbitovů a médií. Špendlíky zobrazené v tabulce hřbitovů jsou v úrovni 2, což umožňuje, že náhrobky jsou zobrazeny v
                nejpodrobnější úrovni.</p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="help"><h4 class="subheadbold">Nápověda Google Maps</h4></a>
