...
<table width="100%" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><p class="subheadbold">Přidání nového uživatele</p></a>
            ...
            <p><span class="optionhead">Povinná pole:</span> Musíte zadat uživatelské jméno, heslo a popis uživatele. Všechna ostatní pole jsou
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="delete"><p class="subheadbold">Vymazání uživatelů</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="review"><p class="subheadbold">Přezkoumat</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="rights"><p class="subheadbold">Role a přístupová práva</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Nahoru</a></p>
            <a id="rights"><p class="subheadbold">Omezení přístupu</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="email"><p class="subheadbold">Email</p></a>
