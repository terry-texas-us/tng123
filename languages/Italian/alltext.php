...
$dates['FROM'] = "da";
$dates['TO'] = "a";
$dates['Y'] = "s�, data sconosciuta";
$dates['CAL'] = "Cal";
$dates['EST'] = "Est";

//global messages
$text['cannotexecutequery'] = "Non pu� effettuare la richiesta";
$text['to'] = "to";
$text['of'] = "di";
...
$text['usersent'] = "Il nome utente � stato inviato al tuo indirizzo email.";
$text['pwdsent'] = "La nuova password provvisoria � stata inviata al tuo indirizzo email.";
...
$text['none'] = "Nulla";
$text['mainton'] = "Il modo manutenzione � attivo";
...
$admtext['confremchild'] = "Sei sicuro voi volete rimuovere questo bambino da questa famiglia? L'individuo non sar� cancellato dal database.";
...
$admtext['activated'] = "Il vostro account � stato attivato";
$admtext['infois'] = "i vostri dati di collegamento sono:";
$admtext['subjectline'] = "Il vostro conto utente genealogia � stato attivato";
