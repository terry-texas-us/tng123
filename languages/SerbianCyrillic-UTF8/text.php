...
//$text['burialabbr'] = "сах.";  //from descend
...
$text['findplaces'] = "Пронађи све особе са подацима на овој локацији";
...
$text['people_have'] = "особе које су повезане са ДНА тестом";
$text['person_has'] = "особа која је повезана са ДНА тестом";
