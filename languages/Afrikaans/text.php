...
switch ($textpart) {
    ...
    case "gedcom":
        ...
        $text['producegedfrom'] = "Skep'n GEDCOM l�er vanaf";
    ...
    case "familygroup":
        ...
        $text['sealedplds'] = "Verse�l O (LDS)";
        $text['sealedslds'] = "Verse�l G (LDS)";
    ...
    case "pedigree":
        ...
        $text['scrollnote'] = "LW: mag dalk nodig wees om na regs en na onder te beweeg vir volledige kaart.";
    ...
    case "reports":
        ...
        $text['ssealdate'] = "Datum Verse�l G (LDS)";   //Sealed to spouse
        $text['ssealplace'] = "Plek Verse�l G (LDS)";
        $text['psealdate'] = "Datum Verse�l O (LDS)";   //Sealed to parents
        $text['psealplace'] = "Plek Verse�l O (LDS)";
    ...
    case "showphoto":
        ...
        $text['iptc005'] = "Titel";
        $text['iptc020'] = "Aanvullende Kategorie�";
    ...
    case "login":
        ...
        $text['nousers'] = "Hierdie vorm kan nie gebruik word voordat nie ten minste ��n gebruikersrekord bestaan nie. As jy die eienaar is van hierdie werf gaan dan asseblief na Amin/Gebruikers om jou Administrasiegebruiker te skep";
        ...
        $text['accactive'] = "Die gebruiker is geaktiveer, maar sal geen spesiale regte h� totdat die toegewys is nie.";
    ...
    case "install":
        ...
        $text['noperms'] = "Vir die volgende l�ers kan die regte nie ingestel word nie:";
        ...
        $text['exists'] = "bestaan";
        $text['loginfirst'] = "Jy moet eers aanteken.";
...
$text['orient'] = "Ori�ntasie"; //for a page
$text['portrait'] = "Regop";
...
$text['wasborn_male'] = "is gebore";
$text['wasborn_female'] = "is gebore";
$text['waschristened_male'] = "is gedoop";
$text['waschristened_female'] = "is gedoop";
$text['died_male'] = "gesterf";
$text['died_female'] = "gesterf";
$text['wasburied_male'] = "is begrawe";
$text['wasburied_female'] = "is begrawe";
$text['wascremated_male'] = "is veras";
$text['wascremated_female'] = "is veras";
$text['wasmarried_male'] = "getroud";
$text['wasmarried_female'] = "getroud";
$text['wasdivorced_male'] = "is geskei";
$text['wasdivorced_female'] = "is geskei";
$text['inplace'] = "in";
$text['onthisdate'] = "aan";
$text['inthisyear'] = "in";
$text['and'] = "en";
