...
switch ($textpart) {
    ...
    case "pedigree":
        ...
        $text['gen13'] = "Parđupani i Parđupane";
        $text['gen14'] = "Ožmikuri i Ožmikure";
        $text['gen15'] = "Kurajberi i Kurajberke";
        $text['gen16'] = "Sajkatovi i Sajkotovke";
        $text['gen17'] = "Beli orao i Bela pčela";
        // my add - vladimir@milicevic.rs  - www.milicevic.rs/tng
...
$text['findplaces'] = "Pronađi sve osobe sa podacima na ovoj lokaciji";
