...
$dates['JAN'] = "Jan";
$dates['JANUARY'] = "Sijecanj";
$dates['FEB'] = "Feb";
$dates['FEBRUARY'] = "Veljaca";
$dates['MAR'] = "Mar";
$dates['MARCH'] = "Ožujak";
$dates['APR'] = "Apr";
$dates['APRIL'] = "Travanj";
...
$text['forgot1'] = "<strong>Zaboravio si svoje korisnicko ime ili zaporku?</strong><br>Unesi svoju e-mail adresu dolje pa ce vam korisnicko ime biti poslato.";
$text['forgot2'] = "Unesi svoju e-mail adresu gore i svoje korisnicko ime dolje da bi se vaša zaporka resetirala (privremena zaporka ce vam biti poslata).";
$text['newpass'] = "Vaša privremena zaporka";
$text['usersent'] = "Vaše korisnicko ime je poslato na vašu e-mail adresu.";
$text['pwdsent'] = "Vaša nova privremena zaporka je poslana na vašu e-mail adresu.";
$text['loginnotsent2'] = "E-mail adresa koju ste unijeli nije nadena. Informacija nije poslata.";
$text['loginnotsent3'] = "E-mail adresa i korisnicko ime koje ste unijeli ne odgovara niti jednom korisnickom racunu u našoj evidenciji. Informacija nije poslana.";
...
$admtext['confremchild'] = "Dali ste sigurni da želite izvaditi ovo dijete iz ove familije?  Osoba nece se izbrisati iz base podataka.";
$admtext['enterfamilyid'] = "Molim unesite ID obitelji.";
$admtext['yes'] = "Da";
$admtext['no'] = "Ne";
$admtext['BIRT'] = "Rodenje";
$admtext['DEAT'] = "Smrt";
...
$admtext['NSFX'] = "Sufiks";
$admtext['NAME'] = "Ime";
$admtext['SLGC'] = "Zapecaceno na Roditelje (LDS)";
$admtext['MARR'] = "Oženjen/Udata";
$admtext['SLGS'] = "Zapecaceno na Suprugu (LDS)";
$admtext['hello'] = "Dobar Dan";
$admtext['activated'] = "Vaš genealoški racun je aktiviran.";
$admtext['infois'] = "Vaša prijavna informacija je";
$admtext['subjectline'] = "Vaš genealoški racun je aktiviran.";

//moved here in 8.1.0
$admtext['adopted'] = "usvojen";
$admtext['birth'] = "rodenje";
...
$text['startingind'] = "Pocetna osoba";
