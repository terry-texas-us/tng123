...
switch ($textpart) {
    ...
    case "relate":
        ...
        $text['sameperson'] = "De twee personen zijn ��n en dezelfde persoon.";
    ...
    case "pedigree":
        ...
        $text['extrasexpl'] = "= Er is zeker ��n foto, (levens)verhaal of ander medium bekend van deze persoon.";
        ...
        $text['showfamily'] = "Toon de Familie";
        $text['shown'] = "shown";
    ...
    case "reports":
        ...
        $text['enterdate'] = "Vul aub op zijn minst ��n van de volgende velden in: dag, maand, jaar, sleutelwoord";
    ...
    case "showphoto":
        ...
        $text['iptc005'] = "Titel";
        $text['iptc020'] = "Aanvullende categorie�n";
    ...
    case "login":
        ...
        $text['nousers'] = "Dit scherm kan pas gebruikt worden als minstens ��n gebruiker bekend is. Als u de eigenaar van deze site bent, ga dan naar Startpagina Beheerder > Gebruikers om een Administrator-account aan te maken.";
    ...
    case "stats":
        ...
        $text['days'] = "dagen";
        $text['age'] = "Leeftijd";
        $text['agedisclaimer'] = "Leeftijd-berekeningen zijn gebaseerd op personen met een geboorte- <strong>en</strong> overlijdensdatum. Als deze niet volledig zijn (bv ��n van de datums is onvolledig, bv alleen het jaar '1945' of zonder dag 'mei 1755') dan zijn deze berekeningen niet 100% nauwkeurig. Datums met 'v��r', 'na', 'circa', 'tussen' en 'berekend' worden niet meegerekend.";
...
$text['orient'] = "Ori�ntatie"; //for a page
...
$text['livingnote'] = "Tenminste nog ��n levende persoon is verbonden aan deze aantekening - detailgegevens worden niet weergegeven.";
$text['livingphoto'] = "Tenminste ��n, nog levende, persoon is verbonden aan dit item - detailgegevens worden niet weergegeven.";
...
$text['wasborn_male'] = "is geboren";
$text['wasborn_female'] = "is geboren";
$text['waschristened_male'] = "is gedoopt";
$text['waschristened_female'] = "is gedoopt";
$text['died_male'] = "is gestorven";
$text['died_female'] = "is gestorven";
$text['wasburied_male'] = "is begraven";
$text['wasburied_female'] = "is begraven";
$text['wascremated_male'] = "is gecremeerd";
$text['wascremated_female'] = "is gecremeerd";
$text['wasmarried_male'] = "getrouwd";
$text['wasmarried_female'] = "getrouwd";
$text['wasdivorced_male'] = "gescheiden";
$text['wasdivorced_female'] = "gescheiden";
$text['inplace'] = " in ";
$text['onthisdate'] = " on ";
$text['inthisyear'] = " in ";
$text['and'] = "en ";
