...
<table width="100%" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="search"><p class="subheadbold">Szukaj</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><p class="subheadbold">Dodawanie nowych albumów</p></a>
        ...
        <p><span class="optionhead">Słowa kluczowe</span><br>
            ...
            <p><span class="optionhead">Pola wymagane:</span> Tylko nazwa albumu jest wymagana, ale powinno być w Twoim interesie wypełnić również
                pozostałe pola.</p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="edit"><p class="subheadbold">Edycja istniejących albumów</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="delete"><p class="subheadbold">Usuwanie albumów</p></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="sort"><p class="subheadbold">Sortowanie albumów</p></a>
