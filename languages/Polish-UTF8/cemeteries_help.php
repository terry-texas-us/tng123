...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">Dodawanie nowych / Edycja istniejących cmentarzy</h4></a>
            ...
            <h5 class="optionhead">Nazwa cmentarza</h5>
            ...
            <h5 class="optionhead">Zdjęcie mapy do załadowania</h5>
            <p>Jeśli masz mapę lub inne zdjęcia z tego cmentarza, które nie zostało jeszcze przesłane do Twojej witryny, kliknij przycisk "Przeglądaj"
                i znajdź go na dysku twardym Twego komputera. Jeśli zdjęcie jest już w folderze nagrobków na swojej
                stronie,
                zostaw to pole puste i użyj zamiast tego pola "Nazwa pliku mapy w folderze nagrobki"</p>

            <h5 class="optionhead">Nazwa pliku mapy w folderze Nagrobki</h5>
            <p> Jeśli poprzednio załadowałeś plik mapy albo zdjęcie na serwer, podaj ścieżkę dostępu i dokładną nazwę pliku, jaka figuruje w katalogu
                Nagrobki . Możesz także kliknąć na przycisk Wybierz, aby zlokalizować plik. Jeśli przesyłałeś plik mapy
            ...
            <p>W polach <strong>Województwo</strong> i <strong>Kraj</strong> wybierz istniejący zapis korzystając z rozwijanej listy. Jeśli żądanego
                wpisu nie ma, skorzystaj z "Dodaj nowe", aby go dodać. Jeśli znajdziesz na liście niewłaściwy wpis zaznacz
            ...
            <p>Kliknij przycisk "Pokaż / Ukryj mapę Google", aby pokazać mapę. Ta opcja jest dostępna tylko jeśli masz "klucz mapy" z Google i
                ...
                miejscowość na mapie, wpisz jej nazwę w polu <strong>Określenie miejsca Geocode</strong> i kliknij "Szukaj". Możesz też kliknąć na
                mapę i przeciągnąć, aby przenieść "szpilkę" na żądaną lokalizację. Można również użyć kontroli Zoom, aby
            ...
            <p>Wprowadź szerokość i długość geograficzną lokalizacji cmentarza lub kliknij na wybrany punkt na mapie aby ustawić te wartości
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="delete"><h4 class="subheadbold">Usuwanie cmentarzy</h4></a>
