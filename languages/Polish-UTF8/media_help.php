...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">Dodawanie nowych mediów</h4></a>
            ...
            <p>Jeśli poprzednio załadowałeś Twój plik mediów, podaj ścieżkę dostępu i nazwę tego medium jaka istnieje w folderze odpowiedniej kolekcji
                ...
                poprzedniej możliwości, w tym polu ukaże się ścieżka dostępu i nazwa Twojego pliku,
                która będzie zapisana w wybranej kolekcji na serwerze. Zasugerowana ścieżka dostępu i nazwa pliku zostaną dla Ciebie wypełnione. Jeśli
                zaznaczysz "To medium pochodzi z zewnętrznego źródła" ,
                zobaczysz pole "Media URL", w którym należy podać dokładny adres Twojego medium.</p>

            <p><strong>UWAGA</strong>: Jeśli załadowujesz nowy plik, informacje, które tutaj podajesz muszą być "czytane przez wszystko". Jeśli nie,
                użyj Twojego programu FTP albo skontaktuj się z Administratorem,
                ...
                Nie można stosować polskich liter takich jak na przykład ą, ę, ź, ś itp, przecinków ani kropek (z wyjątkiem kropki przed rozszerzeniem
                pliku - .jpg czy .gif). Nie powinno się również używać spacji. Na przykład zdjęcie o nazwie "zdjęcie
            ...
            <p>Jeśli Twój serwer wspiera bibliotekę GD image library, będziesz tutaj miał możliwość dostarczyć Twoją własną miniaturkę, albo utworzyć
                ...
                lub na końcu sufiks (przyrostek). Ten prefiks i sufiks, wraz z maks. szerokością i wysokością
                miniaturki są wyznaczone w Administracja/Ustawienia główne. <strong>UWAGA:</strong> Twoja miniaturka <strong>NIE MOŻE</strong> być tym
                samym oryginalnym zdjęciem! TNG będzie reklamować, jeśli będziesz usiłował użyć oryginalnego zdjęcia jako
                miniaturki.
            ...
            <p>Jeśli poprzednio załadowałeś Twoją miniaturkę, podaj jej ścieżkę dostępu i dokładną nazwę taką, jaka zapisana jest w odpowiednim dla
                ...
                zapisywać w
                folderze podrzędnym. Będą mogły mieć te same nazwy, jak oryginały). Jeśli nie znasz dokładnej nazwy pliku, możesz kliknąć przycisk
                Wybierz, aby go zlokalizować w Twoim komputerze. Sugerowana ścieżka dostępu i nazwa pliku zostaną dla Ciebie
                wypełnione. </p>
            ...
            <p><strong>(dotyczy tylko filmów)</strong> Niektóre odtwarzacze wideo (np. Quicktime) wymagają podania wymiarów filmu. Jeśli nie będą one
                ...
                pikselach. Proszę też pamiętać o
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="edit"><h4 class="subheadbold">Edycja istniejących mediów</h4></a>
            ...
            <p><strong>Istniejące łącza:</strong> Możesz edytować lub usuwać istniejące łącza mediów klikając na ikonkę Edycja lub Usuń obok wybranego
                łącza. Edycja łącza umożliwia
            ...
            <p>Jeśli chcesz utworzyć łącze do osoby, musisz po pierwsze wybrać jej drzewo, a następnie kształt (okrąg albo prostokąt) obszaru (
                złożone kształty są również możliwe, ale musisz sam dostarczyć dla nich tekst lub kod łącza).
                Następnie postępuj według instrukcji dla wybranego kształtu, aby we właściwy sposób wybrać współrzędne łącza. Gdy współrzędne zostały
                wybrane, ukaże się okienko "Znajdź ID osoby". Podaj nazwisko oraz / lub imię (lub jego część) albo ID
                osoby.
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="delete"><h4 class="subheadbold">Usuwanie mediów</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="convert"><h4 class="subheadbold">Konwertowanie mediów z jednej kolekcji do drugiej</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="album"><h4 class="subheadbold">Dodawanie mediów do albumów</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="sort"><h4 class="subheadbold">Sortowanie mediów</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="import"><h4 class="subheadbold">Import zdjęć</h4></a>
