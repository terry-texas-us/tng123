    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a name="citations"><p class="subheadbold">Cytaty</p>
                <p>Aby dodać lub edytować cytat ze źródła do wydarzenia musisz najpierw zapisać wydarzenie, a następnie kliknąć na ikonkę obok zapisu tego wydarzenia na liście wydarzeń. Aby uzyskać więcej informacji na ten temat cytatów, zobacz <a
