...
<table width="100%" border="0" cellpadding="10" cellspacing="2" class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Być może trzeba będzie dla istniejących nazw miejsc w TNG zmienić je w polu "Określenie miejsca Geocode" . Na przykład Google nie lubi <em>powiatu (County)</em> jako części nazwy miejsca dla lokalizacji w USA i Szkocji ani nie radzi sobie z
