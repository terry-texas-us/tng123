...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p>Znajdź istniejące rodziny wpisując <strong>ID rodziny</strong>, <strong>Imię męża</strong> lub <strong>Imię żony</strong> albo ich
                część.
                Wybierz drzewo lub zaznacz "Tylko dokładna nazwa" do dalszego zawężenia kryteriów wyszukiwania. Jeśli wybierzesz "Imię męża", będą
                wyszukiwani wszyscy żonaci mężczyźni z Twojej bazy danych.
                Jeśli wybierzesz "Imię żony", będą wyszukiwane wszystkie zamężne kobiety z Twojej bazy danych. Wybierz "Bez imienia" w celu
                wyszukiwania ID rodzin.</p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">Dodawanie nowych rodzin</h4></a>
            <p><strong>Rodzina</strong> Rodzina jest potrzebna dla każdego związku między "Ojcem" i "Matką" (dzieci mogą ale nie muszą zostać dodane).
                Jeżeli dana osoba jest zamężna/żonata
                i ma dzieci z wieloma partnerami, należy utworzyć nową rodzinę dla każdej pary małżonków lub partnerów.</p>

            <p>Aby dodać nową rodzinę, kliknij na <strong>Dodaj nowe</strong>, a następnie wypełnić formularz. Niektóre informacje (notatki, cytaty,
            ...
            wpisać własny ID.
            Aby sprawdzić, czy wpisany ID jest unikalny, kliknij przycisk <strong>Sprawdź</strong>. Pojawi się informacja mówiąca, czy wybrany ID jest
            dostępny.
            Aby wygenerować unikalny ID, kliknij przycisk <strong>Generuj</strong>. Będzie to najwyższa liczba zlokalizowana w bazie danych (najwyższe
            używane ID + 1).
            Aby zabezpieczyć wybrany ID przed zajęciem go przez innego użytkownika podczas wprowadzania danych, kliknij przycisk
            <strong>Zastosuj</strong>.</p>

            <p><strong>UWAGA</strong>: Jeśli korzystasz na Twoim komputerze z programu genealogicznego, który także tworzy numery ID dla nowych
                rodzin,
            ...
            <p>Wprowadź daty i miejsca dla wymienionych standardowych wydarzeń (jeśli je znasz).Jeśli nie znasz jakiejś daty, wpisz w odpowiednie pole
                ...
                Jeśli pole przeznaczone dla daty pozostanie puste, użytkownicy z uprawnieniami <em>Zgoda na składanie komentarzy do podglądu
                    administratora (tylko ludzie, rodziny i źródła)</em> nie będą mogli składać propozycji zmian dot. daty.
                Dodatkowe wydarzenia mogą zostać dodane po zapisaniu lub kliknięciu przycisku "zastosuj". Daty należy zawsze podawać w standardowym
                formacie genealogicznych, DD MMM YYYY (na przykład <em>18 Feb 2008</em>).
                Miesiąc należy zawsze wpisywać podając trzy pierwsze litery jego nazwy w języku angielskim (widoczny będzie jego odpowiednik w języku
                polskim).Oto angielskie odpowiedniki miesięcy: Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec.
                Informacje na temat miejsca powinny być rozdzielane przecinkami ( na przykład, <em>Boston, Suffolk, Massachusetts, USA</em>). Możesz
                również wybrać istniejącą nazwę miejsca przez kliknięcie ikonki "Znajdź" (lupa).
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="edit"><h4 class="subheadbold">Edycja istniejących rodzin</h4></a>
            ...
            przycisku "Usuń"
            (widoczne, gdy umieścisz wskaźnik myszy nad dowolnym dzieckiem), aby usunąć dziecko z listy. Można także użyć przycisku "Usuń" w rubryce
            czynność.
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="delete"><h4 class="subheadbold">Usuwanie rodzin</h4></a>
            <p>Aby usunąć jedną rodzinę, należy nacisnąć przycisk <a href="#search">Szukaj</a> w celu jej zlokalizowania, a następnie kliknąć na
                ikonkę Usuń obok tej rodziny. Wiersz zmieni kolor,
                a następnie zniknie. (małżonkowie i dzieci nie zostaną usunięci z bazy danych, ale małżeństwo zostanie rozwiązane). Aby usunąć więcej
                niż jedną rodzinę naraz,
                zaznacz pole w kolumnie Wybierz obok każdej rodziny, która ma zostać usunięta, a następnie kliknąć przycisk "Usuń wybrane" znajdujący
                się na górze strony.</p>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="review"><h4 class="subheadbold">Przegląd zmian</h4></a>
