        ...
        <td class="tngshadow">
            ...
            <ol>
                <li><p><strong>Postępuj zgodnie z instrukcjami instalacji w pliku <a href="../readme.html" target="_blank">readme.html</a> albo <a
                                href="http://kielakowie.pl/tng/readme620-700.html" target="blank">readme.html po polsku</a>.
                        </strong> Wszystkich podstawowych konfiguracji
                        można dokonać bezpośrednio z tej strony, tutaj możesz również wprowadzić wszystkie potrzebne wartości w dziale <strong>Ustawienia
                            i konfiguracja</strong> w menu Admina</p></li>
                <li><p><strong>Utwórz co najmniej jedno drzewo.</strong> Jeśli masz jeden samodzielny plik GEDCOM, potrzebujesz tylko jedno drzewo.
                    </p></li>
                <li><p><strong>Utwórz co najmniej jednego użytkownika.</strong> Pierwszy użytkownik musi być Administratorem (musi on mieć wszystkie
                        uprawnienia i nie może być związany z żadnym drzewem).</p></li>
                <li><p><strong>Importuj Twoje dane, lub rozpocznij wpisywanie ręczne</strong>. Jeśli wpisujesz jeden zapis na raz, nie ma znaczenia,
                        od czego zaczynasz.
                        Najlepiej jest zaczynać od osób, a następnie łączyć je w rodziny. Później dodawać dzieci i w ten sposób budować drzewo. </p>
                </li>
                <li><p><strong>Wejdź na Procesy drugorzędne</strong> (pod Import / Export) i wybierz tam opcje, które uważasz za konieczne (aby
                        uzyskać więcej informacji zobacz "Pomoc").</p></li>
                <li><p><strong>Media.</strong> Gdy dane zostały wpisane lub importowane, możesz zacząć tworzyć łącza do zdjęć, historii i innych
                        mediów. Miłej zabawy!</p></li>
                <li><p><strong>Inne.</strong> Jeśli będziesz chciał zajrzeć do innych sekcji w menu administratora, na każdej stronie możesz znaleźć
                        dodatkową pomoc.</p></li>
            </ol>
