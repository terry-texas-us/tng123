...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">Dodaj nowe / Edytuj istniejące miejsca</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="delete"><h4 class="subheadbold">Usuwanie miejsc</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="merge"><h4 class="subheadbold">Scalanie miejsc</h4></a>
            ...
            <p>Na tej karcie można będzie zobaczyć listę miejsc pasującą do kryteriów wyszukiwania. Jeśli którykolwiek z nich odnosi się do tej samej
                ...
                w kolumnie oznaczonej "do tego (zachowaj)".
                Będzie to nazwa miejsca, która zastąpi wszystkie zaznaczone miejsca. Ten wiersz stanie się zielony. Nie ma znaczenia, czy nazwa
                miejsca do zachowania jest również jednym z tych
                zaznaczonych w ramach "scal te (usuń)". Będziesz mógł wybrać tylko jeden zapis w kolumnie "zachowaj", ale można wybrać dowolną liczbę
                duplikatów aby je z nim scalić.
                Jeśli jesteś gotowy do scalania, kliknij przycisk "Scal miejsca" na górze lub na dole ekranu. Wszystkie nazwy usuniętych miejsc (w
                zapisach osób i rodzin) zostaną zastąpione przez nazwę
                aktualnie wybranego. <strong>Uwaga:</strong> informacje w polach Notatki i Szerokość / długość będzie tylko zachowane dla miejsca
                które pozostaje.</p>

            <p>Proszę również pamiętać, że wydajność obniża się, im więcej elementów jest wybranych do scalania. Innymi słowy, scalanie dwóch
                miejscach odbędzie się znacznie szybciej niż scalanie 20 miejsc.</p>
