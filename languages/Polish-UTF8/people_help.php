...
<table class="tblback normal">
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <a id="add"><h4 class="subheadbold">Dodawanie nowej osoby</h4></a>
            ...
            <p>Podaj tutaj jak najwięcej informacji o osobie. <strong>Pseudonim</strong> jest nieformalnym imieniem czasami łączonym z osobą.
                ...
                <strong>Suffix</strong> będzie się wyświetlał po przecinku za imieniem lub nawiskiem. <strong>Kolejność nazwisko/imię</strong>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="edit"><h4 class="subheadbold">Edycja istniejących osób</h4></a>
            ...
            <p>Jeśli dana osoba ma rodziców, sekcja <strong>Rodzice</strong> będzie widoczna w sekcji Wydarzenia. Ta sekcja jest zamknięta i wskazuje
                ...
                włączając w to wzajemny stosunek pomiędzy daną osobą i każdą parą rodziców,
                mogą być edytowane w każdym polu. Gdy zatrzymasz wskaźnik myszy nad sekcją rodziców, w prawym górnym rogu pola ukaże się opcja
            ...
            <p>Jeśli dana osoba posiada co najmniej jednego współmałżonka lub partnera, sekcja <strong>Małżonkowie/partnerzy</strong> będzie widoczna
                ...
                niego. Gdy zatrzymasz wskaźnik myszy nad sekcją Małżonkowie / partnerzy, w prawym górnym rogu pola ukaże się
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="delete"><h4 class="subheadbold">Usuwanie osób</h4></a>
    ...
    <tr class="databack">
        <td class="tngshadow">
            ...
            <p style="float:right;"><a href="#top">Wróć</a></p>
            <a id="merge"><h4 class="subheadbold">Scalanie osób</h4></a>
            ...
            <p><em>Użyj Soundex</em> znaczy, że funkcja Soundex MySQL będzie użyta do porównania imion. W tym przypadku, "Blakely" mógłby zostać
                uznany jako zgodność dla "Blackley".</p>

            <p><em>Wspólne notatki &amp; cytaty</em> znaczy, że notatki i cytaty Osoby 2 będą dodane do notatek i cytatów Osoby 1 we wszystkich
                polach. Jeśli ta możliwość nie zostanie wybrana,
                notatki i cytaty dotyczące Osoby 2 zostaną utracone, ponieważ zostaną skasowane przez te, odpowiadające polu Osoby 1.</p>

            <p><em>Połącz media</em> znaczy, że media dotyczące Osoby 2 będą dodane do mediów Osoby 1 we wszystkich polach. Jeśli ta możliwość nie
            ...
            <p>Osoba 2 jest scalana z osobą 1. ID Osoby 1 oraz jej wszystkie inne dane zostaną zachowane, chyba, że dla Osoby 2 zostało zaznaczone
                ...
                1. Odpowiadające im dane Osoby 1 zostaną wtedy usunięte.
