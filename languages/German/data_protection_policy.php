...
<h1><?php echo $text['dataprotect']; ?>
    ...
    <p>Die Nutzung unserer Website ist ohne Angabe personenbezogener Daten möglich. Wenn personenbezogene Daten erhoben werden (z. B. Name und E-Mail-Adresse im Kontaktformular), werden diese freiwillig angegeben. Diese Daten werden nicht an Dritte
        weitergegeben.</p>
    ...
    <h3>Cookies</h3>
    <p>Diese Website verwendet Cookies. Cookies schaden Ihrem Computer nicht und enthalten keine Viren. Cookies übernehmen wichtige Funktionen beim Betrieb dieser Site. Cookies sind kleine Textdateien, die von Ihrem Browser auf Ihrem Computer gespeichert
        werden.</p>
    <p>Die meisten der von uns verwendeten Cookies sind "Session-Cookies". Sie werden automatisch gelöscht, wenn Sie Ihren Browser schließen. Andere Cookies bleiben auf Ihrem Gerät gespeichert, bis Sie sie löschen. Diese Cookies ermöglichen es uns, Ihren
