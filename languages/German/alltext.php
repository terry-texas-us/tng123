...
//global messages
$text['cannotexecutequery'] = "Kann Abfrage nicht ausf�hren";
$text['to'] = "bis";
$text['of'] = "von";
$text['text_next'] = "Vorw�rts";
$text['text_prev'] = "Zur�ck";
...
$text['forgot2'] = "Geben Sie oben Ihre E-Mail-Adresse und unten Ihre Benutzerkennung ein. Ihr Passwort wird zur�ckgesetzt. (Ein tempor�res Passwort wird Ihnen zugesendet.)";
$text['newpass'] = "Ihr neues, tempor�res Passwort";
$text['usersent'] = "Ihre Benutzerkennung wurde an Ihre E-Mail-Adresse gesendet.";
$text['pwdsent'] = "Ihr neues, tempor�res Passwort wurde an Ihre E-Mail-Adresse gesendet.";
$text['loginnotsent2'] = "Die von Ihnen angegebene E-Mail-Adresse stimmt mit keiner vorhandenen Benutzerkennung �berein. Es wurde nichts versendet.";
...
$admtext['confunlink'] = "Sind Sie sicher, dass Sie die Verkn�pfung dieser Person als Ehepartner in dieser Familie l�sen m�chten?";
$admtext['confunlinkc'] = "Sind Sie sicher, dass Sie die Verkn�pfung dieser Person als Kind dieser Familie l�sen m�chten?";
$admtext['confremchild'] = "Sind Sie sicher, dass Sie die Verkn�pfung des Kindes zu dieser Familie l�sen m�chten? Das Kind wird nicht aus der Datenbank gel�scht.";
...
$text['problem'] = "Ein Fehler ist in TNG aufgetreten. Ursache kann das Setup, ein unvollst�ndiges Upgrade oder ein Programmfehler sein. Wenn Sie der Webseitenbetreiber sind, kontaktieren Sie den TNG-Support, um Hilfe zu erhalten. Bitte kopieren Sie die untenstehende Meldung in Ihre Nachricht.";
$text['query'] = "Abfrage";
...
$text['confirmed'] = "Haplogruppe best�tigt";
...
$admtext['mrca'] = "N�chster gemeinsamer Vorfahre";
...
//moved here in 12.0.0
$admtext['xtra_mut'] = "Zus�tzliche Mutationen";
...
$admtext['relationship_range'] = "M�gliche Verwandtschaft";
$admtext['suggested_relationship'] = "Vermutete Verwandtschaft";
$admtext['actual_relationship'] = "Tats�chliche Verwandtschaft";
...
$admtext['largest_segment'] = "Gr��tes Segment";
...
$text['for_match'] = "f�r diesen Match";
