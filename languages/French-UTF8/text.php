...
switch ($textpart) {
  ...
  case "relate":
    ...
    $text['fmil'] = "le beau-père ou bell- mère de";
  ...
  case "pedigree":
    ...
    $text['scrollnote'] = "Note : Utiliser les barres de défilement pour voir tout l'arbre.";
  ...
  case "reports":
    ...
    $text['nodayevents'] = "événments de ce mois non associés à un jour spécifique";
    //added in 9.0.0
  ...
  case "showphoto":
    ...
    $text['photoowner'] = "Source ou propriétaire";
  ...
  case "whatsnew":
    ...
    //added in 11.0.0
    $text['wifename'] = "Le nom de l'épouse";
    break;
  ...
  case "timeline":
    ...
    //changed in 9.0.0
    $text['noliving'] = "L'individu suivant est enregistré comme étant en vie ou marqué privé et n'est pas affiché parce que vous n'êtes pas connecté avec les autorisations nécessaires";
    break;
  ...
  case "login":
    ...
    $text['noregs'] = "Désolés, mais nous n'acceptons pas de nouveaux enregistrements d'utilisateurs pour le moment. Merci de <a href=\"suggest.php\">nous contacter</a> directement si vous avez des commentaires ou des questions concernant n'importe quoi sur ce site Web.";
    //changed in 8.0.0
    ...
    $text['accactive'] = "Le compte à été activé, mais l'utilisateur n'a pas de droit spécifique tant que vous ne les avez pas spécifiés..";
    ...
    $text['ackmessage'] = "Votre demande d'un compte d'utilisateur à bien été reçue. Votre compte restera inactif en attendant une vérification par l'administrateur. Nous vous contacterons par courriel dès que votre compte sera activé.";
    //added in 12.0.0
...
$text['pwrdby'] = "Ce site est propulsé par le logiciel";
...
$text['wascremated_male'] = "a étét incinéré";    // same as $text['wascremated'] if no gender verb
$text['wascremated_female'] = "a été incinérée";  // same as $text['wascremated'] if no gender verb
$text['wasmarried_male'] = "a épousé";  // same as $text['wasdmarried'] if no gender verb
$text['wasmarried_female'] = "a épousé";  // same as $text['wasdmarried'] if no gender verb
