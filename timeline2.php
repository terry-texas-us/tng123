...
function getEvents($person) {
    ...
    foreach ($events as $event) {
        ...
        $eventstr .= "<table border='0' cellspacing='0' cellpadding='1'><tr><td class='pboxpopup whitespace-no-wrap'><span class='normal'>&gt; ";
...
foreach ($timeline as $timeentry) {
    ...
    $query = "SELECT firstname, lnprefix, lastname, prefix, suffix, nameorder, living, private, branch, sex,
...
foreach ($keeparray as $timeentry) {
    ...
    echo "<tr><td class='whitespace-no-wrap'><span class='normal'>{$timeentry['name']}</span></td></tr>";
...
<?php if ($counter) { ?>
    ...
    <table class="whiteback w-full" cellpadding="3" cellspacing="1">
        ...
        foreach ($tlevents2 as $key => $value) {
            $counter++;
            echo "<tr>\n";
            echo "<td class='databack' align=\"right\"><span class='normal'>$counter&nbsp;</span></td>";
            echo "<td class='databack'><span class='normal'>$key&nbsp;</span></td>";
            echo "<td class='databack'><ul class='normal'>$value</ul></td>";
            echo "</tr>\n";
        }
        ?>
    </table><br>
