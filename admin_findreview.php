                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="submit" name="submit" value="<?php echo $admtext['reset']; ?>"
                                       onClick="document.form1.reviewuser.value=''; document.form1.tree.selectedIndex=0; document.form1.living.checked=false; document.form1.exactmatch.checked=false;" class="aligntop">
                            </td>
                        </tr>
                    </table>
              ...
              ?>
                <table cellpadding="3" cellspacing="1" border="0" class="normal">
                    <tr>
                        ...
                        <td class="fieldnameback fieldname">
                            <nobr>&nbsp;<b><?php echo $admtext['name']; ?></b>&nbsp;</nobr>
                        </td>
                        <td class="fieldnameback fieldname">
                            <nobr>&nbsp;<b><?php echo $admtext['event']; ?></b>&nbsp;</nobr>
                        </td>
                        <td class="fieldnameback fieldname">
                            <nobr>&nbsp;<b><?php echo $admtext['postdate']; ?></b>&nbsp;</nobr>
                        </td>
                        <td class="fieldnameback fieldname">
                            <nobr>&nbsp;<b><?php echo $admtext['tree']; ?></b>&nbsp;</nobr>
                        </td>
                    </tr>
