                ...
                <div id="ped" style="display:none">
                            ...
                            <td>
                                <select name="usepopups">
                                    <option value="1"<?php if ($pedigree['usepopups'] == 1) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['pedstandard']; ?></option>
                                    <option value="0"<?php if (!$pedigree['usepopups']) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['pedbox']; ?></option>
                                    <option value="-1"<?php if ($pedigree['usepopups'] == -1) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['pedtextonly']; ?></option>
                                    <option value="2"<?php if ($pedigree['usepopups'] == 2) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['pedcompact']; ?></option>
                                    <option value="3"<?php if ($pedigree['usepopups'] == 3) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['ahnentafel']; ?></option>
                                    <option value="4"<?php if ($pedigree['usepopups'] == 4) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['pedvertical']; ?></option>
                                    <option value="5"<?php if ($pedigree['usepopups'] == 5) {
                                      echo " selected";
                                    } ?>><?php echo $text['fanchart']; ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['maxpedgens']; ?>:</td>
                            <td><input type="text" value="<?php echo $pedigree['maxgen']; ?>" name="maxgen" size="5"></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['initgens']; ?>:</td>
                            <td colspan="4"><input type="text" value="<?php echo $pedigree['initpedgens']; ?>" name="initpedgens" size="5"></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['popupspouses']; ?>:</td>
                            <td><input type="radio" name="popupspouses" value="1" <?php if ($pedigree['popupspouses']) {
                                echo "checked";
                              } ?>> <?php echo $admtext['yes']; ?> <input type="radio" name="popupspouses" value="0" <?php if (!$pedigree['popupspouses']) {
                                echo "checked";
                              } ?>> <?php echo $admtext['no']; ?></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['popupkids']; ?>:</td>
                            <td><input type="radio" name="popupkids" value="1" <?php if ($pedigree['popupkids']) {
                                echo "checked";
                              } ?>> <?php echo $admtext['yes']; ?> <input type="radio" name="popupkids" value="0" <?php if (!$pedigree['popupkids']) {
                                echo "checked";
                              } ?>> <?php echo $admtext['no']; ?></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['popupchartlinks']; ?>:</td>
                            <td><input type="radio" name="popupchartlinks" value="1" <?php if ($pedigree['popupchartlinks']) {
                                echo "checked";
                              } ?>> <?php echo $admtext['yes']; ?> <input type="radio" name="popupchartlinks" value="0" <?php if (!$pedigree['popupchartlinks']) {
                                echo "checked";
                              } ?>> <?php echo $admtext['no']; ?></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['hideempty']; ?>:</td>
                            <td><input type="radio" name="hideempty" value="1" <?php if ($pedigree['hideempty']) {
                                echo "checked";
                              } ?>> <?php echo $admtext['yes']; ?> <input type="radio" name="hideempty" value="0" <?php if (!$pedigree['hideempty']) {
                                echo "checked";
                              } ?>> <?php echo $admtext['no']; ?></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['boxwidth']; ?>:</td>
                            <td><input type="text" value="<?php echo $pedigree['boxwidth']; ?>" name="boxwidth" size="10"></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['boxheight']; ?>:</td>
                            <td><input type="text" value="<?php echo $pedigree['boxheight']; ?>" name="boxheight" size="10"></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="boxalign">
                                    <option value="center"<?php if ($pedigree['boxalign'] == "center") {
                                      echo " selected";
                                    } ?>><?php echo $admtext['center']; ?></option>
                                    <option value="left"<?php if ($pedigree['boxalign'] == "left") {
                                      echo " selected";
                                    } ?>><?php echo $admtext['left']; ?></option>
                                    <option value="right"<?php if ($pedigree['boxalign'] == "right") {
                                      echo " selected";
                                    } ?>><?php echo $admtext['right']; ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['boxheightshift']; ?>:</td>
                            <td><input type="text" value="<?php echo $pedigree['boxheightshift']; ?>" name="boxheightshift" size="10"></td>
                        </tr>
                    </table>
                    ...
                    <table class="normal">
                        <tr>
                            ...
                            <td><input type="text" value="<?php echo $pedigree['vwidth']; ?>" name="vwidth" size="5"></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['vboxheight']; ?>:</td>
                            <td><input type="text" value="<?php echo $pedigree['vheight']; ?>" name="vheight" size="5"></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['vspacing']; ?>:</td>
                            <td><input type="text" value="<?php echo $pedigree['vspacing']; ?>" name="vspacing" size="5"></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $admtext['boxnamesize']; ?>:</td>
                            <td><input type="text" value="<?php echo $pedigree['vfontsize']; ?>" name="vfontsize" size="5"></td>
                        </tr>
                    </table>
                </div>
                            ...
                            <td>
                                <select name="defdesc">
                                    <option value="2"<?php if ($pedigree['defdesc'] == 2) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['stdformat']; ?></option>
                                    ...
                                    <option value="1"<?php if ($pedigree['defdesc'] == 1) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['regformat']; ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top"><span class="normal"><?php echo $admtext['maxpedgens']; ?>:</span></td>
                            <td colspan="4"><input type="text" value="<?php echo $pedigree['maxdesc']; ?>" name="maxdesc" size="5"></td>
                        </tr>
                        <tr>
                            <td valign="top"><span class="normal"><?php echo $admtext['initgens']; ?>:</span></td>
                            <td colspan="4"><input type="text" value="<?php echo $pedigree['initdescgens']; ?>" name="initdescgens" size="5"></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="stdesc">
                                    <option value="0"<?php if (!$pedigree['stdesc']) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['stexpand']; ?></option>
                                    <option value="1"<?php if ($pedigree['stdesc'] == 1) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['stcollapse']; ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="regnosp">
                                    <option value="0"<?php if (!$pedigree['regnosp']) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['chshow']; ?></option>
                                    <option value="1"<?php if ($pedigree['regnosp']) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['chifsp']; ?></option>
                                </select>
                            </td>
                        </tr>
                    </table>
              ...
              <?php echo displayToggle("plus2", 0, "rel", $admtext['relchart'], ""); ?>
                ...
                <div id="rel" style="display:none">
                    <table>
                        ...
                        <tr>
                            <td><span class="normal"><?php echo $admtext['initrels']; ?>:</span></td>
                            <td><input type="text" value="<?php echo $pedigree['initrels']; ?>" name="initrels" size="5"></td>
                        </tr>
                        <tr>
                            <td><span class="normal"><?php echo $admtext['maxrels']; ?>:</span></td>
                            <td><input type="text" value="<?php echo $pedigree['maxrels']; ?>" name="maxrels" size="5"></td>
                        </tr>
                        <tr>
                            <td><span class="normal"><?php echo $admtext['maxpedgens']; ?>:</span></td>
                            <td><input type="text" value="<?php echo $pedigree['maxupgen']; ?>" name="maxupgen" size="5"></td>
                        </tr>
                    </table>
                </div>
              ...
              <?php echo displayToggle("plus3", 0, "time", $admtext['timechart'], ""); ?>
                ...
                <div id="time" style="display:none">
                    <table>
                        ...
                        <tr>
                            <td><span class="normal"><?php echo $admtext['tcwidth']; ?>:</span></td>
                            <td><input type="text" value="<?php echo $pedigree['tcwidth']; ?>" name="tcwidth" size="5"></td>
                        </tr>
                        <tr>
                    ...
                    <table<?php if (!$pedigree['simile']) {
                      echo " style=\"display:none\"";
                        ...
                        <tr>
                            ...
                            <td><input type="text" value="<?php echo $pedigree['tcheight']; ?>" name="tcheight" size="5"></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="tcevents">
                                    <option value="0"<?php if (!$pedigree['tcevents']) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['allevs']; ?></option>
                                    <option value="1"<?php if ($pedigree['tcevents']) {
                                      echo " selected";
                                    } ?>><?php echo $admtext['rangeevs']; ?></option>
                                </select>
                            </td>
                        </tr>
                    </table>
                            ...
                            <td valign="top">
                                <table class="normal">
                                    <tr>
                                        ...
                                        <td><input type="text" value="<?php echo $pedigree['leftindent']; ?>" name="leftindent" size="10"></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $admtext['boxnamesize']; ?>:</td>
                                        <td><input type="text" value="<?php echo $pedigree['boxnamesize']; ?>" name="boxnamesize" size="10"></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $admtext['boxdatessize']; ?>:</td>
                                        <td><input type="text" value="<?php echo $pedigree['boxdatessize']; ?>" name="boxdatessize" size="10"></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $admtext['boxcolor']; ?>:</td>
                                        <td><input type="text" value="<?php echo $pedigree['boxcolor']; ?>" name="boxcolor" id="boxcolor" size="8"> <A HREF="#" onClick="cp.select(document.form1.boxcolor,'pick1');return false;" NAME="pick1" ID="pick1"><img
                                                        src="img/tng_colorpicker.gif" alt="" width="19" height="17" border="0"></A></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $admtext['colorshift']; ?>:</td>
                                        <td><input type="text" value="<?php echo $pedigree['colorshift']; ?>" name="colorshift" size="10"></td>
                                    </tr>
                                    <tr>
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                        <td><?php echo $admtext['boxHsep']; ?>:</td>
                                        <td><input type="text" value="<?php echo $pedigree['boxHsep']; ?>" name="boxHsep" size="10"></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $admtext['boxVsep']; ?>:</td>
                                        <td><input type="text" value="<?php echo $pedigree['boxVsep']; ?>" name="boxVsep" size="10"></td>
                                    </tr>
                                    <tr>
                            ...
                            <td valign="top">
                                <table>
                                    <tr>
                                        ...
                                        <td><input type="text" value="<?php echo $pedigree['linewidth']; ?>" name="linewidth" size="10"></td>
                                    </tr>
                                    <tr>
                                        <td valign="top"><span class="normal"><?php echo $admtext['borderwidth']; ?>:</span></td>
                                        <td><input type="text" value="<?php echo $pedigree['borderwidth']; ?>" name="borderwidth" size="10"></td>
                                    </tr>
                                    <tr>
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" value="<?php echo $pedigree['popuptimer']; ?>" name="popuptimer" size="10"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select name="pedevent">
                                                <option value="down"<?php if ($pedigree['event'] == "down") {
                                                  echo " selected";
                                                } ?>><?php echo $admtext['mousedown']; ?></option>
                                                <option value="over"<?php if ($pedigree['event'] == "over") {
                                                  echo " selected";
                                                } ?>><?php echo $admtext['mouseover']; ?></option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign="top"><span class="normal"><?php echo $admtext['puboxwidth']; ?>:</span></td>
                                        <td><input type="text" value="<?php echo $pedigree['puboxwidth']; ?>" name="puboxwidth" size="10"></td>
                                    </tr>
                                    <tr>
                                        <td valign="top"><span class="normal"><?php echo $admtext['puboxheight']; ?>:</span></td>
                                        <td><input type="text" value="<?php echo $pedigree['puboxheight']; ?>" name="puboxheight" size="10"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" value="<?php echo $pedigree['puboxheightshift']; ?>" name="puboxheightshift" size="10"></td>
                                    </tr>
                                    <tr>
