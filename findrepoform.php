    ...
    <form action="" method="post" name="findrepoform1" id="findrepoform1" onsubmit="return <?php echo $applyfilter; ?>">
        ...
        <table cellspacing="0" cellpadding="2" class="normal">
            <tr>
                ...
                <td><input type="text" name="mytitle" id="mytitle" class="longfield"
                           onkeyup="filterChanged(event, {form:'findrepoform1',fieldId:'mytitle',type:'R',tree:'<?php echo $tree; ?>',destdiv:'reporesults'<?php echo $mediaoption; ?>});"></td>
