                ...
                <table class="normal">
                  ...
                  ?>
                    ...
                    <tr>
                        ...
                        <td><input type="radio" name="keep" value="1" checked> <?php echo $admtext['accept']; ?> &nbsp; <input type="radio" name="keep" value="0"> <?php echo $admtext['ignore']; ?></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td valign="top"><?php echo $admtext['collapseev']; ?>:</td>
                        <td><input type="radio" name="collapse" value="1"> <?php echo $admtext['yes']; ?> &nbsp; <input type="radio" name="collapse" value="0" checked> <?php echo $admtext['no']; ?></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td valign="top"><?php echo $admtext['ldsevent']; ?>:</td>
                        <td><input type="radio" name="ldsevent" value="1"> <?php echo $admtext['yes']; ?> &nbsp; <input type="radio" name="ldsevent" value="0" checked> <?php echo $admtext['no']; ?></td>
                        <td></td>
                    </tr>
                </table>
                <br/>
