                  ...
                  <form action="" name="form1" id="form1" onsubmit="return startUtility(document.form1.withsel);">
                      ...
                      <table cellpadding="3" cellspacing="1" border="0" class="normal">
                          <tr>
                              ...
                              <td class="fieldnameback fieldname">
                                  <nobr>&nbsp;<b><?php echo $admtext['table']; ?></b>&nbsp;</nobr>
                              </td>
                              <td class="fieldnameback fieldname">
                                  <nobr>&nbsp;<b><?php echo $admtext['lastbackup']; ?></b>&nbsp;</nobr>
                              </td>
                              <td class="fieldnameback fieldname">
                                  <nobr>&nbsp;<b><?php echo $admtext['backupfilesize']; ?></b>&nbsp;</nobr>
                              </td>
                              <td class="fieldnameback fieldname" style="width:200px">
                                  <nobr>&nbsp;<b><?php echo $admtext['msg']; ?></b>&nbsp;</nobr>
                              </td>
                          </tr>
                        <?php
