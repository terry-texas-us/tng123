  ...
  foreach ($tngevents as $tngevent) {
    ...
    if ($needfamilies) {
      ...
      $query = "SELECT $families_table.ID, husb.personID as hpersonID, husb.lastname as hlastname, husb.lnprefix as hlnprefix, husb.firstname as hfirstname, 
				husb.living as hliving, husb.private as hprivate, husb.branch as hbranch, husb.prefix as hprefix, husb.suffix as hsuffix, husb.nameorder as hnameorder, 
				wife.personID as wpersonID, wife.lastname as wlastname, wife.lnprefix as wlnprefix, wife.firstname as wfirstname, 
				wife.living as wliving, wife.private as wprivate, wife.branch as wbranch, wife.prefix as wprefix, wife.suffix as wsuffix, wife.nameorder as wnameorder,
