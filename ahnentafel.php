...
?>
    ...
    <div class="titleboxmedium">
        ...
        while ($spouserow = array_shift($row['spouses'])) {
            ...
            echo " [<a href=\"familygroup.php?familyID={$spouserow['familyID']}&amp;tree=$tree\">{$text['groupsheet']}</a>]";
            echo "</p>\n";
                        ...
                        if ($gotmother) {
                            ...
                            if ($mothrow['firstname'] || $mothrow['lastname']) {
                                ...
                                if ($parentrow['husband']) {
                                    ...
                                    echo " [<a href=\"familygroup.php?familyID=$nextfamily&amp;tree=$tree\">{$text['groupsheet']}</a>]</p>\n";
