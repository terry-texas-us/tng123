...
<iframe name="iframe1" id="iframe1" src="<?php echo getURL("img_viewer", 1); ?>sa=1&mediaID=<?php echo $_GET['mediaID']; ?>&medialinkID=<?php echo $_GET['medialinkID']; ?>" width="100%" height="1" onLoad="calcHeight(1);" frameborder="0" marginheight="0"
