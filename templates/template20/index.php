...
// Use the random photo with the following width and height parameters
        ...
        <div id="rightsection" class="rightsection"><br>
            ...
            <div class="normal">
                <p>
                    <a href="<?php echo $tmp['t20_featurelink1']; ?>"><img src="<?php echo $cms['tngpath'] . $templatepath; ?><?php echo $tmp['t20_featurethumb1']; ?>" alt="feature 1" class="featureimg"/><span
                ...
                <p>
                    <a href="<?php echo $tmp['t20_featurelink2']; ?>"><img src="<?php echo $cms['tngpath'] . $templatepath; ?><?php echo $tmp['t20_featurethumb2']; ?>" alt="feature 2" class="featureimg"/><span
                ...
                <p>
                    <a href="<?php echo $tmp['t20_featurelink3']; ?>"><img src="<?php echo $cms['tngpath'] . $templatepath; ?><?php echo $tmp['t20_featurethumb3']; ?>" alt="feature 3" class="featureimg"/><span
                ...
                <p>
                    <a href="<?php echo $tmp['t20_featurelink4']; ?>"><img src="<?php echo $cms['tngpath'] . $templatepath; ?><?php echo $tmp['t20_featurethumb4']; ?>" alt="feature 4" class="featureimg"/><span
                ...
                <p>
                    <a href="<?php echo $tmp['t20_featurelink5']; ?>"><img src="<?php echo $cms['tngpath'] . $templatepath; ?><?php echo $tmp['t20_featurethumb5']; ?>" alt="feature 5" class="featureimg"/><span
                ...
                <p>
                    <a href="<?php echo $tmp['t20_featurelink6']; ?>"><img src="<?php echo $cms['tngpath'] . $templatepath; ?><?php echo $tmp['t20_featurethumb6']; ?>" alt="feature 6" class="featureimg"/><span
            ...
            <div class="normal">
                <p><img src="<?php echo $cms['tngpath'] . $templatepath; ?>img/email.gif" alt="email image" class="emailimg"/></p>
