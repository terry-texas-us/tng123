    ...
    <nav class="nav-primary">
        <div class="wrap">
            ...
            <ul class="menu nav-menu menu-primary responsive-menu">
                <li class="first menu-item current-menu-item"><a href="<?php echo $cms['tngpath'] . $homepage; ?>">Home</a></li>
                <?php
                if ($dadlabel) {
                    ?>
                    <li class="menu-item"><a
                                href="<?php echo $cms['tngpath']; ?>pedigree.php?personID=<?php echo $tmp['t15_dadperson']; ?>&amp;tree=<?php echo $tmp['t15_dadtree']; ?>"><?php echo $dadlabel; ?></a>
                    </li>
                    <?php
                }
                if ($momlabel) {
                    ?>
                    <li class="menu-item"><a
                                href="<?php echo $cms['tngpath']; ?>pedigree.php?personID=<?php echo $tmp['t15_momperson']; ?>&amp;tree=<?php echo $tmp['t15_momtree']; ?>"><?php echo $momlabel; ?></a>
                    </li>
                    <?php
                }
                ...
                <section class="widget">
                    <div class="widget-wrap">
                        <aside class="widget-area">
                            <section class="widget">
                                <div class="widget-wrap">
                                    <a href="<?php echo $cms['tngpath'] . $homepage; ?>"><img
                                                src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t15_titleimg']; ?>" title="" alt=""></a>
                                </div>
                            </section>
                        </aside>
                    </div>
