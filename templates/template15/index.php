                ...
                <div class="">
                    ...
                    <article class="post entry">
                        ...
                        <a href="<?php echo $tmp['t15_featurelink2']; ?>" title="" class="alignnone">
                            <img src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t15_featurethumb2']; ?>" alt="Lorem Ipsum" title="" class="" width="405"></a>
                        <header class="entry-header">
                    ...
                    <article class="post">
                        <a href="<?php echo $tmp['t15_featurelink3']; ?>" title="" class="alignnone"><img src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t15_featurethumb3']; ?>" class="" alt="interest" width="405"></a>
                        <header class="entry-header">
