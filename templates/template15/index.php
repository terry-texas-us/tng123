                    ...
                    <div class="">
                        ...
                        <article class="post">
                            <a href="<?php echo $tmp['t15_featurelink1']; ?>" title="" class="alignnone"><img
                                        src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t15_mainimage']; ?>" id="mainphoto" class=""
                                        alt="main image"></a>
                    ...
                    <div class="">
                        ...
                        <article class="post entry">
                            ...
                            <a href="<?php echo $tmp['t15_featurelink2']; ?>" title="" class="alignnone">
                                <img src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t15_featurethumb2']; ?>" alt="Lorem Ipsum" title=""
                                     class="" width="405"></a>
                            <header class="entry-header">
                                <h2 class="entry-title"><a
                        ...
                        <article class="post">
                            <a href="<?php echo $tmp['t15_featurelink3']; ?>" title="" class="alignnone"><img
                                        src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t15_featurethumb3']; ?>" class="" alt="interest"
                                        width="405"></a>
                            <header class="entry-header">
                                <h2 class="entry-title"><a
                ...
                <div class="">
                    ...
                    <article class="post entry">
                        <a href="<?php echo $tmp['t15_featurelink4']; ?>" title="" class="alignleft"><img
                                    src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t15_featurethumb4']; ?>" class="" alt="" height="100"
                                    width="100"></a>
                        <header class="entry-header">
                            <h2 class="entry-title"><a
                    ...
                    <article class="post entry">
                        <a href="<?php echo $tmp['t15_featurelink5']; ?>" title="" class="alignleft"><img
                                    src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t15_featurethumb5']; ?>" class="" alt="" height="100"
                                    width="100"></a>
                        <header class="entry-header">
                            <h2 class="entry-title"><a
                    ...
                    <article class="post entry">
                        <a href="<?php echo $tmp['t15_featurelink6']; ?>" title="" class="alignleft"><img
                                    src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t15_featurethumb6']; ?>" class="" alt="" height="100"
                                    width="100"></a>
                        <header class="entry-header">
                            <h2 class="entry-title"><a
                ...
                <div class="">
                    ...
                    <div class="">
                        <a href="<?php echo $tmp['t15_featurelink7']; ?>" title="" class="alignleft"><img
                                    src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t15_featurethumb7']; ?>" class="" alt="" height="150"
                                    width="150"></a>
            ...
            <section class="widget widget_text">
                <div class="">
                    ...
                    <a href="<?php echo $tmp['t15_featurelink8']; ?>" title="" class="alignnone"><img
                                src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t15_featurethumb8']; ?>" class="" alt="" height="200"
                                width="360"></a>
                    <div class="">
