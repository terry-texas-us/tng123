                        ...
                        <div id="linktable">
                            ...
                            <table cellspacing="4">
                                <tr>
                                    ...
                                    <td>&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>whatsnew.php" class="sidelink"><?php echo $text['mnuwhatsnew']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>statistics.php" class="sidelink"><?php echo $text['mnustatistics']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>anniversaries.php" class="sidelink"><?php echo $text['anniversaries']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                                <tr>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>browsemedia.php?mediatypeID=photos" class="sidelink"><?php echo $text['mnuphotos']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>browsemedia.php?mediatypeID=histories" class="sidelink"><?php echo $text['mnuhistories']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>cemeteries.php" class="sidelink"><?php echo $text['mnucemeteries']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>places.php" class="sidelink"><?php echo $text['places']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                                <tr>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>browsemedia.php?mediatypeID=documents" class="sidelink"><?php echo $text['documents']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>browsemedia.php" class="sidelink"><?php echo $text['allmedia']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>browsemedia.php?mediatypeID=headstones" class="sidelink"><?php echo $text['mnutombstones']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>browsealbums.php" class="sidelink"><?php echo $text['albums']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                                <tr>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>reports.php" class="sidelink"><?php echo $text['mnureports']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>browsesources.php" class="sidelink"><?php echo $text['mnusources']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>bookmarks.php" class="sidelink"><?php echo $text['bookmarks']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>suggest.php?page=<?php echo $title; ?>" class="sidelink"><?php echo $text['contactus']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                                <tr>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>mostwanted.php" class="sidelink"><?php echo $text['mostwanted']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>browserepos.php" class="sidelink"><?php echo $text['repositories']; ?></a></td>
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top"><a href="<?php echo $cms['tngpath']; ?>showlog.php" class="sidelink"><?php if ($allow_admin) {
                              ...
                              if (!$currentuser && !$tngconfig['disallowreg']) {
                                ?>
                                  <tr>
                                      <td valign="top" colspan="4"><a href="<?php echo $cms['tngpath']; ?>newacctform.php" class="sidelink"><?php echo $text['mnuregister']; ?></a></td>
                                      <td>&nbsp;&nbsp;&nbsp;</td>
                                  </tr>
                                <?php
                              }
