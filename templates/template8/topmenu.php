      ...
      <table class="headertable">
        <tr class="headertextrow">
          <td>
            ...
            <span class="headertext text_white"><?php echo getTemplateMessage('t8_headtitle1'); ?></span><span class="headertext text_tan"><?php echo getTemplateMessage('t8_headtitle2'); ?></span><span
          ...
          <td class="searchtext">
            <form id="topsearchform" name="topsearchform" method="get" action="<?php echo $cms['tngpath']; ?>search.php">
              ...
              <span class="subsearch"><?php echo $text['mnufirstname']; ?>:&nbsp;</span><input size="8" name="myfirstname" type="text" id="myfirstname"> <span class="subsearch"><?php echo $text['mnulastname']; ?>:&nbsp;</span><input
                  size="10" name="mylastname" type="text" id="mylastname"> <input alt="Submit Search" style="vertical-align: bottom; border:none;" type="image" name="imageField"
                                                                                  src="<?php echo $cms['tngpath'] . $templatepath; ?>img/searchbutton.gif">
              <br>
              [<a class="subsearch" href="<?php echo $cms['tngpath']; ?>searchform.php"><?php echo $text['mnuadvancedsearch']; ?></a>]&nbsp;&nbsp;[<a class="subsearch"
