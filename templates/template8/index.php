    ...
    <tr>
      ...
      <td class="homenav_col">
        ...
        <ul class="homenav">
          ...
          -->
          <li><a href="pedigree.php?personID=<?php echo $tmp['t8_momperson']; ?>&amp;tree=<?php echo $tmp['t8_momtree']; ?>"><?php echo getTemplateMessage('t8_momside'); ?><br>&nbsp;&nbsp;<span
          ...
          -->
          <li><a href="pedigree.php?personID=<?php echo $tmp['t8_dadperson']; ?>&amp;tree=<?php echo $tmp['t8_dadtree']; ?>"><?php echo getTemplateMessage('t8_dadside'); ?><br>&nbsp;&nbsp;<span
