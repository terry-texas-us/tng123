          ...
          <tr>
            <td valign="top"><span class="normal"><?php echo $admtext['logfilename'] . " " . $admtext['text_public']; ?>:</span></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="<?php echo $maxloglines; ?>" name="maxloglines" size="5"></td>
                    </tr>
                    <tr>
                        <td valign="top"><span class="normal"><?php echo $admtext['badhosts']; ?>*:</span></td>
                        <td><input type="text" value="<?php echo $badhosts; ?>" name="badhosts" size="80"></td>
                    </tr>
                    <tr>
                        <td valign="top"><span class="normal"><?php echo $admtext['exusers']; ?>*:</span></td>
                        <td><input type="text" value="<?php echo $exusers; ?>" name="exusers" size="80"></td>
                    </tr>
                  <tr>
                    <td valign="top"><span class="normal"><?php echo $admtext['logfilename'] . " " . $admtext['admin']; ?>:</span></td>
                    <td><input type="text" value="<?php echo $adminlogfile; ?>" name="adminlogfile" size="20"></td>
                  </tr>
                  <tr>
                    <td valign="top"><span class="normal"><?php echo $admtext['maxloglines'] . " " . $admtext['admin']; ?>:</span></td>
                    <td><input type="text" value="<?php echo $adminmaxloglines; ?>" name="adminmaxloglines" size="5"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input type="text" value="<?php echo $addr_exclude; ?>" name="addr_exclude" size="80"></td>
                  </tr>
                  <tr>
